...
class ClientPrefs {
	public static var scrollSpeedSetting:Float = 0;
	public static var RoundLeDecimal:Bool = false;
	...
	public static function loadPrefs() {
		if(FlxG.save.data.scrollSpeedSetting != null) {
			scrollSpeedSetting = FlxG.save.data.scrollSpeedSetting;
		}
