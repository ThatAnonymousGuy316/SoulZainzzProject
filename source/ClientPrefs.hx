...
class ClientPrefs {
	...
	public static var missSoundVolume:Float = 0.3;
	...
	public static function saveSettings() {
		...
		save.bind('controls', 'irissoulWuzzainzz'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		var save:FlxSave = new FlxSave();
		save.bind('controls', 'irissoulWuzzainzz');
