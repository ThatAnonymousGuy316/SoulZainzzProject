...
class MainMenuState extends MusicBeatState
{
	...
	public static var soulZainzzVersion:String = '0.1.1';
	...
	{
		if (Redirects.MainMenuState != null && Redirects.MainMenuState != ''){
			MusicBeatState.switchState(new HXState(Redirects.MainMenuState));
		}
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "SoulZainzz Engine v" + soulZainzzVersion, 12);
