...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addEventsUI():Void
	{
		...
		#if MODS_ALLOWED
		directories.push(Paths.mods('scripts/events/'));
		directories.push(Paths.mods(Paths.currentModDirectory + '/scripts/events/'));
		for(mod in Paths.getGlobalMods())
			directories.push(Paths.mods(mod + '/scripts/events/'));
		#end
