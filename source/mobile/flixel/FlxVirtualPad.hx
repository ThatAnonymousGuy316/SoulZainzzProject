...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	private function createButton(X:Float, Y:Float, Graphic:String, Color:Int = 0xFFFFFF):FlxButton
	{
		...
		if (Assets.exists('mobile/virtualpad/${Graphic}.png'))
			graphic = FlxG.bitmap.add('mobile/virtualpad/${Graphic}.png');
		else
			graphic = FlxG.bitmap.add('mobile/virtualpad/default.png');
