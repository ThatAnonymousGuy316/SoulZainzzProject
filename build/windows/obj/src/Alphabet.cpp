...
HXLINE( 213)				 ::flixel::sound::FlxSound _this = this->dialogueSound;
...
HXLINE( 228)				_hx_tmp3 = (this->xPos >= (( (Float)(::flixel::FlxG_obj::width) ) * ((Float)0.65)));
            			}
            			else {
...
HXLINE( 232)				 ::Alphabet _hx_tmp4 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 232)				_hx_tmp4->loopNum = (_hx_tmp4->loopNum + 1);
            			}
            			else {
HXLINE( 234)				if (::hx::IsNotNull( tmr )) {
HXLINE( 234)					 ::flixel::util::FlxTimer tmr2 = tmr;
HXDLIN( 234)					tmr2->loops = (tmr2->loops - 2);
            				}
HXLINE( 235)				 ::Alphabet _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 235)				_hx_tmp5->loopNum = (_hx_tmp5->loopNum + 2);
            			}
HXLINE( 237)			 ::Alphabet _hx_tmp6 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 237)			_hx_tmp6->yMulti = (_hx_tmp6->yMulti + 1);
HXLINE( 238)			this->xPosResetted = true;
HXLINE( 239)			this->xPos = ( (Float)(0) );
HXLINE( 240)			 ::Alphabet _hx_tmp7 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 240)			_hx_tmp7->curRow = (_hx_tmp7->curRow + 1);
HXLINE( 241)			if ((this->curRow == 2)) {
HXLINE( 241)				this->set_y((this->y + this->LONG_TEXT_ADD));
            			}
            		}
HXLINE( 244)		bool _hx_tmp8;
HXDLIN( 244)		if ((this->loopNum <= this->splitWords->length)) {
HXLINE( 244)			_hx_tmp8 = ::hx::IsNotNull( this->splitWords->__get(this->loopNum) );
            		}
            		else {
...
HXLINE( 255)				_hx_tmp11 = isSymbol;
            			}
            			else {
HXLINE( 255)				_hx_tmp11 = true;
            			}
HXDLIN( 255)			if (!(_hx_tmp11)) {
HXLINE( 255)				_hx_tmp10 = isNumber;
            			}
            			else {
HXLINE( 255)				_hx_tmp10 = true;
            			}
HXDLIN( 255)			if (_hx_tmp10) {
HXLINE( 255)				if (this->isBold) {
HXLINE( 255)					_hx_tmp9 = !(spaceChar);
            				}
            				else {
HXLINE( 255)					_hx_tmp9 = true;
            				}
            			}
            			else {
...
HXLINE( 257)				bool _hx_tmp12;
HXDLIN( 257)				if (::hx::IsNotNull( this->lastSprite )) {
HXLINE( 257)					_hx_tmp12 = !(this->xPosResetted);
            				}
            				else {
HXLINE( 257)					_hx_tmp12 = false;
            				}
HXDLIN( 257)				if (_hx_tmp12) {
HXLINE( 259)					this->lastSprite->updateHitbox();
HXLINE( 260)					 ::Alphabet _hx_tmp13 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 260)					Float _hx_tmp14 = _hx_tmp13->xPos;
HXDLIN( 260)					_hx_tmp13->xPos = (_hx_tmp14 + (this->lastSprite->get_width() + 3));
            				}
            				else {
HXLINE( 266)					this->xPosResetted = false;
            				}
HXLINE( 269)				if ((this->consecutiveSpaces > 0)) {
HXLINE( 271)					 ::Alphabet _hx_tmp15 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 271)					_hx_tmp15->xPos = (_hx_tmp15->xPos + (( (Float)((20 * this->consecutiveSpaces)) ) * this->textSize));
            				}
...
HXLINE( 311)						 ::flixel::sound::FlxSound _this = this->dialogueSound;
HXDLIN( 311)						_this->cleanup(_this->autoDestroy,true);
            					}
HXLINE( 312)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp16 = ::flixel::FlxG_obj::sound;
HXDLIN( 312)					this->dialogueSound = _hx_tmp16->play(::Paths_obj::sound(HX_("dialogue",18,2d,94,a7),null()),null(),null(),null(),null(),null());
            				}
...
HXLINE( 343)				Float a1 = this->x;
HXDLIN( 343)				this->set_x((a1 + (lerpVal * ((((this->targetY * ( (Float)(20) )) + 90) + this->xAdd) - a1))));
            			}
            		}
...
::hx::Val Alphabet_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		break;
	case 13:
		if (HX_FIELD_EQ(inName,"dialogueSound") ) { dialogueSound=inValue.Cast<  ::flixel::sound::FlxSound >(); return inValue; }
...
static ::hx::StorageInfo Alphabet_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::sound::FlxSound */ ,(int)offsetof(Alphabet_obj,dialogueSound),HX_("dialogueSound",97,58,b3,1b)},
