...
HXLINE(  94)			::String file1 = ((HX_("images/dialogue/",c0,b0,32,12) + ::DialogueCharacter_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN(  94)			if (::hx::IsNull( file1 )) {
HXLINE(  94)				file1 = HX_("",00,00,00,00);
            			}
HXDLIN(  94)			path = (HX_("assets/",4c,2a,dc,36) + file1);
            		}
...
HXLINE( 130)				_hx_tmp2 = (( (::String)(this->dialogueAnimations->get(leAnim)->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic)) ).length < 1);
            			}
            			else {
HXLINE( 130)				_hx_tmp2 = true;
            			}
HXDLIN( 130)			if (!(_hx_tmp2)) {
HXLINE( 132)				::String _hx_tmp3 = ( (::String)(this->dialogueAnimations->get(leAnim)->__Field(HX_("loop_name",46,3d,8f,96),::hx::paccDynamic)) );
HXLINE( 129)				_hx_tmp1 = ::hx::IsEq( _hx_tmp3,this->dialogueAnimations->get(leAnim)->__Field(HX_("idle_name",96,be,e2,c5),::hx::paccDynamic) );
            			}
            			else {
...
HXLINE( 135)		::String _hx_tmp4;
HXDLIN( 135)		if (playIdle) {
HXLINE( 135)			_hx_tmp4 = (leAnim + ::DialogueCharacter_obj::IDLE_SUFFIX);
            		}
            		else {
HXLINE( 135)			_hx_tmp4 = leAnim;
            		}
HXDLIN( 135)		this->animation->play(_hx_tmp4,false,null(),null());
HXLINE( 137)		if (this->dialogueAnimations->exists(leAnim)) {
HXLINE( 138)			 ::Dynamic anim2 = this->dialogueAnimations->get(leAnim);
HXLINE( 139)			if (playIdle) {
HXLINE( 140)				this->offset->set(( (Float)( ::Dynamic(anim2->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(0)) ),( (Float)( ::Dynamic(anim2->__Field(HX_("idle_offsets",15,3e,2c,b8),::hx::paccDynamic))->__GetItem(1)) ));
            			}
            			else {
HXLINE( 143)				this->offset->set(( (Float)( ::Dynamic(anim2->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(0)) ),( (Float)( ::Dynamic(anim2->__Field(HX_("loop_offsets",65,0d,38,58),::hx::paccDynamic))->__GetItem(1)) ));
            			}
            		}
            		else {
HXLINE( 147)			this->offset->set(0,0);
HXLINE( 148)			::String _hx_tmp5;
HXDLIN( 148)			if (playIdle) {
HXLINE( 148)				_hx_tmp5 = HX_("idle anim",9d,46,16,77);
            			}
            			else {
HXLINE( 148)				_hx_tmp5 = HX_("loop anim",4d,c5,c2,47);
            			}
HXDLIN( 148)			::haxe::Log_obj::trace((((HX_("Offsets not found! Dialogue character is badly formatted, anim: ",ce,cc,78,b6) + leAnim) + HX_(", ",74,26,00,00)) + _hx_tmp5),::hx::SourceInfo(HX_("source/DialogueBoxPsych.hx",c2,b0,33,e8),148,HX_("DialogueCharacter",51,eb,23,69),HX_("playAnim",25,ea,84,30)));
            		}
            	}
