...
HXLINE(  47)		 ::flixel::animation::FlxAnimation _hx_tmp1 = this->animation->_curAnim;
HXDLIN(  47)		_hx_tmp1->set_frameRate(( (Float)((24 + ::flixel::FlxG_obj::random->_hx_int(-2,2,null()))) ));
            	}
