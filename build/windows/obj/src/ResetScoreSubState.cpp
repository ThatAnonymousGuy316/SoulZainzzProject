...
HXLINE(  38)		this->bg->scrollFactor->set(0,0);
...
HXDLIN(  48)				text1->set_x(((( (Float)(_hx_tmp5) ) - text1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  48)			bool _hx_tmp6;
HXDLIN(  48)			if ((axes1 != 16)) {
HXLINE(  48)				_hx_tmp6 = (axes1 == 17);
            			}
            			else {
...
HXDLIN(  48)				text1->set_y(((( (Float)(_hx_tmp7) ) - text1->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  49)		if ((week == -1)) {
...
HXLINE(  55)			 ::HealthIcon _hx_tmp8 = this->icon;
HXDLIN(  55)			_hx_tmp8->setGraphicSize(::Std_obj::_hx_int((this->icon->get_width() * tooLong)),null());
HXLINE(  56)			this->icon->updateHitbox();
HXLINE(  57)			 ::HealthIcon _hx_tmp9 = this->icon;
HXDLIN(  57)			Float text2 = text1->x;
HXDLIN(  57)			Float _hx_tmp10 = ((text2 - this->icon->get_width()) + (( (Float)(10) ) * tooLong));
HXDLIN(  57)			_hx_tmp9->setPosition(_hx_tmp10,(text1->y - ( (Float)(30) )));
...
HXDLIN(  63)			int axes2 = 1;
HXDLIN(  63)			bool _hx_tmp11;
HXDLIN(  63)			if ((axes2 != 1)) {
HXLINE(  63)				_hx_tmp11 = (axes2 == 17);
            			}
            			else {
HXLINE(  63)				_hx_tmp11 = true;
            			}
HXDLIN(  63)			if (_hx_tmp11) {
HXLINE(  63)				int _hx_tmp12 = ::flixel::FlxG_obj::width;
HXDLIN(  63)				_this->set_x(((( (Float)(_hx_tmp12) ) - _this->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  63)			bool _hx_tmp13;
HXDLIN(  63)			if ((axes2 != 16)) {
HXLINE(  63)				_hx_tmp13 = (axes2 == 17);
            			}
            			else {
HXLINE(  63)				_hx_tmp13 = true;
            			}
HXDLIN(  63)			if (_hx_tmp13) {
HXLINE(  63)				int _hx_tmp14 = ::flixel::FlxG_obj::height;
HXDLIN(  63)				_this->set_y(((( (Float)(_hx_tmp14) ) - _this->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXDLIN(  67)			int axes3 = 1;
HXDLIN(  67)			bool _hx_tmp15;
HXDLIN(  67)			if ((axes3 != 1)) {
HXLINE(  67)				_hx_tmp15 = (axes3 == 17);
            			}
            			else {
HXLINE(  67)				_hx_tmp15 = true;
            			}
HXDLIN(  67)			if (_hx_tmp15) {
HXLINE(  67)				int _hx_tmp16 = ::flixel::FlxG_obj::width;
HXDLIN(  67)				_this1->set_x(((( (Float)(_hx_tmp16) ) - _this1->get_width()) / ( (Float)(2) )));
            			}
HXDLIN(  67)			bool _hx_tmp17;
HXDLIN(  67)			if ((axes3 != 16)) {
HXLINE(  67)				_hx_tmp17 = (axes3 == 17);
            			}
            			else {
HXLINE(  67)				_hx_tmp17 = true;
            			}
HXDLIN(  67)			if (_hx_tmp17) {
HXLINE(  67)				int _hx_tmp18 = ::flixel::FlxG_obj::height;
HXDLIN(  67)				_this1->set_y(((( (Float)(_hx_tmp18) ) - _this1->get_height()) / ( (Float)(2) )));
            			}
            		}
...
bool ResetScoreSubState_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x62817b24) {
		if (inClassId<=(int)0x5661ffbf) {
			...
			return inClassId==(int)0x5d837fd8 || inClassId==(int)0x62817b24;
		}
	} else {
...
HXLINE(  82)			 ::HealthIcon fh1 = this->icon;
HXDLIN(  82)			fh1->set_alpha((fh1->alpha + (elapsed * ((Float)2.5))));
            		}
...
HXLINE(  85)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp1 = ::flixel::FlxG_obj::sound;
HXDLIN(  85)			_hx_tmp1->play(::Paths_obj::sound(HX_("scrollMenu",4c,d4,18,06),null()),1,null(),null(),null(),null());
HXLINE(  86)			this->onYes = !(this->onYes);
HXLINE(  87)			this->updateOptions();
            		}
HXLINE(  89)		if (::PlayerSettings_obj::player1->controls->_back->check()) {
HXLINE(  90)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::sound;
HXDLIN(  90)			_hx_tmp2->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
...
HXLINE( 100)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::sound;
HXDLIN( 100)				_hx_tmp3->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),1,null(),null(),null(),null());
