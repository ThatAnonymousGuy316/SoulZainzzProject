...
HXDLIN(  27)			 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(file);
HXDLIN(  27)			 ::Dynamic _hx_tmp2;
HXDLIN(  27)			if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE(  27)				_hx_tmp2 = imageToReturn1;
            			}
            			else {
HXLINE(  27)				_hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + file) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            			}
HXDLIN(  27)			this->loadGraphic(_hx_tmp2,null(),null(),null(),null(),null());
            		}
HXLINE(  29)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  30)		this->scrollFactor->set(0,0);
            	}
