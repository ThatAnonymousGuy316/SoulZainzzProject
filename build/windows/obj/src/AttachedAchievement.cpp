...
HXLINE( 100)			::String library1 = null();
HXDLIN( 100)			 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(HX_("lockedachievement",a5,23,f4,2a));
HXDLIN( 100)			 ::Dynamic _hx_tmp1;
HXDLIN( 100)			if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE( 100)				_hx_tmp1 = imageToReturn1;
            			}
            			else {
HXLINE( 100)				_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("lockedachievement",a5,23,f4,2a)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            			}
HXDLIN( 100)			this->loadGraphic(_hx_tmp1,null(),null(),null(),null(),null());
            		}
