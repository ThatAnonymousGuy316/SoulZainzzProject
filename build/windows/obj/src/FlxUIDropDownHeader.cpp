...
HXLINE( 581)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp1 = this->button;
HXDLIN( 581)		Float _hx_tmp2 = this->background->get_height();
HXDLIN( 581)		_hx_tmp1->resize(_hx_tmp2,this->background->get_height());
HXLINE( 582)		 ::flixel::addons::ui::FlxUISpriteButton _hx_tmp3 = this->button;
HXDLIN( 582)		Float _hx_tmp4 = this->background->x;
HXDLIN( 582)		Float _hx_tmp5 = (_hx_tmp4 + this->background->get_width());
HXDLIN( 582)		_hx_tmp3->set_x((_hx_tmp5 - this->button->get_width()));
HXLINE( 585)		this->button->set_width(( (Float)(Width) ));
HXLINE( 586)		 ::flixel::addons::ui::FlxUISpriteButton fh = this->button;
HXDLIN( 586)		fh->offset->set_x((fh->offset->x - ( (Float)((Width - this->button->frameWidth)) )));
HXLINE( 587)		this->button->set_x(this->offset->x);
HXLINE( 588)		 ::flixel::FlxSprite fh1 = ( ( ::flixel::FlxSprite)(this->button->label) );
HXDLIN( 588)		fh1->offset->set_x((fh1->offset->x + this->button->offset->x));
