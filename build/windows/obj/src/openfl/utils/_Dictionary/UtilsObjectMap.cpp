...
HX_DEFINE_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_496_new,"openfl.utils._Dictionary.UtilsObjectMap","new",0xb7b17cf2,"openfl.utils._Dictionary.UtilsObjectMap.new","openfl/utils/Dictionary.hx",496,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_502_clear,"openfl.utils._Dictionary.UtilsObjectMap","clear",0xd3eae69f,"openfl.utils._Dictionary.UtilsObjectMap.clear","openfl/utils/Dictionary.hx",502,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_508_copy,"openfl.utils._Dictionary.UtilsObjectMap","copy",0xfc5e0ee3,"openfl.utils._Dictionary.UtilsObjectMap.copy","openfl/utils/Dictionary.hx",508,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_518_exists,"openfl.utils._Dictionary.UtilsObjectMap","exists",0x51d7188a,"openfl.utils._Dictionary.UtilsObjectMap.exists","openfl/utils/Dictionary.hx",518,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_530_get,"openfl.utils._Dictionary.UtilsObjectMap","get",0xb7ac2d28,"openfl.utils._Dictionary.UtilsObjectMap.get","openfl/utils/Dictionary.hx",530,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_536_keyValueIterator,"openfl.utils._Dictionary.UtilsObjectMap","keyValueIterator",0xf84f2d8e,"openfl.utils._Dictionary.UtilsObjectMap.keyValueIterator","openfl/utils/Dictionary.hx",536,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_542_keys,"openfl.utils._Dictionary.UtilsObjectMap","keys",0x01a03522,"openfl.utils._Dictionary.UtilsObjectMap.keys","openfl/utils/Dictionary.hx",542,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_547_iterator,"openfl.utils._Dictionary.UtilsObjectMap","iterator",0xcd47cc1c,"openfl.utils._Dictionary.UtilsObjectMap.iterator","openfl/utils/Dictionary.hx",547,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_552_remove,"openfl.utils._Dictionary.UtilsObjectMap","remove",0x967f96f2,"openfl.utils._Dictionary.UtilsObjectMap.remove","openfl/utils/Dictionary.hx",552,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_557_set,"openfl.utils._Dictionary.UtilsObjectMap","set",0xb7b54834,"openfl.utils._Dictionary.UtilsObjectMap.set","openfl/utils/Dictionary.hx",557,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_562_toString,"openfl.utils._Dictionary.UtilsObjectMap","toString",0x721c52da,"openfl.utils._Dictionary.UtilsObjectMap.toString","openfl/utils/Dictionary.hx",562,0x5979b1eb)
HX_LOCAL_STACK_FRAME(_hx_pos_b7f8145c5f80ac3d_490_boot,"openfl.utils._Dictionary.UtilsObjectMap","boot",0xfbb4d760,"openfl.utils._Dictionary.UtilsObjectMap.boot","openfl/utils/Dictionary.hx",490,0x5979b1eb)
namespace openfl{
namespace utils{
namespace _Dictionary{

void UtilsObjectMap_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_496_new)
HXDLIN( 496)		this->map =  ::haxe::ds::ObjectMap_obj::__alloc( HX_CTX );
            	}
...
void UtilsObjectMap_obj::clear(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_502_clear)
HXDLIN( 502)		this->map->clear();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,clear,(void))
 ...
 ::openfl::utils::_Dictionary::UtilsObjectMap UtilsObjectMap_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_508_copy)
HXLINE( 509)		 ::openfl::utils::_Dictionary::UtilsObjectMap copied =  ::openfl::utils::_Dictionary::UtilsObjectMap_obj::__alloc( HX_CTX );
HXLINE( 510)		{
HXLINE( 510)			 ::Dynamic key = this->keys();
HXDLIN( 510)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 510)				 ::Dynamic key1 = key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXLINE( 511)				copied->set(key1,this->get(key1));
            			}
            		}
HXLINE( 512)		return copied;
            	}
...
bool UtilsObjectMap_obj::exists( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_518_exists)
HXDLIN( 518)		return this->map->exists(key);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,exists,return )
 ...
 ::Dynamic UtilsObjectMap_obj::get( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_530_get)
HXDLIN( 530)		return this->map->get(key);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(UtilsObjectMap_obj,get,return )
 ...
 ::Dynamic UtilsObjectMap_obj::keyValueIterator(){
            	HX_GC_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_536_keyValueIterator)
HXDLIN( 536)		return  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,::hx::ObjectPtr<OBJ_>(this));
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,keyValueIterator,return )
 ...
 ::Dynamic UtilsObjectMap_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_542_keys)
HXDLIN( 542)		return this->map->keys();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(UtilsObjectMap_obj,keys,return )
 ...
 ::Dynamic UtilsObjectMap_obj::iterator(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_547_iterator)
HXDLIN( 547)		return this->map->iterator();
            	}
...
bool UtilsObjectMap_obj::remove( ::Dynamic key){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_552_remove)
HXDLIN( 552)		return this->map->remove(key);
            	}
...
void UtilsObjectMap_obj::set( ::Dynamic key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_557_set)
HXDLIN( 557)		this->map->set(key,value);
            	}
...
::String UtilsObjectMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_562_toString)
HXDLIN( 562)		return this->map->toString();
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b7f8145c5f80ac3d_490_boot)
HXDLIN( 490)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
