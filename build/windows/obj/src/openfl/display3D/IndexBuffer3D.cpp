...
HXLINE( 134)					if (((offset + existingUInt16Array->length) > _this4->length)) {
HXLINE( 134)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 134)					if ((_this4->bytesPerElement == existingUInt16Array->bytesPerElement)) {
...
HXLINE( 134)						int _g = 0;
HXDLIN( 134)						int _g1 = existingUInt16Array->length;
HXDLIN( 134)						while((_g < _g1)){
HXLINE( 134)							_g = (_g + 1);
HXDLIN( 134)							int i = (_g - 1);
HXDLIN( 134)							::lime::utils::ArrayBufferView_obj::transferElement(existingUInt16Array,i,_this4,(offset + i));
            						}
            					}
            				}
            				else {
...
HXLINE( 138)		{
HXLINE( 138)			int _g2 = startOffset;
HXDLIN( 138)			int _g3 = length;
HXDLIN( 138)			while((_g2 < _g3)){
HXLINE( 138)				_g2 = (_g2 + 1);
HXDLIN( 138)				int i1 = (_g2 - 1);
HXLINE( 140)				{
HXLINE( 140)					 ::lime::utils::ArrayBufferView this2 = this->_hx___tempUInt16Array;
HXDLIN( 140)					int val = data->get(i1);
HXDLIN( 140)					 ::__hxcpp_memory_set_ui16(this2->buffer->b,(this2->byteOffset + ((i1 - startOffset) * 2)),val);
            				}
            			}
            		}
