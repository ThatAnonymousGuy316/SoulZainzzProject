...
HXLINE( 172)					if (((offset + existingFloat32Array->length) > _this4->length)) {
HXLINE( 172)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 172)					if ((_this4->bytesPerElement == existingFloat32Array->bytesPerElement)) {
...
HXLINE( 172)						int _g = 0;
HXDLIN( 172)						int _g1 = existingFloat32Array->length;
HXDLIN( 172)						while((_g < _g1)){
HXLINE( 172)							_g = (_g + 1);
HXDLIN( 172)							int i = (_g - 1);
HXDLIN( 172)							::lime::utils::ArrayBufferView_obj::transferElement(existingFloat32Array,i,_this4,(offset + i));
            						}
            					}
            				}
            				else {
...
HXLINE( 176)		{
HXLINE( 176)			int _g2 = start;
HXDLIN( 176)			int _g3 = length;
...
HXDLIN( 178)					Float val = data->get(i1);
HXDLIN( 178)					 ::__hxcpp_memory_set_float(this2->buffer->b,(this2->byteOffset + ((i1 - start) * 4)),val);
            				}
            			}
            		}
