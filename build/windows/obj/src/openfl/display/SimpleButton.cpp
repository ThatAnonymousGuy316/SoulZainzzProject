...
HX_LOCAL_STACK_FRAME(_hx_pos_10b8a2091f17fcad_506___this_onMouseDown,"openfl.display.SimpleButton","__this_onMouseDown",0x383f91c7,"openfl.display.SimpleButton.__this_onMouseDown","openfl/display/SimpleButton.hx",506,0x4b6b858e)
HX_LOCAL_STACK_FRAME(_hx_pos_10b8a2091f17fcad_513___this_onMouseOut,"openfl.display.SimpleButton","__this_onMouseOut",0x6c31fac9,"openfl.display.SimpleButton.__this_onMouseOut","openfl/display/SimpleButton.hx",513,0x4b6b858e)
HX_LOCAL_STACK_FRAME(_hx_pos_10b8a2091f17fcad_523___this_onMouseOver,"openfl.display.SimpleButton","__this_onMouseOver",0x3f8a2ab9,"openfl.display.SimpleButton.__this_onMouseOver","openfl/display/SimpleButton.hx",523,0x4b6b858e)
HX_LOCAL_STACK_FRAME(_hx_pos_10b8a2091f17fcad_536___this_onMouseUp,"openfl.display.SimpleButton","__this_onMouseUp",0xd7286c80,"openfl.display.SimpleButton.__this_onMouseUp","openfl/display/SimpleButton.hx",536,0x4b6b858e)
namespace openfl{
namespace display{
...
HXLINE( 469)		if (::hx::IsInstanceNotEq( value,this->_hx___currentState )) {
HXLINE( 489)			if (::hx::IsNotNull( value )) {
HXLINE( 491)				value->_hx___renderParent = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 492)				if (!(value->_hx___renderDirty)) {
HXLINE( 492)					value->_hx___renderDirty = true;
HXDLIN( 492)					value->_hx___setParentRenderDirty();
            				}
            			}
...
HXLINE( 498)		this->_hx___currentState = value;
...
void SimpleButton_obj::_hx___this_onMouseDown( ::openfl::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_10b8a2091f17fcad_506___this_onMouseDown)
HXDLIN( 506)		if (this->enabled) {
HXLINE( 508)			this->set___currentState(this->get_downState());
            		}
            	}
...
void SimpleButton_obj::_hx___this_onMouseOut( ::openfl::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_10b8a2091f17fcad_513___this_onMouseOut)
HXLINE( 514)		this->_hx___ignoreEvent = false;
HXLINE( 516)		 ::openfl::display::DisplayObject _hx_tmp = this->get_upState();
HXDLIN( 516)		if (::hx::IsInstanceNotEq( _hx_tmp,this->_hx___currentState )) {
HXLINE( 518)			this->set___currentState(this->get_upState());
            		}
            	}
...
void SimpleButton_obj::_hx___this_onMouseOver( ::openfl::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_10b8a2091f17fcad_523___this_onMouseOver)
HXLINE( 524)		if (event->buttonDown) {
HXLINE( 526)			this->_hx___ignoreEvent = true;
            		}
HXLINE( 529)		bool _hx_tmp;
HXDLIN( 529)		bool _hx_tmp1;
HXDLIN( 529)		bool _hx_tmp2;
HXDLIN( 529)		 ::openfl::display::DisplayObject _hx_tmp3 = this->get_overState();
HXDLIN( 529)		if (::hx::IsInstanceNotEq( _hx_tmp3,this->_hx___currentState )) {
HXLINE( 529)			_hx_tmp2 = ::hx::IsNotNull( this->get_overState() );
            		}
            		else {
HXLINE( 529)			_hx_tmp2 = false;
            		}
HXDLIN( 529)		if (_hx_tmp2) {
HXLINE( 529)			_hx_tmp1 = !(this->_hx___ignoreEvent);
            		}
            		else {
HXLINE( 529)			_hx_tmp1 = false;
            		}
HXDLIN( 529)		if (_hx_tmp1) {
HXLINE( 529)			_hx_tmp = this->enabled;
            		}
            		else {
HXLINE( 529)			_hx_tmp = false;
            		}
HXDLIN( 529)		if (_hx_tmp) {
HXLINE( 531)			this->set___currentState(this->get_overState());
            		}
            	}
...
void SimpleButton_obj::_hx___this_onMouseUp( ::openfl::events::MouseEvent event){
            	HX_STACKFRAME(&_hx_pos_10b8a2091f17fcad_536___this_onMouseUp)
HXLINE( 537)		this->_hx___ignoreEvent = false;
HXLINE( 539)		bool _hx_tmp;
HXDLIN( 539)		if (this->enabled) {
HXLINE( 539)			_hx_tmp = ::hx::IsNotNull( this->get_overState() );
            		}
            		else {
HXLINE( 539)			_hx_tmp = false;
            		}
HXDLIN( 539)		if (_hx_tmp) {
HXLINE( 541)			this->set___currentState(this->get_overState());
            		}
            		else {
HXLINE( 545)			this->set___currentState(this->get_upState());
            		}
            	}
