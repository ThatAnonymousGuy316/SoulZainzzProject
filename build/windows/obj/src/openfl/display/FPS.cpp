...
HX_DEFINE_STACK_FRAME(_hx_pos_a7e04a5c6176ce66_23_new,"openfl.display.FPS","new",0xe5d2c231,"openfl.display.FPS.new","openfl/display/FPS.hx",23,0x584764e1)
HX_LOCAL_STACK_FRAME(_hx_pos_a7e04a5c6176ce66_64___enterFrame,"openfl.display.FPS","__enterFrame",0xcd4a4b24,"openfl.display.FPS.__enterFrame","openfl/display/FPS.hx",64,0x584764e1)
namespace openfl{
namespace display{
...
void FPS_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_color){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a7e04a5c6176ce66_23_new)
HXLINE(  33)		this->lastText = null();
HXLINE(  37)		super::__construct();
HXLINE(  39)		this->set_x(x);
HXLINE(  40)		this->set_y(y);
HXLINE(  42)		this->currentFPS = 0;
HXLINE(  43)		this->set_selectable(false);
HXLINE(  44)		this->mouseEnabled = false;
HXLINE(  45)		this->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,HX_("_sans",32,a0,5e,ff),12,color,null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE(  46)		this->set_text(HX_("FPS: ",af,da,2c,83));
...
void FPS_obj::_hx___enterFrame(int _tmp_deltaTime){
            	HX_STACKFRAME(&_hx_pos_a7e04a5c6176ce66_64___enterFrame)
HXLINE(  65)		Float deltaTime = ( (Float)(_tmp_deltaTime) );
HXDLIN(  65)		 ::openfl::display::FPS _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  65)		_hx_tmp->currentTime = (_hx_tmp->currentTime + deltaTime);
HXLINE(  66)		this->times->push(this->currentTime);
HXLINE(  68)		while((this->times->__get(0) < (this->currentTime - ( (Float)(1000) )))){
HXLINE(  70)			this->times->shift();
            		}
HXLINE(  73)		int currentCount = this->times->length;
HXLINE(  74)		this->currentFPS = ::Std_obj::_hx_int((( (Float)((currentCount + this->cacheCount)) ) / ( (Float)(2) )));
HXLINE(  76)		if ((currentCount != this->cacheCount)) {
HXLINE(  77)			::String newText = (HX_("FPS: ",af,da,2c,83) + this->currentFPS);
HXLINE(  85)			if ((newText != this->lastText)) {
HXLINE(  86)				this->set_text(newText);
HXLINE(  87)				this->lastText = newText;
            			}
            		}
HXLINE(  91)		this->cacheCount = currentCount;
            	}
...
void FPS_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(lastText,"lastText");
...
void FPS_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(lastText,"lastText");
...
::hx::Val FPS_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"lastText") ) { return ::hx::Val( lastText ); }
		break;
	case 10:
...
::hx::Val FPS_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 5:
		...
		break;
	case 8:
		if (HX_FIELD_EQ(inName,"lastText") ) { lastText=inValue.Cast< ::String >(); return inValue; }
		break;
	case 10:
...
void FPS_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_("lastText",23,e6,42,e0));
...
static ::hx::StorageInfo FPS_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsString,(int)offsetof(FPS_obj,lastText),HX_("lastText",23,e6,42,e0)},
	{ ::hx::fsUnknown, 0, null()}
};
