...
HX_DEFINE_STACK_FRAME(_hx_pos_3e7f1148457df64b_140_new,"openfl.display.Stage3D","new",0x52647737,"openfl.display.Stage3D.new","openfl/display/Stage3D.hx",140,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_220_requestContext3D,"openfl.display.Stage3D","requestContext3D",0x80c219da,"openfl.display.Stage3D.requestContext3D","openfl/display/Stage3D.hx",220,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_300_requestContext3DMatchingProfiles,"openfl.display.Stage3D","requestContext3DMatchingProfiles",0x5b5ae301,"openfl.display.Stage3D.requestContext3DMatchingProfiles","openfl/display/Stage3D.hx",300,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_304___createContext,"openfl.display.Stage3D","__createContext",0x1987b48a,"openfl.display.Stage3D.__createContext","openfl/display/Stage3D.hx",304,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_404___dispatchError,"openfl.display.Stage3D","__dispatchError",0xdb9710e5,"openfl.display.Stage3D.__dispatchError","openfl/display/Stage3D.hx",404,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_411___dispatchCreate,"openfl.display.Stage3D","__dispatchCreate",0x733e9b3f,"openfl.display.Stage3D.__dispatchCreate","openfl/display/Stage3D.hx",411,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_419___lostContext,"openfl.display.Stage3D","__lostContext",0x951652e2,"openfl.display.Stage3D.__lostContext","openfl/display/Stage3D.hx",419,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_431___resize,"openfl.display.Stage3D","__resize",0x193af2dd,"openfl.display.Stage3D.__resize","openfl/display/Stage3D.hx",431,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_471___restoreContext,"openfl.display.Stage3D","__restoreContext",0xa732262a,"openfl.display.Stage3D.__restoreContext","openfl/display/Stage3D.hx",471,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_478_get_x,"openfl.display.Stage3D","get_x",0x0609efe6,"openfl.display.Stage3D.get_x","openfl/display/Stage3D.hx",478,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_482_set_x,"openfl.display.Stage3D","set_x",0xeed8e5f2,"openfl.display.Stage3D.set_x","openfl/display/Stage3D.hx",482,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_494_get_y,"openfl.display.Stage3D","get_y",0x0609efe7,"openfl.display.Stage3D.get_y","openfl/display/Stage3D.hx",494,0x37141b9b)
HX_LOCAL_STACK_FRAME(_hx_pos_3e7f1148457df64b_498_set_y,"openfl.display.Stage3D","set_y",0xeed8e5f3,"openfl.display.Stage3D.set_y","openfl/display/Stage3D.hx",498,0x37141b9b)
namespace openfl{
namespace display{

void Stage3D_obj::__construct( ::openfl::display::Stage stage){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_140_new)
HXLINE( 141)		super::__construct(null());
HXLINE( 143)		this->_hx___stage = stage;
HXLINE( 145)		this->_hx___height = 0;
HXLINE( 146)		this->_hx___projectionTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE( 147)		this->_hx___renderTransform =  ::openfl::geom::Matrix3D_obj::__alloc( HX_CTX ,null());
HXLINE( 148)		this->_hx___width = 0;
HXLINE( 149)		this->_hx___x = ( (Float)(0) );
HXLINE( 150)		this->_hx___y = ( (Float)(0) );
HXLINE( 152)		this->visible = true;
HXLINE( 154)		bool _hx_tmp;
HXDLIN( 154)		if ((stage->stageWidth > 0)) {
HXLINE( 154)			_hx_tmp = (stage->stageHeight > 0);
            		}
            		else {
HXLINE( 154)			_hx_tmp = false;
            		}
HXDLIN( 154)		if (_hx_tmp) {
HXLINE( 156)			this->_hx___resize(stage->stageWidth,stage->stageHeight);
            		}
            	}
...
void Stage3D_obj::requestContext3D( ::Dynamic __o_context3DRenderMode, ::Dynamic __o_profile){
            	...
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_220_requestContext3D)
HXLINE( 221)		if (this->_hx___contextLost) {
HXLINE( 223)			this->_hx___contextRequested = true;
HXLINE( 224)			return;
            		}
HXLINE( 227)		if (::hx::IsNotNull( this->context3D )) {
HXLINE( 229)			this->_hx___contextRequested = true;
HXLINE( 230)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),1);
            		}
            		else {
HXLINE( 232)			if (!(this->_hx___contextRequested)) {
HXLINE( 234)				this->_hx___contextRequested = true;
HXLINE( 235)				::haxe::Timer_obj::delay(this->_hx___createContext_dyn(),1);
            			}
            		}
            	}
...
void Stage3D_obj::requestContext3DMatchingProfiles( ::openfl::_Vector::ObjectVector profiles){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_300_requestContext3DMatchingProfiles)
HXDLIN( 300)		this->requestContext3D(null(),null());
            	}
...
void Stage3D_obj::_hx___createContext(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_304___createContext)
HXLINE( 306)		 ::openfl::display::Stage stage = this->_hx___stage;
HXLINE( 307)		 ::openfl::display::DisplayObjectRenderer renderer = stage->_hx___renderer;
HXLINE( 309)		bool _hx_tmp;
HXDLIN( 309)		if ((renderer->_hx___type != HX_("cairo",88,30,19,41))) {
HXLINE( 309)			_hx_tmp = (renderer->_hx___type == HX_("canvas",d8,54,42,b8));
            		}
            		else {
HXLINE( 309)			_hx_tmp = true;
            		}
HXDLIN( 309)		if (_hx_tmp) {
HXLINE( 311)			this->_hx___dispatchError();
HXLINE( 312)			return;
            		}
HXLINE( 315)		if ((renderer->_hx___type == HX_("opengl",6f,64,94,21))) {
HXLINE( 320)			this->context3D =  ::openfl::display3D::Context3D_obj::__alloc( HX_CTX ,stage,stage->context3D->_hx___contextState,::hx::ObjectPtr<OBJ_>(this));
HXLINE( 322)			this->_hx___dispatchCreate();
            		}
            		else {
HXLINE( 324)			bool _hx_tmp1 = (renderer->_hx___type == HX_("dom",82,42,4c,00));
            		}
            	}
...
void Stage3D_obj::_hx___dispatchError(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_404___dispatchError)
HXLINE( 405)		this->_hx___contextRequested = false;
HXLINE( 406)		this->dispatchEvent( ::openfl::events::ErrorEvent_obj::__alloc( HX_CTX ,HX_("error",c8,cb,29,73),false,false,HX_("Context3D not available",9c,fc,63,d3),null()));
            	}
...
void Stage3D_obj::_hx___dispatchCreate(){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_411___dispatchCreate)
HXDLIN( 411)		if (this->_hx___contextRequested) {
HXLINE( 413)			this->_hx___contextRequested = false;
HXLINE( 414)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("context3DCreate",7c,bf,59,7b),null(),null()));
            		}
            	}
...
void Stage3D_obj::_hx___lostContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_419___lostContext)
HXLINE( 420)		this->_hx___contextLost = true;
HXLINE( 422)		if (::hx::IsNotNull( this->context3D )) {
HXLINE( 424)			this->context3D->_hx___dispose();
HXLINE( 425)			this->_hx___contextRequested = true;
            		}
            	}
...
void Stage3D_obj::_hx___resize(int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_3e7f1148457df64b_431___resize)
HXDLIN( 431)		bool _hx_tmp;
HXDLIN( 431)		if ((width == this->_hx___width)) {
HXDLIN( 431)			_hx_tmp = (height != this->_hx___height);
            		}
            		else {
HXDLIN( 431)			_hx_tmp = true;
            		}
HXDLIN( 431)		if (_hx_tmp) {
HXLINE( 441)			 ::openfl::geom::Matrix3D _hx_tmp1 = this->_hx___projectionTransform;
HXDLIN( 441)			int length = null();
HXDLIN( 441)			bool fixed = null();
HXLINE( 442)			int _hx_tmp2;
HXDLIN( 442)			if ((width > 0)) {
HXLINE( 442)				_hx_tmp2 = width;
            			}
            			else {
HXLINE( 442)				_hx_tmp2 = 1;
            			}
HXLINE( 447)			int _hx_tmp3;
HXDLIN( 447)			if ((height > 0)) {
HXLINE( 447)				_hx_tmp3 = height;
            			}
            			else {
HXLINE( 447)				_hx_tmp3 = 1;
            			}
HXLINE( 441)			_hx_tmp1->copyRawDataFrom( ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length,fixed,::Array_obj< Float >::__new(16)->init(0,(((Float)2.0) / ( (Float)(_hx_tmp2) )))->init(1,((Float)0.0))->init(2,((Float)0.0))->init(3,((Float)0.0))->init(4,((Float)0.0))->init(5,(((Float)-2.0) / ( (Float)(_hx_tmp3) )))->init(6,((Float)0.0))->init(7,((Float)0.0))->init(8,((Float)0.0))->init(9,((Float)0.0))->init(10,((Float)-0.001))->init(11,((Float)0.0))->init(12,((Float)-1.0))->init(13,((Float)1.0))->init(14,((Float)0.0))->init(15,((Float)1.0)),true),null(),null());
HXLINE( 460)			Float pixelRatio = this->_hx___stage->window->_hx___scale;
HXLINE( 461)			this->_hx___renderTransform->identity();
HXLINE( 462)			this->_hx___renderTransform->appendTranslation((this->_hx___x * pixelRatio),(this->_hx___y * pixelRatio),( (Float)(0) ));
HXLINE( 463)			this->_hx___renderTransform->append(this->_hx___projectionTransform);
HXLINE( 465)			this->_hx___width = width;
HXLINE( 466)			this->_hx___height = height;
            		}
            	}
...
void Stage3D_obj::_hx___restoreContext(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_471___restoreContext)
HXLINE( 472)		this->_hx___contextLost = false;
HXLINE( 473)		this->_hx___createContext();
            	}
...
Float Stage3D_obj::get_x(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_478_get_x)
HXDLIN( 478)		return this->_hx___x;
            	}
...
Float Stage3D_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_482_set_x)
HXLINE( 483)		if ((this->_hx___x == value)) {
HXLINE( 483)			return value;
            		}
HXLINE( 484)		this->_hx___x = value;
HXLINE( 485)		Float pixelRatio = this->_hx___stage->window->_hx___scale;
HXLINE( 486)		this->_hx___renderTransform->identity();
HXLINE( 487)		this->_hx___renderTransform->appendTranslation((this->_hx___x * pixelRatio),(this->_hx___y * pixelRatio),( (Float)(0) ));
HXLINE( 488)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
...
Float Stage3D_obj::get_y(){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_494_get_y)
HXDLIN( 494)		return this->_hx___y;
            	}
...
Float Stage3D_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_3e7f1148457df64b_498_set_y)
HXLINE( 499)		if ((this->_hx___y == value)) {
HXLINE( 499)			return value;
            		}
HXLINE( 500)		this->_hx___y = value;
HXLINE( 501)		Float pixelRatio = this->_hx___stage->window->_hx___scale;
HXLINE( 502)		this->_hx___renderTransform->identity();
HXLINE( 503)		this->_hx___renderTransform->appendTranslation((this->_hx___x * pixelRatio),(this->_hx___y * pixelRatio),( (Float)(0) ));
HXLINE( 504)		this->_hx___renderTransform->append(this->_hx___projectionTransform);
