...
HX_LOCAL_STACK_FRAME(_hx_pos_b1fba0bba755bee2_261_renderDrawable,"openfl.display._internal.CairoShape","renderDrawable",0xf82011ed,"openfl.display._internal.CairoShape.renderDrawable","openfl/display/_internal/CairoShape.hx",261,0x7720bd06)
HX_LOCAL_STACK_FRAME(_hx_pos_b1fba0bba755bee2_266_renderDrawableMask,"openfl.display._internal.CairoShape","renderDrawableMask",0x01237979,"openfl.display._internal.CairoShape.renderDrawableMask","openfl/display/_internal/CairoShape.hx",266,0x7720bd06)
...
void CairoShape_obj::renderDrawable( ::openfl::display::Shape shape, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b1fba0bba755bee2_261_renderDrawable)
HXDLIN( 261)		renderer->_hx___updateCacheBitmap(shape,false);
HXDLIN( 261)		bool _hx_tmp;
HXDLIN( 261)		if (::hx::IsNotNull( shape->_hx___cacheBitmap )) {
HXDLIN( 261)			_hx_tmp = !(shape->_hx___isCacheBitmapRender);
            		}
            		else {
HXDLIN( 261)			_hx_tmp = false;
            		}
HXDLIN( 261)		if (_hx_tmp) {
HXDLIN( 261)			 ::openfl::display::Bitmap bitmap = shape->_hx___cacheBitmap;
HXDLIN( 261)			if (bitmap->_hx___renderable) {
HXDLIN( 261)				Float alpha = renderer->_hx___getAlpha(bitmap->_hx___worldAlpha);
HXDLIN( 261)				bool _hx_tmp1;
HXDLIN( 261)				bool _hx_tmp2;
HXDLIN( 261)				if ((alpha > 0)) {
HXDLIN( 261)					_hx_tmp2 = ::hx::IsNotNull( bitmap->_hx___bitmapData );
            				}
            				else {
HXDLIN( 261)					_hx_tmp2 = false;
            				}
HXDLIN( 261)				if (_hx_tmp2) {
HXDLIN( 261)					_hx_tmp1 = bitmap->_hx___bitmapData->_hx___isValid;
            				}
            				else {
HXDLIN( 261)					_hx_tmp1 = false;
            				}
HXDLIN( 261)				if (_hx_tmp1) {
HXDLIN( 261)					 ::lime::graphics::cairo::Cairo cairo = renderer->cairo;
HXDLIN( 261)					renderer->_hx___setBlendMode(bitmap->_hx___worldBlendMode);
HXDLIN( 261)					renderer->_hx___pushMaskObject(bitmap,null());
HXDLIN( 261)					renderer->applyMatrix(bitmap->_hx___renderTransform,cairo);
HXDLIN( 261)					 ::Dynamic surface = bitmap->_hx___bitmapData->getSurface();
HXDLIN( 261)					if (::hx::IsNotNull( surface )) {
HXDLIN( 261)						 ::Dynamic pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
HXDLIN( 261)						int _hx_tmp3;
HXDLIN( 261)						bool _hx_tmp4;
HXDLIN( 261)						if (renderer->_hx___allowSmoothing) {
HXDLIN( 261)							_hx_tmp4 = bitmap->smoothing;
            						}
            						else {
HXDLIN( 261)							_hx_tmp4 = false;
            						}
HXDLIN( 261)						if (_hx_tmp4) {
HXDLIN( 261)							_hx_tmp3 = 1;
            						}
            						else {
HXDLIN( 261)							_hx_tmp3 = 3;
            						}
HXDLIN( 261)						::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,_hx_tmp3);
HXDLIN( 261)						cairo->set_source(pattern);
HXDLIN( 261)						if ((alpha == 1)) {
HXDLIN( 261)							cairo->paint();
            						}
            						else {
HXDLIN( 261)							cairo->paintWithAlpha(alpha);
            						}
            					}
HXDLIN( 261)					renderer->_hx___popMaskObject(bitmap,null());
HXDLIN( 261)					renderer->_hx___setBlendMode(10);
            				}
            			}
            		}
            		else {
HXDLIN( 261)			::openfl::display::_internal::CairoDisplayObject_obj::render(shape,renderer);
            		}
HXDLIN( 261)		renderer->_hx___renderEvent(shape);
            	}
...
void CairoShape_obj::renderDrawableMask( ::openfl::display::Shape shape, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_b1fba0bba755bee2_266_renderDrawableMask)
HXDLIN( 266)		if (::hx::IsNotNull( shape->_hx___graphics )) {
HXDLIN( 266)			::openfl::display::_internal::CairoGraphics_obj::renderMask(shape->_hx___graphics,renderer);
            		}
            	}
