...
HXLINE( 129)						if (((offset + cacheBufferData->length) > _this8->length)) {
HXLINE( 129)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 129)						if ((_this8->bytesPerElement == cacheBufferData->bytesPerElement)) {
...
HXLINE( 129)							int _g = 0;
HXDLIN( 129)							int _g1 = cacheBufferData->length;
HXDLIN( 129)							while((_g < _g1)){
HXLINE( 129)								_g = (_g + 1);
HXDLIN( 129)								int i = (_g - 1);
HXDLIN( 129)								::lime::utils::ArrayBufferView_obj::transferElement(cacheBufferData,i,_this8,(offset + i));
            							}
            						}
            					}
            					else {
