...
HX_LOCAL_STACK_FRAME(_hx_pos_9214f9594be357b4_48_renderDrawableMask,"openfl.display._internal.CairoBitmapData","renderDrawableMask",0x4d290609,"openfl.display._internal.CairoBitmapData.renderDrawableMask","openfl/display/_internal/CairoBitmapData.hx",48,0xf08dfb3c)
namespace openfl{
namespace display{
namespace _internal{
...
HXLINE(  25)		renderer->applyMatrix(bitmapData->_hx___renderTransform,cairo);
HXLINE(  27)		 ::Dynamic surface = bitmapData->getSurface();
HXLINE(  29)		if (::hx::IsNotNull( surface )) {
HXLINE(  31)			 ::Dynamic pattern = ::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::createForSurface(surface);
HXLINE(  33)			bool _hx_tmp;
HXDLIN(  33)			if (renderer->_hx___allowSmoothing) {
HXLINE(  33)				_hx_tmp = (cairo->get_antialias() == 1);
            			}
            			else {
HXLINE(  33)				_hx_tmp = true;
            			}
HXDLIN(  33)			if (_hx_tmp) {
HXLINE(  35)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,3);
            			}
            			else {
HXLINE(  39)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,1);
            			}
HXLINE(  42)			cairo->set_source(pattern);
HXLINE(  43)			cairo->paint();
            		}
            	}
...
void CairoBitmapData_obj::renderDrawableMask( ::openfl::display::Tilemap tilemap, ::openfl::display::CairoRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_9214f9594be357b4_48_renderDrawableMask)
            	}
