...
HX_LOCAL_STACK_FRAME(_hx_pos_e8f34708793cba91_34_renderDrawableMask,"openfl.display._internal.CanvasBitmapData","renderDrawableMask",0xa8060041,"openfl.display._internal.CanvasBitmapData.renderDrawableMask","openfl/display/_internal/CanvasBitmapData.hx",34,0xa698878e)
namespace openfl{
namespace display{
namespace _internal{
...
void CanvasBitmapData_obj::renderDrawableMask( ::openfl::display::BitmapData bitmapData, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_e8f34708793cba91_34_renderDrawableMask)
            	}
