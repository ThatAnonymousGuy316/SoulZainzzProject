...
HX_DEFINE_STACK_FRAME(_hx_pos_064cc14bbb4441a0_42_new,"openfl.filters.BitmapFilterShader","new",0xcb76b60f,"openfl.filters.BitmapFilterShader.new","openfl/filters/BitmapFilterShader.hx",42,0x7f5a8bff)
namespace openfl{
namespace filters{

void BitmapFilterShader_obj::__construct( ::openfl::utils::ByteArrayData code){
            	HX_STACKFRAME(&_hx_pos_064cc14bbb4441a0_42_new)
...
HXLINE(  43)		super::__construct(code);
