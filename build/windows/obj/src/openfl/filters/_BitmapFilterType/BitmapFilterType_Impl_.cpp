...
HX_LOCAL_STACK_FRAME(_hx_pos_5a7216b527fd896d_28_fromString,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_","fromString",0x08c15429,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_.fromString","openfl/filters/BitmapFilterType.hx",28,0xe7df860a)
HX_LOCAL_STACK_FRAME(_hx_pos_5a7216b527fd896d_39_toString,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_","toString",0xe11e277a,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_.toString","openfl/filters/BitmapFilterType.hx",39,0xe7df860a)
HX_LOCAL_STACK_FRAME(_hx_pos_5a7216b527fd896d_14_boot,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_","boot",0x2ac7dc00,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_.boot","openfl/filters/BitmapFilterType.hx",14,0xe7df860a)
HX_LOCAL_STACK_FRAME(_hx_pos_5a7216b527fd896d_19_boot,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_","boot",0x2ac7dc00,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_.boot","openfl/filters/BitmapFilterType.hx",19,0xe7df860a)
HX_LOCAL_STACK_FRAME(_hx_pos_5a7216b527fd896d_24_boot,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_","boot",0x2ac7dc00,"openfl.filters._BitmapFilterType.BitmapFilterType_Impl_.boot","openfl/filters/BitmapFilterType.hx",24,0xe7df860a)
namespace openfl{
namespace filters{
...
bool BitmapFilterType_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic BitmapFilterType_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_5a7216b527fd896d_28_fromString)
...
::String BitmapFilterType_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_5a7216b527fd896d_39_toString)
HXDLIN(  39)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  41)			return HX_("full",8f,e9,c4,43);
HXDLIN(  41)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  42)			return HX_("inner",96,31,1c,be);
HXDLIN(  42)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==2) ){
HXLINE(  43)			return HX_("outer",7b,b8,28,37);
...
{
{
            	HX_STACKFRAME(&_hx_pos_5a7216b527fd896d_14_boot)
HXDLIN(  14)		FULL = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5a7216b527fd896d_19_boot)
HXDLIN(  19)		INNER = 1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_5a7216b527fd896d_24_boot)
HXDLIN(  24)		OUTER = 2;
            	}
}
