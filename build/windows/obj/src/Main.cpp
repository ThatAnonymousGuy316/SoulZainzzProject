...
HXLINE(  16)		this->initialState = ::hx::ClassOf< ::funkin::meta::states::InitState >();
...
HXLINE(  68)		::Paths_obj::getModFolders();
HXLINE(  69)		int _hx_tmp = this->gameWidth;
HXDLIN(  69)		int _hx_tmp1 = this->gameHeight;
HXDLIN(  69)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,_hx_tmp,_hx_tmp1,::flixel::util::typeLimit::_NextState::InitialState_Impl__obj::fromType(this->initialState),this->framerate,this->framerate,this->skipSplash,this->startFullscreen));
HXLINE(  72)		::Main_obj::fpsVar =  ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  73)		this->addChild(::Main_obj::fpsVar);
HXLINE(  74)		if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE(  75)			::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            		}
            	}
