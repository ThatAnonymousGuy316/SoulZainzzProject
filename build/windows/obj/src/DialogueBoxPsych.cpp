...
HXLINE( 184)			{
HXLINE( 184)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this = ::flixel::FlxG_obj::sound;
...
HXDLIN( 184)					asset = ::Paths_obj::customSoundsLoaded->get(file);
            				}
            				else {
HXLINE( 184)					asset = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + song) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            				}
HXDLIN( 184)				 ::flixel::sound::FlxSoundGroup group = null();
HXDLIN( 184)				 ::Dynamic onComplete = null();
HXDLIN( 184)				 ::flixel::sound::FlxSound _this1 = _this->recycleMusic(group)->loadHelper(asset,null(),null(),null());
HXDLIN( 184)				_this1->set_volume(( (Float)(0) ));
HXDLIN( 184)				_this1->loopUntil = -1;
HXDLIN( 184)				_this1->init(true,false,onComplete)->play(null(),null(),null());
            			}
HXLINE( 185)			{
HXLINE( 185)				 ::flixel::sound::FlxSound _this2 = ::flixel::FlxG_obj::sound->music;
HXDLIN( 185)				 ::Dynamic onComplete1 = null();
HXDLIN( 185)				if (::hx::IsNull( _this2->_channel )) {
HXLINE( 185)					_this2->play(null(),null(),null());
            				}
HXDLIN( 185)				if (::hx::IsNotNull( _this2->fadeTween )) {
HXLINE( 185)					_this2->fadeTween->cancel();
            				}
HXDLIN( 185)				_this2->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),( (Float)(1) ),2, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 189)		this->bgFade->scrollFactor->set(0,0);
...
HXLINE( 198)				_hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            			}
            		}
HXDLIN( 198)		 ::Dynamic _hx_tmp4;
...
HXLINE( 198)			_hx_tmp4 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("speech_bubble",49,db,97,da)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1);
            		}
HXDLIN( 198)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp3,_hx_tmp4));
HXLINE( 199)		this->box->scrollFactor->set(0,0);
...
HXLINE( 245)				Float _hx_tmp1 = _hx_char->get_width();
HXDLIN( 245)				_hx_char->setGraphicSize(::Std_obj::_hx_int(((_hx_tmp1 * ::DialogueCharacter_obj::DEFAULT_SCALE) * ( (Float)(_hx_char->jsonFile->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic)) ))),null());
HXLINE( 246)				_hx_char->updateHitbox();
HXLINE( 247)				_hx_char->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE( 248)				_hx_char->scrollFactor->set(0,0);
...
HXLINE( 268)				Float _hx_tmp2;
HXDLIN( 268)				if (saveY) {
HXLINE( 268)					_hx_tmp2 = y;
            				}
            				else {
HXLINE( 268)					_hx_tmp2 = x;
            				}
HXDLIN( 268)				_hx_char->startingPos = _hx_tmp2;
...
HXDLIN( 309)									int _g3 = checkArray->length;
HXDLIN( 309)									while((_g2 < _g3)){
HXLINE( 309)										_g2 = (_g2 + 1);
HXDLIN( 309)										int j = (_g2 - 1);
...
HXDLIN( 327)				_hx_tmp1->play(::Paths_obj::sound(HX_("dialogueClose",80,e3,49,e3),null()),null(),null(),null(),null(),null());
            			}
            			else {
...
HXDLIN( 330)					bool _hx_tmp4;
HXDLIN( 330)					if (::hx::IsNotNull( _hx_char )) {
HXLINE( 330)						_hx_tmp4 = ::hx::IsNotNull( _hx_char->animation->_curAnim );
            					}
            					else {
HXLINE( 330)						_hx_tmp4 = false;
            					}
HXDLIN( 330)					if (_hx_tmp4) {
HXLINE( 330)						_hx_tmp3 = _hx_char->animationIsLoop();
            					}
            					else {
HXLINE( 330)						_hx_tmp3 = false;
            					}
HXDLIN( 330)					if (_hx_tmp3) {
HXLINE( 330)						_hx_tmp2 = _hx_char->animation->get_finished();
            					}
            					else {
...
HXLINE( 334)					 ::DialogueCharacter char1 = this->arrayCharacters->__get(this->lastCharacter).StaticCast<  ::DialogueCharacter >();
HXLINE( 335)					bool _hx_tmp5;
HXDLIN( 335)					bool _hx_tmp6;
HXDLIN( 335)					if (::hx::IsNotNull( char1 )) {
HXLINE( 335)						_hx_tmp6 = ::hx::IsNotNull( char1->animation->_curAnim );
            					}
            					else {
HXLINE( 335)						_hx_tmp6 = false;
            					}
HXDLIN( 335)					if (_hx_tmp6) {
HXLINE( 335)						_hx_tmp5 = char1->animation->get_finished();
            					}
            					else {
HXLINE( 335)						_hx_tmp5 = false;
            					}
HXDLIN( 335)					if (_hx_tmp5) {
HXLINE( 336)						char1->animation->_curAnim->restart();
            					}
            				}
            			}
...
HXDLIN( 341)					int _g5 = this->textBoxTypes->length;
HXDLIN( 341)					while((_g4 < _g5)){
HXLINE( 341)						_g4 = (_g4 + 1);
HXDLIN( 341)						int i1 = (_g4 - 1);
HXLINE( 342)						::Array< ::String > checkArray1 = ::Array_obj< ::String >::fromData( _hx_array_data_c9b73088_18,2);
HXLINE( 343)						::String animName1 = this->box->animation->_curAnim->name;
HXLINE( 344)						{
HXLINE( 344)							int _g6 = 0;
HXDLIN( 344)							int _g7 = checkArray1->length;
HXDLIN( 344)							while((_g6 < _g7)){
HXLINE( 344)								_g6 = (_g6 + 1);
HXDLIN( 344)								int j1 = (_g6 - 1);
HXLINE( 345)								bool _hx_tmp7;
HXDLIN( 345)								if ((animName1 != (checkArray1->__get(j1) + this->textBoxTypes->__get(i1)))) {
HXLINE( 345)									_hx_tmp7 = (animName1 == ((checkArray1->__get(j1) + this->textBoxTypes->__get(i1)) + HX_("Open",ea,2f,8d,34)));
            								}
            								else {
HXLINE( 345)									_hx_tmp7 = true;
            								}
HXDLIN( 345)								if (_hx_tmp7) {
HXLINE( 346)									this->box->animation->play((checkArray1->__get(j1) + this->textBoxTypes->__get(i1)),true,null(),null());
            								}
            							}
            						}
            					}
...
HXLINE( 353)			bool _hx_tmp8;
HXDLIN( 353)			if ((this->lastCharacter != -1)) {
HXLINE( 353)				_hx_tmp8 = (this->arrayCharacters->length > 0);
            			}
            			else {
HXLINE( 353)				_hx_tmp8 = false;
            			}
HXDLIN( 353)			if (_hx_tmp8) {
HXLINE( 354)				int _g8 = 0;
HXDLIN( 354)				int _g9 = this->arrayCharacters->length;
HXDLIN( 354)				while((_g8 < _g9)){
HXLINE( 354)					_g8 = (_g8 + 1);
HXDLIN( 354)					int i2 = (_g8 - 1);
HXLINE( 355)					 ::DialogueCharacter char2 = this->arrayCharacters->__get(i2).StaticCast<  ::DialogueCharacter >();
HXLINE( 356)					if (::hx::IsNotNull( char2 )) {
HXLINE( 357)						if ((i2 != this->lastCharacter)) {
HXLINE( 358)							::String _hx_switch_0 = ( (::String)(char2->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
            							if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 363)								char2->set_y((char2->y + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 364)								if ((char2->y > (char2->startingPos + ::flixel::FlxG_obj::height))) {
HXLINE( 364)									char2->set_y((char2->startingPos + ::flixel::FlxG_obj::height));
            								}
HXLINE( 362)								goto _hx_goto_11;
            							}
            							if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE( 360)								char2->set_x((char2->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 361)								if ((char2->x < (char2->startingPos + this->offsetPos))) {
HXLINE( 361)									char2->set_x((char2->startingPos + this->offsetPos));
            								}
HXLINE( 359)								goto _hx_goto_11;
            							}
            							if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 366)								char2->set_x((char2->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 367)								if ((char2->x > (char2->startingPos - this->offsetPos))) {
HXLINE( 367)									char2->set_x((char2->startingPos - this->offsetPos));
            								}
HXLINE( 365)								goto _hx_goto_11;
            							}
            							_hx_goto_11:;
HXLINE( 369)							char2->set_alpha((char2->alpha - (( (Float)(3) ) * elapsed)));
HXLINE( 370)							if ((char2->alpha < ((Float)0.00001))) {
HXLINE( 370)								char2->set_alpha(((Float)0.00001));
            							}
            						}
            						else {
HXLINE( 372)							::String _hx_switch_1 = ( (::String)(char2->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
            							if (  (_hx_switch_1==HX_("center",d5,25,db,05)) ){
HXLINE( 377)								char2->set_y((char2->y - (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 378)								if ((char2->y < char2->startingPos)) {
HXLINE( 378)									char2->set_y(char2->startingPos);
            								}
HXLINE( 376)								goto _hx_goto_12;
            							}
            							if (  (_hx_switch_1==HX_("left",07,08,b0,47)) ){
HXLINE( 374)								char2->set_x((char2->x + (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 375)								if ((char2->x > char2->startingPos)) {
HXLINE( 375)									char2->set_x(char2->startingPos);
            								}
HXLINE( 373)								goto _hx_goto_12;
            							}
            							if (  (_hx_switch_1==HX_("right",dc,0b,64,e9)) ){
HXLINE( 380)								char2->set_x((char2->x - (( (Float)(this->scrollSpeed) ) * elapsed)));
HXLINE( 381)								if ((char2->x < char2->startingPos)) {
HXLINE( 381)									char2->set_x(char2->startingPos);
            								}
HXLINE( 379)								goto _hx_goto_12;
            							}
            							_hx_goto_12:;
HXLINE( 383)							char2->set_alpha((char2->alpha + (( (Float)(3) ) * elapsed)));
HXLINE( 384)							if ((char2->alpha > 1)) {
HXLINE( 384)								char2->set_alpha(( (Float)(1) ));
            							}
            						}
            					}
            				}
...
HXLINE( 390)				_hx_tmp9 = (this->box->animation->_curAnim->curFrame <= 0);
            			}
            			else {
...
HXLINE( 398)				 ::flixel::FlxSprite fh1 = this->bgFade;
HXDLIN( 398)				fh1->set_alpha((fh1->alpha - (((Float)0.5) * elapsed)));
...
HXDLIN( 407)				int _g11 = this->arrayCharacters->length;
HXDLIN( 407)				while((_g10 < _g11)){
HXLINE( 407)					_g10 = (_g10 + 1);
HXDLIN( 407)					int i3 = (_g10 - 1);
HXLINE( 408)					 ::DialogueCharacter leChar = this->arrayCharacters->__get(i3).StaticCast<  ::DialogueCharacter >();
HXLINE( 409)					if (::hx::IsNotNull( leChar )) {
HXLINE( 410)						::String _hx_switch_2 = ( (::String)(this->arrayCharacters->__get(i3).StaticCast<  ::DialogueCharacter >()->jsonFile->__Field(HX_("dialogue_pos",ad,3b,6d,1a),::hx::paccDynamic)) );
...
HXLINE( 422)			bool _hx_tmp10;
HXDLIN( 422)			if (::hx::IsNull( this->box )) {
HXLINE( 422)				_hx_tmp10 = ::hx::IsNull( this->bgFade );
            			}
            			else {
HXLINE( 422)				_hx_tmp10 = false;
            			}
HXDLIN( 422)			if (_hx_tmp10) {
HXLINE( 423)				{
HXLINE( 423)					int _g12 = 0;
HXDLIN( 423)					int _g13 = this->arrayCharacters->length;
HXDLIN( 423)					while((_g12 < _g13)){
HXLINE( 423)						_g12 = (_g12 + 1);
HXDLIN( 423)						int i4 = (_g12 - 1);
HXLINE( 424)						 ::DialogueCharacter leChar1 = this->arrayCharacters->__get(0).StaticCast<  ::DialogueCharacter >();
HXLINE( 425)						if (::hx::IsNotNull( leChar1 )) {
HXLINE( 426)							this->arrayCharacters->remove(leChar1);
HXLINE( 427)							leChar1->kill();
HXLINE( 428)							this->remove(leChar1,null());
HXLINE( 429)							leChar1->destroy();
            						}
            					}
            				}
...
HXDLIN( 462)				int i1 = (_g2 - 1);
HXLINE( 463)				if (::hx::IsEq( this->arrayCharacters->__get(i1).StaticCast<  ::DialogueCharacter >()->curCharacter,curDialogue->__Field(HX_("portrait",5b,21,af,b8),::hx::paccDynamic) )) {
HXLINE( 464)					character = i1;
...
HXLINE( 531)			box->offset->set_y((box->offset->y + 10));
            		}
            	}
