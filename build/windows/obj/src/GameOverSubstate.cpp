...
HXLINE(  47)		Float x1 = this->bf->getGraphicMidpoint(null())->x;
HXDLIN(  47)		Float y1 = this->bf->getGraphicMidpoint(null())->y;
HXDLIN(  47)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN(  47)		point->_inPool = false;
HXDLIN(  47)		this->camFollow = point;
HXLINE(  49)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN(  49)		_hx_tmp->play(::Paths_obj::sound(::GameOverSubstate_obj::deathSoundName,null()),null(),null(),null(),null(),null());
HXLINE(  50)		::Conductor_obj::changeBPM(( (Float)(100) ));
HXLINE(  53)		::flixel::FlxG_obj::camera->scroll->set(0,0);
...
HXLINE(  91)			{
HXLINE(  91)				 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this1 = ::flixel::FlxG_obj::sound;
...
HXDLIN(  91)					asset = ::Paths_obj::customSoundsLoaded->get(file);
            				}
            				else {
HXLINE(  91)					asset = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            				}
HXDLIN(  91)				 ::flixel::sound::FlxSoundGroup group = null();
HXDLIN(  91)				 ::Dynamic onComplete = null();
HXDLIN(  91)				 ::flixel::sound::FlxSound _this2 = _this1->recycleMusic(group)->loadHelper(asset,null(),null(),null());
HXDLIN(  91)				_this2->set_volume(((Float)1.0));
HXDLIN(  91)				_this2->loopUntil = -1;
HXDLIN(  91)				_this2->init(true,false,onComplete)->play(null(),null(),null());
            			}
...
HXDLIN( 128)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this = ::flixel::FlxG_obj::sound;
...
HXDLIN( 128)			asset = ::Paths_obj::customSoundsLoaded->get(file);
            		}
            		else {
HXDLIN( 128)			asset = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + key) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            		}
HXDLIN( 128)		 ::flixel::sound::FlxSoundGroup group = null();
HXDLIN( 128)		 ::Dynamic onComplete = null();
HXDLIN( 128)		 ::flixel::sound::FlxSound _this1 = _this->recycleMusic(group)->loadHelper(asset,null(),null(),null());
HXDLIN( 128)		_this1->set_volume(( (Float)(volume) ));
HXDLIN( 128)		_this1->loopUntil = -1;
HXDLIN( 128)		_this1->init(true,false,onComplete)->play(null(),null(),null());
            	}
...
HXLINE( 143)					::MusicBeatState_obj::switchState(::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false));
            				}
