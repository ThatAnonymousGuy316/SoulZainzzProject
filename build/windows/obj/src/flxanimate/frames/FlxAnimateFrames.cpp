...
HXLINE(  77)			{
HXLINE(  77)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(  77)				_this->advanced(HX_("the Frames parsing couldn't parse any of the frames, it's completely empty! \n Maybe you misspelled the Path?",ff,0a,77,40),_this->styles->error,true,::hx::SourceInfo(HX_("flxanimate/frames/FlxAnimateFrames.hx",20,95,16,11),77,HX_("flxanimate.frames.FlxAnimateFrames",3e,8a,4b,fc),HX_("fromTextureAtlas",fa,62,e9,b8)));
            			}
...
HXDLIN( 121)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 121)				rect->_inPool = false;
HXDLIN( 121)				rect->_weak = false;
HXDLIN( 121)				 ::flixel::math::FlxRect _this = rect;
HXDLIN( 121)				_this->x = x;
HXDLIN( 121)				_this->y = y;
HXDLIN( 121)				_this->width = width;
HXDLIN( 121)				_this->height = height;
HXDLIN( 121)				 ::flixel::math::FlxRect rect1 = _this;
HXLINE( 122)				if (( (bool)(limb->__Field(HX_("rotated",a9,49,1d,f1),::hx::paccDynamic)) )) {
HXLINE( 123)					Float Height = rect1->width;
HXDLIN( 123)					rect1->width = rect1->height;
HXDLIN( 123)					rect1->height = Height;
            				}
...
HXDLIN( 198)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 198)				rect->_inPool = false;
HXDLIN( 198)				rect->_weak = false;
HXDLIN( 198)				 ::flixel::math::FlxRect _this = rect;
HXDLIN( 198)				_this->x = x;
HXDLIN( 198)				_this->y = y;
HXDLIN( 198)				_this->width = width;
HXDLIN( 198)				_this->height = height;
HXDLIN( 198)				 ::flixel::math::FlxRect rect1 = _this;
...
HXLINE( 220)				Float x1 = -(size->x);
HXDLIN( 220)				Float y1 = -(size->y);
HXDLIN( 220)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 220)				point->_inPool = false;
HXDLIN( 220)				 ::flixel::math::FlxBasePoint offset = point;
HXLINE( 221)				Float x2 = size->width;
HXDLIN( 221)				Float y2 = size->height;
HXDLIN( 221)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x2,y2);
HXDLIN( 221)				point1->_inPool = false;
HXDLIN( 221)				 ::flixel::math::FlxBasePoint sourceSize = point1;
HXLINE( 223)				offset->set((offset->x - pivotX),(offset->y - pivotY));
...
HXLINE( 225)					sourceSize->set(size->height,size->width);
            				}
...
HXDLIN( 346)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 346)				rect->_inPool = false;
HXDLIN( 346)				rect->_weak = false;
HXDLIN( 346)				 ::flixel::math::FlxRect _this = rect;
HXDLIN( 346)				_this->x = x;
HXDLIN( 346)				_this->y = y;
HXDLIN( 346)				_this->width = width;
HXDLIN( 346)				_this->height = height;
HXDLIN( 346)				 ::flixel::math::FlxRect dimensions = _this;
HXLINE( 348)				Float x1 = ::Std_obj::parseFloat(source->__get(0));
HXDLIN( 348)				Float y1 = ::Std_obj::parseFloat(source->__get(1));
HXDLIN( 348)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 348)				point->_inPool = false;
HXDLIN( 348)				 ::flixel::math::FlxBasePoint sourceSize = point;
HXLINE( 350)				Float x2 = ::Std_obj::parseFloat(offset->__get(0));
HXDLIN( 350)				Float y2 = ::Std_obj::parseFloat(offset->__get(1));
HXDLIN( 350)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x2,y2);
HXDLIN( 350)				point1->_inPool = false;
HXDLIN( 350)				 ::flixel::math::FlxBasePoint offset1 = point1;
HXLINE( 352)				if (rotated) {
HXLINE( 354)					{
HXLINE( 354)						Float Height = dimensions->width;
HXDLIN( 354)						dimensions->width = dimensions->height;
HXDLIN( 354)						dimensions->height = Height;
            					}
HXLINE( 355)					sourceSize->set(sourceSize->x,sourceSize->y);
            				}
...
HXDLIN( 402)						 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 402)						rect->_inPool = false;
HXDLIN( 402)						rect->_weak = false;
HXDLIN( 402)						 ::flixel::math::FlxRect _this = rect;
...
HXLINE( 402)						::flxanimate::frames::FlxAnimateFrames_obj::sliceFrame(_hx_tmp,false,_this,null(),point1,frames);
...
HXLINE( 418)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 418)			rect->_inPool = false;
HXDLIN( 418)			rect->_weak = false;
HXDLIN( 418)			 ::flixel::math::FlxRect _this = rect;
HXDLIN( 418)			_this->x = ( (Float)(0) );
HXDLIN( 418)			_this->y = ( (Float)(0) );
HXDLIN( 418)			_this->width = ( (Float)(1) );
HXDLIN( 418)			_this->height = ( (Float)(1) );
HXDLIN( 418)			Frames->addEmptyFrame(_this);
            		}
            		else {
...
HXLINE( 421)				_hx_tmp2 = offset->set((offset->x * ( (Float)(-1) )),(offset->y * ( (Float)(-1) )));
            			}
            			else {
