...
HXDLIN(  80)				_this->advanced(((HX_("There's no layer called \"",7d,e4,11,ee) + name1) + HX_("\"!",bf,1d,00,00)),_this->styles->error,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxTimeline.hx",79,0b,d0,bc),80,HX_("flxanimate.animate.FlxTimeline",27,32,74,9f),HX_("hide",c2,34,0e,45)));
            			}
HXLINE(  81)			return;
            		}
...
HXDLIN(  85)				_this1->advanced(((HX_("The layer called \"",dd,88,f0,6b) + name1) + HX_("\" is already hidden!",f7,89,ae,96)),_this1->styles->error,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxTimeline.hx",79,0b,d0,bc),85,HX_("flxanimate.animate.FlxTimeline",27,32,74,9f),HX_("hide",c2,34,0e,45)));
            			}
HXLINE(  86)			return;
            		}
...
HXDLIN( 101)				_this->advanced(((HX_("There's no layer called \"",7d,e4,11,ee) + name1) + HX_("\"!",bf,1d,00,00)),_this->styles->error,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxTimeline.hx",79,0b,d0,bc),101,HX_("flxanimate.animate.FlxTimeline",27,32,74,9f),HX_("show",fd,d4,52,4c)));
            			}
HXLINE( 102)			return;
            		}
HXLINE( 104)		if (layer->visible) {
HXLINE( 106)			{
HXLINE( 106)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 106)				_this1->advanced(((HX_("The layer called \"",dd,88,f0,6b) + name1) + HX_("\" is not hidden!",72,1a,8e,ac)),_this1->styles->error,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxTimeline.hx",79,0b,d0,bc),106,HX_("flxanimate.animate.FlxTimeline",27,32,74,9f),HX_("show",fd,d4,52,4c)));
            			}
HXLINE( 107)			return;
            		}
...
HXLINE( 150)			{
HXLINE( 150)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 150)				_this->advanced(((HX_("There's no layer called \"",7d,e4,11,ee) + name) + HX_("\"!",bf,1d,00,00)),_this->styles->error,true,::hx::SourceInfo(HX_("flxanimate/animate/FlxTimeline.hx",79,0b,d0,bc),150,HX_("flxanimate.animate.FlxTimeline",27,32,74,9f),HX_("remove",44,9c,88,04)));
            			}
