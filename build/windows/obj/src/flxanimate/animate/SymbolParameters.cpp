...
HXDLIN( 140)		this->transformationPoint = point;
...
HXLINE( 241)		this->transformationPoint->set(0,0);
...
HXLINE( 359)			this->_filterFrame->sourceSize->set(rect->width,rect->height);
