...
HXDLIN(  24)				 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(image);
HXDLIN(  24)				 ::Dynamic _hx_tmp2;
HXDLIN(  24)				if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE(  24)					_hx_tmp2 = imageToReturn1;
            				}
            				else {
HXLINE(  24)					_hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + image) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            				}
HXDLIN(  24)				this->loadGraphic(_hx_tmp2,null(),null(),null(),null(),null());
            			}
HXLINE(  26)			this->set_active(false);
            		}
HXLINE(  28)		this->scrollFactor->set(( (Float)(scrollX) ),( (Float)(scrollY) ));
