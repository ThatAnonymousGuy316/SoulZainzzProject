...
HX_LOCAL_STACK_FRAME(_hx_pos_ea0e6435c6f91785_116_fromBytes,"lime.net._HTTPRequest_lime_utils_Bytes","fromBytes",0x77f65513,"lime.net._HTTPRequest_lime_utils_Bytes.fromBytes","lime/utils/Bytes.hx",116,0x9fbf972b)
namespace lime{
namespace net{
...
bool _HTTPRequest_lime_utils_Bytes_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic _HTTPRequest_lime_utils_Bytes_obj::fromBytes( ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_ea0e6435c6f91785_116_fromBytes)
HXDLIN( 116)		return ::lime::utils::_Bytes::Bytes_Impl__obj::fromBytes(bytes);
            	}
