...
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_466_get_src,"lime.media.AudioBuffer","get_src",0x0f304c40,"lime.media.AudioBuffer.get_src","lime/media/AudioBuffer.hx",466,0xf6fabaad)
HX_LOCAL_STACK_FRAME(_hx_pos_3ac99a7056b92cf3_483_set_src,"lime.media.AudioBuffer","set_src",0x0231dd4c,"lime.media.AudioBuffer.set_src","lime/media/AudioBuffer.hx",483,0xf6fabaad)
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,dispose,(void))
 ...
 ::Dynamic AudioBuffer_obj::get_src(){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_466_get_src)
HXDLIN( 466)		return this->_hx___srcVorbisFile;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(AudioBuffer_obj,get_src,return )
 ...
 ::Dynamic AudioBuffer_obj::set_src( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_3ac99a7056b92cf3_483_set_src)
HXDLIN( 483)		return (this->_hx___srcVorbisFile = ( ( ::lime::media::vorbis::VorbisFile)(value) ));
            	}
...
HXLINE( 422)		::String signature = null();
HXLINE( 423)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 425)			signature = bytes->getString(0,4,null());
            		} catch( ::Dynamic _hx_e) {
...
HXLINE( 434)		::String _hx_switch_0 = signature;
            		if (  (_hx_switch_0==HX_("OggS",44,5d,86,34)) ){
HXLINE( 437)			return HX_("audio/ogg",56,37,42,54);
HXDLIN( 437)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("RIFF",b7,20,6b,36)) ){
HXLINE( 440)			if ((bytes->getString(8,4,null()) == HX_("WAVE",b9,2d,b3,39))) {
HXLINE( 441)				return HX_("audio/wav",33,44,48,54);
            			}
            			else {
HXLINE( 443)				int _g1 = ( (int)(bytes->b->__get(1)) );
HXDLIN( 443)				int _g2 = ( (int)(bytes->b->__get(2)) );
HXDLIN( 443)				switch((int)(( (int)(bytes->b->__get(0)) ))){
            					case (int)73: {
HXLINE( 443)						if ((_g1 == 68)) {
HXLINE( 443)							if ((_g2 == 51)) {
HXLINE( 445)								return HX_("audio/mp3",77,ba,40,54);
            							}
            						}
            					}
            					break;
            					case (int)255: {
HXLINE( 443)						switch((int)(_g1)){
...
HXLINE( 440)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("fLaC",68,c3,a5,43)) ){
HXLINE( 439)			return HX_("audio/flac",c1,0e,bf,5f);
HXDLIN( 439)			goto _hx_goto_14;
            		}
            		/* default */{
HXLINE( 443)			int _g3 = ( (int)(bytes->b->__get(1)) );
HXDLIN( 443)			int _g4 = ( (int)(bytes->b->__get(2)) );
HXDLIN( 443)			switch((int)(( (int)(bytes->b->__get(0)) ))){
            				case (int)73: {
HXLINE( 443)					if ((_g3 == 68)) {
HXLINE( 443)						if ((_g4 == 51)) {
HXLINE( 445)							return HX_("audio/mp3",77,ba,40,54);
            						}
            					}
            				}
...
HXLINE( 445)							return HX_("audio/mp3",77,ba,40,54);
            		...
            		_hx_goto_14:;
HXLINE( 450)		::lime::utils::Log_obj::error(HX_("Unsupported sound format",d3,74,34,38),::hx::SourceInfo(HX_("lime/media/AudioBuffer.hx",ad,ba,fa,f6),450,HX_("lime.media.AudioBuffer",33,70,4b,3a),HX_("__getCodec",40,d9,65,4d)));
