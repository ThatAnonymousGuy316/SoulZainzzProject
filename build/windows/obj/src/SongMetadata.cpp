...
HX_DEFINE_STACK_FRAME(_hx_pos_66f21fcacf595f6d_385_new,"SongMetadata","new",0x0585a376,"SongMetadata.new","FreeplayState.hx",385,0x0d86f62d)

void SongMetadata_obj::__construct(::String song,int week,::String songCharacter,int color){
            	HX_STACKFRAME(&_hx_pos_66f21fcacf595f6d_385_new)
HXLINE( 391)		this->folder = HX_("",00,00,00,00);
HXLINE( 390)		this->color = -7179779;
HXLINE( 389)		this->songCharacter = HX_("",00,00,00,00);
HXLINE( 388)		this->week = 0;
HXLINE( 387)		this->songName = HX_("",00,00,00,00);
HXLINE( 395)		this->songName = song;
HXLINE( 396)		this->week = week;
HXLINE( 397)		this->songCharacter = songCharacter;
HXLINE( 398)		this->color = color;
HXLINE( 399)		this->folder = ::Paths_obj::currentModDirectory;
HXLINE( 400)		if (::hx::IsNull( this->folder )) {
HXLINE( 400)			this->folder = HX_("",00,00,00,00);
            		}
            	}
