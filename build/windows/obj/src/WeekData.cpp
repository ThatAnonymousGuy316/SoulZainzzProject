...
HXLINE(  98)		{
HXLINE(  98)			int _g2 = 0;
HXDLIN(  98)			int _g3 = sexList->length;
HXDLIN(  98)			while((_g2 < _g3)){
HXLINE(  98)				_g2 = (_g2 + 1);
HXDLIN(  98)				int i = (_g2 - 1);
HXLINE(  99)				{
HXLINE(  99)					int _g4 = 0;
HXDLIN(  99)					int _g5 = directories->length;
HXDLIN(  99)					while((_g4 < _g5)){
HXLINE(  99)						_g4 = (_g4 + 1);
HXDLIN(  99)						int j = (_g4 - 1);
...
HXLINE( 112)											_hx_tmp2 = !(weekFile->hideStoryMode);
            										}
            										else {
...
HXLINE( 112)										if (!(( (bool)(isStoryMode) ))) {
HXLINE( 112)											_hx_tmp1 = !(weekFile->hideFreeplay);
            										}
            										else {
...
HXLINE( 122)		{
HXLINE( 122)			int _g6 = 0;
HXDLIN( 122)			int _g7 = directories->length;
HXDLIN( 122)			while((_g6 < _g7)){
HXLINE( 122)				_g6 = (_g6 + 1);
HXDLIN( 122)				int i1 = (_g6 - 1);
HXLINE( 123)				::String directory = (directories->__get(i1) + HX_("weeks/",50,a9,04,ff));
HXLINE( 124)				if (::sys::FileSystem_obj::exists(directory)) {
HXLINE( 125)					int _g8 = 0;
HXDLIN( 125)					::Array< ::String > _g9 = ::sys::FileSystem_obj::readDirectory(directory);
HXDLIN( 125)					while((_g8 < _g9->length)){
HXLINE( 125)						::String file1 = _g9->__get(_g8);
HXDLIN( 125)						_g8 = (_g8 + 1);
HXLINE( 126)						::String path1 = ::haxe::io::Path_obj::join(::Array_obj< ::String >::__new(2)->init(0,directory)->init(1,file1));
HXLINE( 127)						bool _hx_tmp3;
HXDLIN( 127)						if (!(::sys::FileSystem_obj::isDirectory(path1))) {
HXLINE( 127)							_hx_tmp3 = ::StringTools_obj::endsWith(file1,HX_(".json",56,f1,d6,c2));
            						}
            						else {
HXLINE( 127)							_hx_tmp3 = false;
            						}
HXDLIN( 127)						if (_hx_tmp3) {
HXLINE( 128)							::String weekToCheck = file1.substr(0,(file1.length - 5));
HXLINE( 129)							if (!(::WeekData_obj::weeksLoaded->exists(weekToCheck))) {
HXLINE( 130)								 ::Dynamic week1 = ::WeekData_obj::getWeekFile(path1);
HXLINE( 131)								if (::hx::IsNotNull( week1 )) {
HXLINE( 132)									 ::WeekData weekFile1 =  ::WeekData_obj::__alloc( HX_CTX ,week1);
HXLINE( 133)									if ((i1 >= originalLength)) {
HXLINE( 134)										weekFile1->folder = directories->__get(i1).substring(HX_("mods/",9e,2f,58,0c).length,(directories->__get(i1).length - 1));
            									}
HXLINE( 137)									bool _hx_tmp4;
HXDLIN( 137)									bool _hx_tmp5;
HXDLIN( 137)									if (( (bool)(isStoryMode) )) {
HXLINE( 137)										_hx_tmp5 = !(weekFile1->hideStoryMode);
            									}
            									else {
...
HXLINE( 137)											_hx_tmp4 = !(weekFile1->hideFreeplay);
            										}
            										else {
...
HXLINE( 138)										::WeekData_obj::weeksLoaded->set(weekToCheck,weekFile1);
