...
HX_DEFINE_STACK_FRAME(_hx_pos_b2ff2ad71752a816_233_new,"__ASSET__assets_fonts_vcr_ttf","new",0xbb14ed97,"__ASSET__assets_fonts_vcr_ttf.new","lime/_internal/macros/AssetsMacro.hx",233,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ff2ad71752a816_230_boot,"__ASSET__assets_fonts_vcr_ttf","boot",0xef53f71b,"__ASSET__assets_fonts_vcr_ttf.boot","lime/_internal/macros/AssetsMacro.hx",230,0xc651f030)

void __ASSET__assets_fonts_vcr_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b2ff2ad71752a816_233_new)
HXLINE( 234)		super::__construct(null());
HXLINE( 236)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__assets_fonts_vcr_ttf_obj::resourceName));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_b2ff2ad71752a816_230_boot)
HXDLIN( 230)		resourceName = HX_("LIME_font___ASSET__assets_fonts_vcr_ttf",9f,aa,95,e0);
            	}
}
