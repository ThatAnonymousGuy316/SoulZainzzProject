...
HX_DEFINE_STACK_FRAME(_hx_pos_0e989bab684323cb_1768_new,"flixel.math.FlxCallbackPoint","new",0x2af621df,"flixel.math.FlxCallbackPoint.new","flixel/math/FlxPoint.hx",1768,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1785_set,"flixel.math.FlxCallbackPoint","set",0x2af9ed21,"flixel.math.FlxCallbackPoint.set","flixel/math/FlxPoint.hx",1785,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1802_set_x,"flixel.math.FlxCallbackPoint","set_x",0x4f288a9a,"flixel.math.FlxCallbackPoint.set_x","flixel/math/FlxPoint.hx",1802,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1815_set_y,"flixel.math.FlxCallbackPoint","set_y",0x4f288a9b,"flixel.math.FlxCallbackPoint.set_y","flixel/math/FlxPoint.hx",1815,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1828_destroy,"flixel.math.FlxCallbackPoint","destroy",0xdd08a9f9,"flixel.math.FlxCallbackPoint.destroy","flixel/math/FlxPoint.hx",1828,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_0e989bab684323cb_1835_put,"flixel.math.FlxCallbackPoint","put",0x2af7b44e,"flixel.math.FlxCallbackPoint.put","flixel/math/FlxPoint.hx",1835,0xb3e1cd2c)
namespace flixel{
namespace math{

void FlxCallbackPoint_obj::__construct( ::Dynamic setXCallback, ::Dynamic setYCallback, ::Dynamic setXYCallback){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1768_new)
HXLINE(1769)		super::__construct(null(),null());
HXLINE(1772)		bool _hx_tmp;
HXDLIN(1772)		bool _hx_tmp1;
HXDLIN(1772)		if (::hx::IsNotNull( setXCallback )) {
HXLINE(1772)			_hx_tmp1 = ::hx::IsNull( setYCallback );
            		}
            		else {
HXLINE(1772)			_hx_tmp1 = false;
            		}
HXDLIN(1772)		if (_hx_tmp1) {
HXLINE(1772)			_hx_tmp = ::hx::IsNull( setXYCallback );
            		}
            		else {
HXLINE(1772)			_hx_tmp = false;
            		}
HXDLIN(1772)		if (_hx_tmp) {
HXLINE(1774)			this->_setXYCallback = setXCallback;
            		}
            		else {
HXLINE(1778)			this->_setXCallback = setXCallback;
HXLINE(1779)			this->_setYCallback = setYCallback;
HXLINE(1780)			this->_setXYCallback = setXYCallback;
            		}
            	}
...
bool FlxCallbackPoint_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::math::FlxBasePoint FlxCallbackPoint_obj::set(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1785_set)
HXLINE(1786)		this->x = x;
HXLINE(1787)		this->y = y;
HXLINE(1789)		if (::hx::IsNotNull( this->_setXCallback )) {
HXLINE(1790)			this->_setXCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1792)		if (::hx::IsNotNull( this->_setYCallback )) {
HXLINE(1793)			this->_setYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1795)		if (::hx::IsNotNull( this->_setXYCallback )) {
HXLINE(1796)			this->_setXYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1798)		return ::hx::ObjectPtr<OBJ_>(this);
            	}


Float FlxCallbackPoint_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1802_set_x)
HXLINE(1803)		this->super::set_x(value);
HXLINE(1805)		if (::hx::IsNotNull( this->_setXCallback )) {
HXLINE(1806)			this->_setXCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1808)		if (::hx::IsNotNull( this->_setXYCallback )) {
HXLINE(1809)			this->_setXYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
...
Float FlxCallbackPoint_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1815_set_y)
HXLINE(1816)		this->super::set_y(value);
HXLINE(1818)		if (::hx::IsNotNull( this->_setYCallback )) {
HXLINE(1819)			this->_setYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1821)		if (::hx::IsNotNull( this->_setXYCallback )) {
HXLINE(1822)			this->_setXYCallback(::hx::ObjectPtr<OBJ_>(this));
            		}
HXLINE(1824)		return value;
            	}


void FlxCallbackPoint_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1828_destroy)
HXLINE(1829)		this->super::destroy();
HXLINE(1830)		this->_setXCallback = null();
HXLINE(1831)		this->_setYCallback = null();
HXLINE(1832)		this->_setXYCallback = null();
            	}


void FlxCallbackPoint_obj::put(){
            	HX_STACKFRAME(&_hx_pos_0e989bab684323cb_1835_put)
            	}
