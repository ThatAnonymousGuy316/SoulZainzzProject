...
HX_DEFINE_STACK_FRAME(_hx_pos_4bc163271948760e_1551_new,"flixel.math.FlxBasePoint","new",0x6212f113,"flixel.math.FlxBasePoint.new","flixel/math/FlxPoint.hx",1551,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1614_set,"flixel.math.FlxBasePoint","set",0x6216bc55,"flixel.math.FlxBasePoint.set","flixel/math/FlxPoint.hx",1614,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1626_put,"flixel.math.FlxBasePoint","put",0x62148382,"flixel.math.FlxBasePoint.put","flixel/math/FlxPoint.hx",1626,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1641_putWeak,"flixel.math.FlxBasePoint","putWeak",0x8df7f51a,"flixel.math.FlxBasePoint.putWeak","flixel/math/FlxPoint.hx",1641,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1655_equals,"flixel.math.FlxBasePoint","equals",0x5cb8ff6c,"flixel.math.FlxBasePoint.equals","flixel/math/FlxPoint.hx",1655,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1664_destroy,"flixel.math.FlxBasePoint","destroy",0xb50f232d,"flixel.math.FlxBasePoint.destroy","flixel/math/FlxPoint.hx",1664,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1671_toString,"flixel.math.FlxBasePoint","toString",0x1fbd4719,"flixel.math.FlxBasePoint.toString","flixel/math/FlxPoint.hx",1671,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1679_set_x,"flixel.math.FlxBasePoint","set_x",0x227e8ece,"flixel.math.FlxBasePoint.set_x","flixel/math/FlxPoint.hx",1679,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1687_set_y,"flixel.math.FlxBasePoint","set_y",0x227e8ecf,"flixel.math.FlxBasePoint.set_y","flixel/math/FlxPoint.hx",1687,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1566_get,"flixel.math.FlxBasePoint","get",0x620da149,"flixel.math.FlxBasePoint.get","flixel/math/FlxPoint.hx",1566,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1585_weak,"flixel.math.FlxBasePoint","weak",0x7472d865,"flixel.math.FlxBasePoint.weak","flixel/math/FlxPoint.hx",1585,0xb3e1cd2c)
HX_LOCAL_STACK_FRAME(_hx_pos_4bc163271948760e_1554_boot,"flixel.math.FlxBasePoint","boot",0x6699001f,"flixel.math.FlxBasePoint.boot","flixel/math/FlxPoint.hx",1554,0xb3e1cd2c)
namespace flixel{
namespace math{
...
void FlxBasePoint_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1551_new)
HXLINE(1598)		this->_inPool = false;
HXLINE(1597)		this->_weak = false;
HXLINE(1594)		this->y = ((Float)0);
HXLINE(1593)		this->x = ((Float)0);
HXLINE(1604)		this->set(x,y);
            	}
...
static ::flixel::util::IFlxPooled_obj _hx_flixel_math_FlxBasePoint__hx_flixel_util_IFlxPooled= {
	...
	( void (::hx::Object::*)())&::flixel::math::FlxBasePoint_obj::putWeak,
};
...
void *FlxBasePoint_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::math::FlxBasePoint FlxBasePoint_obj::set(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1614_set)
HXLINE(1615)		this->set_x(x);
HXLINE(1616)		this->set_y(y);
HXLINE(1617)		return ::hx::ObjectPtr<OBJ_>(this);
            	}
...
void FlxBasePoint_obj::put(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1626_put)
HXDLIN(1626)		if (!(this->_inPool)) {
HXLINE(1628)			this->_inPool = true;
HXLINE(1629)			this->_weak = false;
HXLINE(1630)			::flixel::math::FlxBasePoint_obj::pool->putUnsafe(::hx::ObjectPtr<OBJ_>(this));
            		}
            	}
...
void FlxBasePoint_obj::putWeak(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1641_putWeak)
HXDLIN(1641)		if (this->_weak) {
HXLINE(1643)			this->put();
            		}
            	}
...
bool FlxBasePoint_obj::equals( ::flixel::math::FlxBasePoint point){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1655_equals)
HXLINE(1656)		bool result;
HXDLIN(1656)		if ((::Math_obj::abs((this->x - point->x)) <= ((Float)0.0000001))) {
HXLINE(1656)			result = (::Math_obj::abs((this->y - point->y)) <= ((Float)0.0000001));
            		}
            		else {
HXLINE(1656)			result = false;
            		}
HXLINE(1657)		if (point->_weak) {
HXLINE(1657)			point->put();
            		}
HXLINE(1658)		return result;
            	}
...
void FlxBasePoint_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1664_destroy)
            	}
...
::String FlxBasePoint_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1671_toString)
HXDLIN(1671)		 ::Dynamic value = this->x;
HXDLIN(1671)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(1671)		_this->label = HX_("x",78,00,00,00);
HXDLIN(1671)		_this->value = value;
HXDLIN(1671)		 ::Dynamic value1 = this->y;
HXDLIN(1671)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN(1671)		_this1->label = HX_("y",79,00,00,00);
HXDLIN(1671)		_this1->value = value1;
HXDLIN(1671)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_this)->init(1,_this1));
            	}
...
Float FlxBasePoint_obj::set_x(Float Value){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1679_set_x)
HXDLIN(1679)		return (this->x = Value);
            	}
...
Float FlxBasePoint_obj::set_y(Float Value){
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1687_set_y)
HXDLIN(1687)		return (this->y = Value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxBasePoint_obj,set_y,return )
 ...
 ::flixel::math::FlxBasePoint FlxBasePoint_obj::get(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1566_get)
HXLINE(1568)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXLINE(1569)		point->_inPool = false;
HXLINE(1570)		return point;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxBasePoint_obj,get,return )
 ...
 ::flixel::math::FlxBasePoint FlxBasePoint_obj::weak(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		Float x = __o_x.Default(0);
            		Float y = __o_y.Default(0);
            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1585_weak)
HXLINE(1586)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN(1586)		point->_inPool = false;
HXDLIN(1586)		 ::flixel::math::FlxBasePoint point1 = point;
HXLINE(1588)		point1->_weak = true;
HXLINE(1590)		return point1;
            	}
            		 ...
            		 ::flixel::util::FlxPool _hx_run(){
            			HX_BEGIN_LOCAL_FUNC_S2(::hx::LocalFunc,_hx_Closure_0,Float,y,Float,x) HXARGC(0)
            			 ::flixel::math::FlxBasePoint _hx_run(){
            				HX_GC_STACKFRAME(&_hx_pos_4bc163271948760e_1554_boot)
HXDLIN(1554)				return  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,x,y);
            			}
            			HX_END_LOCAL_FUNC0(return)

            			HX_GC_STACKFRAME(&_hx_pos_4bc163271948760e_1554_boot)
HXDLIN(1554)			Float x = ( (Float)(0) );
HXDLIN(1554)			Float y = ( (Float)(0) );
HXDLIN(1554)			return  ::flixel::util::FlxPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0(y,x)));
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_4bc163271948760e_1554_boot)
HXDLIN(1554)		pool = ( ( ::flixel::util::FlxPool)( ::Dynamic(new _hx_Closure_1())()) );
            	}
}
