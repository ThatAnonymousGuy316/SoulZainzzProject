...
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_522_fastSin,"flixel.math.FlxMath","fastSin",0xce873d54,"flixel.math.FlxMath.fastSin","flixel/math/FlxMath.hx",522,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_556_fastCos,"flixel.math.FlxMath","fastCos",0xce7b1e83,"flixel.math.FlxMath.fastCos","flixel/math/FlxMath.hx",556,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_564_sinh,"flixel.math.FlxMath","sinh",0x02ce9bd8,"flixel.math.FlxMath.sinh","flixel/math/FlxMath.hx",564,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_572_maxInt,"flixel.math.FlxMath","maxInt",0x4dbb7033,"flixel.math.FlxMath.maxInt","flixel/math/FlxMath.hx",572,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_580_minInt,"flixel.math.FlxMath","minInt",0xe253f205,"flixel.math.FlxMath.minInt","flixel/math/FlxMath.hx",580,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_588_absInt,"flixel.math.FlxMath","absInt",0x118b9f25,"flixel.math.FlxMath.absInt","flixel/math/FlxMath.hx",588,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_605_mod,"flixel.math.FlxMath","mod",0xc0db1a3a,"flixel.math.FlxMath.mod","flixel/math/FlxMath.hx",605,0x837802f8)
...
Float FlxMath_obj::fastSin(Float n){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_522_fastSin)
HXLINE( 523)		n = (n * ((Float)0.3183098862));
HXLINE( 526)		if ((n > 1)) {
HXLINE( 528)			n = (n - ( (Float)(((::Math_obj::ceil(n) >> 1) << 1)) ));
            		}
            		else {
HXLINE( 530)			if ((n < -1)) {
HXLINE( 532)				n = (n + ((::Math_obj::ceil(-(n)) >> 1) << 1));
            			}
            		}
HXLINE( 536)		if ((n > 0)) {
HXLINE( 538)			return (n * (((Float)3.1) + (n * (((Float)0.5) + (n * (((Float)-7.2) + (n * ((Float)3.6))))))));
            		}
            		else {
HXLINE( 542)			return (n * (((Float)3.1) - (n * (((Float)0.5) + (n * (((Float)7.2) + (n * ((Float)3.6))))))));
            		}
...
Float FlxMath_obj::fastCos(Float n){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_556_fastCos)
HXDLIN( 556)		Float n1 = (n + ((Float)1.570796327));
HXDLIN( 556)		n1 = (n1 * ((Float)0.3183098862));
HXDLIN( 556)		if ((n1 > 1)) {
HXDLIN( 556)			n1 = (n1 - ( (Float)(((::Math_obj::ceil(n1) >> 1) << 1)) ));
            		}
            		else {
HXDLIN( 556)			if ((n1 < -1)) {
HXDLIN( 556)				n1 = (n1 + ((::Math_obj::ceil(-(n1)) >> 1) << 1));
            			}
            		}
HXDLIN( 556)		if ((n1 > 0)) {
HXDLIN( 556)			return (n1 * (((Float)3.1) + (n1 * (((Float)0.5) + (n1 * (((Float)-7.2) + (n1 * ((Float)3.6))))))));
            		}
            		else {
HXDLIN( 556)			return (n1 * (((Float)3.1) - (n1 * (((Float)0.5) + (n1 * (((Float)7.2) + (n1 * ((Float)3.6))))))));
            		}
HXDLIN( 556)		return ((Float)0.);
            	}
...
Float FlxMath_obj::sinh(Float n){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_564_sinh)
HXDLIN( 564)		return ((::Math_obj::exp(n) - ::Math_obj::exp(-(n))) / ( (Float)(2) ));
            	}
...
int FlxMath_obj::maxInt(int a,int b){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_572_maxInt)
HXDLIN( 572)		if ((a > b)) {
HXDLIN( 572)			return a;
            		}
            		else {
...
int FlxMath_obj::minInt(int a,int b){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_580_minInt)
HXDLIN( 580)		if ((a > b)) {
HXDLIN( 580)			return b;
            		}
            		else {
...
int FlxMath_obj::absInt(int n){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_588_absInt)
HXDLIN( 588)		if ((n > 0)) {
HXDLIN( 588)			return n;
            		}
            		else {
...
Float FlxMath_obj::mod(Float a,Float b){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_605_mod)
HXLINE( 606)		b = ::Math_obj::abs(b);
HXLINE( 607)		return (a - (b * ( (Float)(::Math_obj::floor((a / b))) )));
            	}
