...
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_259_getObject,"flixel.math.FlxRandom","getObject",0x2a1130e8,"flixel.math.FlxRandom.getObject","flixel/math/FlxRandom.hx",259,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_305_shuffle,"flixel.math.FlxRandom","shuffle",0x24083c2c,"flixel.math.FlxRandom.shuffle","flixel/math/FlxRandom.hx",305,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_326_color,"flixel.math.FlxRandom","color",0x54cd64d6,"flixel.math.FlxRandom.color","flixel/math/FlxRandom.hx",326,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_372_generate,"flixel.math.FlxRandom","generate",0xe00ed5a2,"flixel.math.FlxRandom.generate","flixel/math/FlxRandom.hx",372,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_387_set_initialSeed,"flixel.math.FlxRandom","set_initialSeed",0x5f4b69eb,"flixel.math.FlxRandom.set_initialSeed","flixel/math/FlxRandom.hx",387,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_395_get_currentSeed,"flixel.math.FlxRandom","get_currentSeed",0xbfecf714,"flixel.math.FlxRandom.get_currentSeed","flixel/math/FlxRandom.hx",395,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_403_set_currentSeed,"flixel.math.FlxRandom","set_currentSeed",0xbbb87420,"flixel.math.FlxRandom.set_currentSeed","flixel/math/FlxRandom.hx",403,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_411_rangeBound,"flixel.math.FlxRandom","rangeBound",0x5cf038ee,"flixel.math.FlxRandom.rangeBound","flixel/math/FlxRandom.hx",411,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_417_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",417,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_428_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",428,0x4fa37e1d)
...
HXLINE( 379)		this->internalSeed = ((Float)1);
...
HX_DEFINE_DYNAMIC_FUNC1(FlxRandom_obj,weightedPick,return )
 ...
 ::Dynamic FlxRandom_obj::getObject(::cpp::VirtualArray Objects,::Array< Float > WeightsArray,::hx::Null< int >  __o_StartIndex, ::Dynamic EndIndex){
            	...
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_259_getObject)
HXLINE( 260)		 ::Dynamic selected = null();
HXLINE( 262)		if ((Objects->get_length() != 0)) {
HXLINE( 264)			if (::hx::IsNull( WeightsArray )) {
HXLINE( 266)				::Array< Float > _g = ::Array_obj< Float >::__new(0);
HXDLIN( 266)				{
HXLINE( 266)					int _g1 = 0;
HXDLIN( 266)					int _g2 = Objects->get_length();
HXDLIN( 266)					while((_g1 < _g2)){
HXLINE( 266)						_g1 = (_g1 + 1);
HXDLIN( 266)						int i = (_g1 - 1);
HXDLIN( 266)						_g->push(1);
            					}
            				}
HXDLIN( 266)				WeightsArray = _g;
            			}
HXLINE( 269)			if (::hx::IsNull( EndIndex )) {
HXLINE( 271)				EndIndex = (Objects->get_length() - 1);
            			}
HXLINE( 274)			 ::Dynamic Max = (Objects->get_length() - 1);
HXDLIN( 274)			Float lowerBound;
HXDLIN( 274)			if ((StartIndex < 0)) {
HXLINE( 274)				lowerBound = ( (Float)(0) );
            			}
            			else {
HXLINE( 274)				lowerBound = ( (Float)(StartIndex) );
            			}
HXDLIN( 274)			Float StartIndex1;
HXDLIN( 274)			bool StartIndex2;
HXDLIN( 274)			if (::hx::IsNotNull( Max )) {
HXLINE( 274)				StartIndex2 = ::hx::IsGreater( lowerBound,Max );
            			}
            			else {
HXLINE( 274)				StartIndex2 = false;
            			}
HXDLIN( 274)			if (StartIndex2) {
HXLINE( 274)				StartIndex1 = ( (Float)(Max) );
            			}
            			else {
HXLINE( 274)				StartIndex1 = lowerBound;
            			}
HXDLIN( 274)			StartIndex = ::Std_obj::_hx_int(StartIndex1);
HXLINE( 275)			Float Value = ( (Float)(EndIndex) );
HXDLIN( 275)			 ::Dynamic Max1 = (Objects->get_length() - 1);
HXDLIN( 275)			Float lowerBound1;
HXDLIN( 275)			if ((Value < 0)) {
HXLINE( 275)				lowerBound1 = ( (Float)(0) );
            			}
            			else {
HXLINE( 275)				lowerBound1 = Value;
            			}
HXDLIN( 275)			Float EndIndex1;
HXDLIN( 275)			bool EndIndex2;
HXDLIN( 275)			if (::hx::IsNotNull( Max1 )) {
HXLINE( 275)				EndIndex2 = ::hx::IsGreater( lowerBound1,Max1 );
            			}
            			else {
HXLINE( 275)				EndIndex2 = false;
            			}
HXDLIN( 275)			if (EndIndex2) {
HXLINE( 275)				EndIndex1 = ( (Float)(Max1) );
            			}
            			else {
HXLINE( 275)				EndIndex1 = lowerBound1;
            			}
HXDLIN( 275)			EndIndex = ::Std_obj::_hx_int(EndIndex1);
HXLINE( 278)			if (::hx::IsLess( EndIndex,StartIndex )) {
HXLINE( 280)				StartIndex = (StartIndex + EndIndex);
HXLINE( 281)				EndIndex = (StartIndex - ( (int)(EndIndex) ));
HXLINE( 282)				StartIndex = (StartIndex - ( (int)(EndIndex) ));
            			}
HXLINE( 285)			if (::hx::IsGreater( EndIndex,(WeightsArray->length - 1) )) {
HXLINE( 287)				EndIndex = (WeightsArray->length - 1);
            			}
HXLINE( 290)			::Array< Float > _g3 = ::Array_obj< Float >::__new(0);
HXDLIN( 290)			{
HXLINE( 290)				int _g4 = StartIndex;
HXDLIN( 290)				int _g5 = (EndIndex + 1);
HXDLIN( 290)				while((_g4 < _g5)){
HXLINE( 290)					_g4 = (_g4 + 1);
HXDLIN( 290)					int i1 = (_g4 - 1);
HXDLIN( 290)					_g3->push(WeightsArray->__get(i1));
            				}
            			}
HXDLIN( 290)			::flixel::math::FlxRandom_obj::_arrayFloatHelper = _g3;
HXLINE( 291)			selected = Objects->__get((StartIndex + this->weightedPick(::flixel::math::FlxRandom_obj::_arrayFloatHelper)));
            		}
HXLINE( 294)		return selected;
            	}
...
void FlxRandom_obj::shuffle(::cpp::VirtualArray array){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_305_shuffle)
HXLINE( 306)		int maxValidIndex = (array->get_length() - 1);
HXLINE( 307)		{
HXLINE( 307)			int _g = 0;
HXDLIN( 307)			int _g1 = maxValidIndex;
HXDLIN( 307)			while((_g < _g1)){
HXLINE( 307)				_g = (_g + 1);
HXDLIN( 307)				int i = (_g - 1);
HXLINE( 309)				int j = this->_hx_int(i,maxValidIndex,null());
HXLINE( 310)				 ::Dynamic tmp = array->__get(i);
HXLINE( 311)				array->set(i,array->__get(j));
HXLINE( 312)				array->set(j,tmp);
            			}
            		}
            	}
...
int FlxRandom_obj::color( ::Dynamic Min, ::Dynamic Max, ::Dynamic Alpha,::hx::Null< bool >  __o_GreyScale){
            	...
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_326_color)
HXLINE( 327)		int red;
HXLINE( 328)		int green;
HXLINE( 329)		int blue;
HXLINE( 330)		int alpha;
HXLINE( 332)		bool _hx_tmp;
HXDLIN( 332)		if (::hx::IsNull( Min )) {
HXLINE( 332)			_hx_tmp = ::hx::IsNull( Max );
            		}
            		else {
HXLINE( 332)			_hx_tmp = false;
            		}
HXDLIN( 332)		if (_hx_tmp) {
HXLINE( 334)			red = this->_hx_int(0,255,null());
HXLINE( 335)			green = this->_hx_int(0,255,null());
HXLINE( 336)			blue = this->_hx_int(0,255,null());
HXLINE( 337)			if (::hx::IsNull( Alpha )) {
HXLINE( 337)				alpha = this->_hx_int(0,255,null());
            			}
            			else {
HXLINE( 337)				alpha = ( (int)(Alpha) );
            			}
            		}
            		else {
HXLINE( 339)			if (::hx::IsNull( Max )) {
HXLINE( 341)				red = this->_hx_int(((( (int)(Min) ) >> 16) & 255),255,null());
HXLINE( 342)				if (GreyScale) {
HXLINE( 342)					green = red;
            				}
            				else {
HXLINE( 342)					green = this->_hx_int(((( (int)(Min) ) >> 8) & 255),255,null());
            				}
HXLINE( 343)				if (GreyScale) {
HXLINE( 343)					blue = red;
            				}
            				else {
HXLINE( 343)					blue = this->_hx_int((( (int)(Min) ) & 255),255,null());
            				}
HXLINE( 344)				if (::hx::IsNull( Alpha )) {
HXLINE( 344)					alpha = this->_hx_int(((( (int)(Min) ) >> 24) & 255),255,null());
            				}
            				else {
HXLINE( 344)					alpha = ( (int)(Alpha) );
            				}
            			}
            			else {
HXLINE( 346)				if (::hx::IsNull( Min )) {
HXLINE( 348)					red = this->_hx_int(0,((( (int)(Max) ) >> 16) & 255),null());
HXLINE( 349)					if (GreyScale) {
HXLINE( 349)						green = red;
            					}
            					else {
HXLINE( 349)						green = this->_hx_int(0,((( (int)(Max) ) >> 8) & 255),null());
            					}
HXLINE( 350)					if (GreyScale) {
HXLINE( 350)						blue = red;
            					}
            					else {
HXLINE( 350)						blue = this->_hx_int(0,(( (int)(Max) ) & 255),null());
            					}
HXLINE( 351)					if (::hx::IsNull( Alpha )) {
HXLINE( 351)						alpha = this->_hx_int(0,((( (int)(Max) ) >> 24) & 255),null());
            					}
            					else {
HXLINE( 351)						alpha = ( (int)(Alpha) );
            					}
            				}
            				else {
HXLINE( 355)					red = this->_hx_int(((( (int)(Min) ) >> 16) & 255),((( (int)(Max) ) >> 16) & 255),null());
HXLINE( 356)					if (GreyScale) {
HXLINE( 356)						green = red;
            					}
            					else {
HXLINE( 356)						green = this->_hx_int(((( (int)(Min) ) >> 8) & 255),((( (int)(Max) ) >> 8) & 255),null());
            					}
HXLINE( 357)					if (GreyScale) {
HXLINE( 357)						blue = red;
            					}
            					else {
HXLINE( 357)						blue = this->_hx_int((( (int)(Min) ) & 255),(( (int)(Max) ) & 255),null());
            					}
HXLINE( 358)					if (::hx::IsNull( Alpha )) {
HXLINE( 358)						alpha = this->_hx_int(((( (int)(Min) ) >> 24) & 255),((( (int)(Max) ) >> 24) & 255),null());
            					}
            					else {
HXLINE( 358)						alpha = ( (int)(Alpha) );
            					}
            				}
            			}
            		}
HXLINE( 361)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 361)		{
...
Float FlxRandom_obj::generate(){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_372_generate)
HXDLIN( 372)		return (this->internalSeed = ::hx::Mod((this->internalSeed * ((Float)48271.0)),(int)2147483647));
            	}
...
int FlxRandom_obj::set_initialSeed(int NewSeed){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_387_set_initialSeed)
HXDLIN( 387)		Float lowerBound;
HXDLIN( 387)		if ((NewSeed < 1)) {
HXDLIN( 387)			lowerBound = ( (Float)(1) );
            		}
            		else {
HXDLIN( 387)			lowerBound = ( (Float)(NewSeed) );
            		}
HXDLIN( 387)		Float NewSeed1;
HXDLIN( 387)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 387)			NewSeed1 = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 387)			NewSeed1 = lowerBound;
            		}
HXDLIN( 387)		int NewSeed2 = ::Std_obj::_hx_int(NewSeed1);
HXDLIN( 387)		Float lowerBound1;
HXDLIN( 387)		if ((NewSeed2 < 1)) {
HXDLIN( 387)			lowerBound1 = ( (Float)(1) );
            		}
            		else {
HXDLIN( 387)			lowerBound1 = ( (Float)(NewSeed2) );
            		}
HXDLIN( 387)		Float _hx_tmp;
HXDLIN( 387)		if ((lowerBound1 > (int)2147483646)) {
HXDLIN( 387)			_hx_tmp = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 387)			_hx_tmp = lowerBound1;
            		}
HXDLIN( 387)		return (this->initialSeed = ::Std_obj::_hx_int((this->internalSeed = ( (Float)(::Std_obj::_hx_int(_hx_tmp)) ))));
            	}
...
int FlxRandom_obj::get_currentSeed(){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_395_get_currentSeed)
HXDLIN( 395)		return ::Std_obj::_hx_int(this->internalSeed);
            	}
...
int FlxRandom_obj::set_currentSeed(int NewSeed){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_403_set_currentSeed)
HXDLIN( 403)		Float lowerBound;
HXDLIN( 403)		if ((NewSeed < 1)) {
HXDLIN( 403)			lowerBound = ( (Float)(1) );
            		}
            		else {
HXDLIN( 403)			lowerBound = ( (Float)(NewSeed) );
            		}
HXDLIN( 403)		Float _hx_tmp;
HXDLIN( 403)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 403)			_hx_tmp = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 403)			_hx_tmp = lowerBound;
            		}
HXDLIN( 403)		return ::Std_obj::_hx_int((this->internalSeed = ( (Float)(::Std_obj::_hx_int(_hx_tmp)) )));
            	}
...
int FlxRandom_obj::rangeBound(int Value){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_411_rangeBound)
HXDLIN( 411)		Float lowerBound;
HXDLIN( 411)		if ((Value < 1)) {
HXDLIN( 411)			lowerBound = ( (Float)(1) );
            		}
            		else {
HXDLIN( 411)			lowerBound = ( (Float)(Value) );
            		}
HXDLIN( 411)		Float _hx_tmp;
HXDLIN( 411)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 411)			_hx_tmp = ( (Float)((int)2147483646) );
            		}
            		else {
HXDLIN( 411)			_hx_tmp = lowerBound;
            		}
HXDLIN( 411)		return ::Std_obj::_hx_int(_hx_tmp);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_417_boot)
HXDLIN( 417)		_arrayFloatHelper = null();
            	}
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_428_boot)
HXDLIN( 428)		MULTIPLIER = ((Float)48271.0);
            	}
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_430_boot)
HXDLIN( 430)		MODULUS = (int)2147483647;
            	}
}
