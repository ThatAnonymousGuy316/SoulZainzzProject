...
HXLINE(  53)		::Array< ::Dynamic> cameras = this->getCamerasLegacy();
HXLINE(  54)		{
HXLINE(  54)			int _g = 0;
HXDLIN(  54)			while((_g < cameras->length)){
HXLINE(  54)				 ::flixel::FlxCamera camera = cameras->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  54)				_g = (_g + 1);
HXLINE(  56)				bool _hx_tmp2;
HXDLIN(  56)				if (camera->visible) {
HXLINE(  56)					_hx_tmp2 = !(camera->exists);
            				}
            				else {
...
HXLINE(  59)				this->getScreenPosition(this->_point,camera);
HXLINE(  60)				{
HXLINE(  60)					 ::flixel::math::FlxBasePoint a = this->_point;
HXDLIN(  60)					 ::flixel::math::FlxBasePoint b = this->offset;
HXDLIN(  60)					{
HXLINE(  60)						a->set((a->x - b->x),(a->y - b->y));
HXDLIN(  60)						{
HXLINE(  60)							 ::flixel::math::FlxBasePoint _this = b;
HXDLIN(  60)							if (_this->_weak) {
HXLINE(  60)								_this->put();
            							}
            						}
            					}
            				}
HXLINE(  61)				camera->drawTriangles(this->graphic,this->vertices,this->indices,this->uvtData,this->colors,this->_point,this->blend,this->repeat,this->antialiasing,this->colorTransform,this->shader);
            			}
            		}
            	}
