...
HXDLIN( 330)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 330)			rect->_inPool = false;
HXDLIN( 330)			rect->_weak = false;
HXDLIN( 330)			 ::flixel::math::FlxRect _this = rect;
