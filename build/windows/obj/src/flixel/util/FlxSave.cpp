...
HXDLIN( 216)					_this->advanced(data,_this->styles->error,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),216,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("bind",bd,f5,16,41)));
            				}
...
HXDLIN( 355)					_this->advanced(HX_("You must call save.bind() before you can read or write data.",fb,dd,51,dc),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),355,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            				}
            				break;
            				case (int)1: {
...
HXDLIN( 358)					switch((int)(_g1->_hx_getIndex())){
            						case (int)0: {
HXLINE( 357)							 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 357)							_this1->advanced(HX_("FlxSave is requesting extra storage space",a9,e6,e5,8f),_this1->styles->error,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),357,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            						}
            						break;
            						case (int)1: {
HXLINE( 358)							 ::haxe::Exception e = _g1->_hx_getObject(0).StaticCast<  ::haxe::Exception >();
HXLINE( 359)							{
HXLINE( 359)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this2 = ::flixel::FlxG_obj::log;
HXDLIN( 359)								 ::Dynamic data = (HX_("There was an problem encoding the save data: ",78,77,ed,31) + e->get_message());
HXDLIN( 359)								_this2->advanced(data,_this2->styles->error,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),359,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            					}
...
HXLINE( 363)							{
HXLINE( 363)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this3 = ::flixel::FlxG_obj::log;
HXDLIN( 363)								::String _hx_tmp;
...
HXDLIN( 363)								_this3->advanced(((((HX_("Invalid name:\"",dc,fb,f0,ea) + name1) + HX_("\", ",16,f3,19,00)) + _hx_tmp) + HX_(".",2e,00,00,00)),_this3->styles->error,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),363,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            						case (int)1: {
...
HXLINE( 365)							{
HXLINE( 365)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this4 = ::flixel::FlxG_obj::log;
HXDLIN( 365)								::String _hx_tmp1;
...
HXDLIN( 365)								_this4->advanced(((((HX_("Invalid path:\"",b6,79,4a,bc) + path1) + HX_("\", ",16,f3,19,00)) + _hx_tmp1) + HX_(".",2e,00,00,00)),_this4->styles->error,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),365,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            						case (int)2: {
...
HXLINE( 361)							{
HXLINE( 361)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this5 = ::flixel::FlxG_obj::log;
HXDLIN( 361)								 ::Dynamic data1 = (HX_("IO ERROR: ",14,4a,e8,7d) + e1->get_message());
HXDLIN( 361)								_this5->advanced(data1,_this5->styles->error,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),361,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            						case (int)3: {
...
HXLINE( 367)							{
HXLINE( 367)								 ::flixel::_hx_system::frontEnds::LogFrontEnd _this6 = ::flixel::FlxG_obj::log;
HXDLIN( 367)								 ::Dynamic data2 = ((((HX_("Error parsing \"",ba,8d,7f,0a) + rawData) + HX_("\", ",16,f3,19,00)) + e2->get_message()) + HX_(".",2e,00,00,00));
HXDLIN( 367)								_this6->advanced(data2,_this6->styles->error,true,::hx::SourceInfo(HX_("flixel/util/FlxSave.hx",a9,d0,3c,c4),367,HX_("flixel.util.FlxSave",95,71,4e,bc),HX_("checkStatus",1a,ba,0d,e8)));
            							}
            						}
            						break;
            					}
