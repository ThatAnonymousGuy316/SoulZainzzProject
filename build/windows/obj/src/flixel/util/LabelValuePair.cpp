...
HX_DEFINE_STACK_FRAME(_hx_pos_53443e31a49e57d3_823_new,"flixel.util.LabelValuePair","new",0x8e753503,"flixel.util.LabelValuePair.new","flixel/util/FlxStringUtil.hx",823,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_805_create,"flixel.util.LabelValuePair","create",0x3da24a39,"flixel.util.LabelValuePair.create","flixel/util/FlxStringUtil.hx",805,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_813_put,"flixel.util.LabelValuePair","put",0x8e76c772,"flixel.util.LabelValuePair.put","flixel/util/FlxStringUtil.hx",813,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_817_destroy,"flixel.util.LabelValuePair","destroy",0xc37a1f1d,"flixel.util.LabelValuePair.destroy","flixel/util/FlxStringUtil.hx",817,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_798_weak,"flixel.util.LabelValuePair","weak",0x1e0c0675,"flixel.util.LabelValuePair.weak","flixel/util/FlxStringUtil.hx",798,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_53443e31a49e57d3_794_boot,"flixel.util.LabelValuePair","boot",0x10322e2f,"flixel.util.LabelValuePair.boot","flixel/util/FlxStringUtil.hx",794,0x4e012e33)
namespace flixel{
namespace util{

void LabelValuePair_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_823_new)
            	}
...
void *LabelValuePair_obj::_hx_getInterface(int inHash) {
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::create(::String label, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_805_create)
HXLINE( 806)		this->label = label;
...
void LabelValuePair_obj::put(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_813_put)
HXDLIN( 813)		::flixel::util::LabelValuePair_obj::_pool->put(::hx::ObjectPtr<OBJ_>(this));
            	}
...
void LabelValuePair_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_817_destroy)
HXLINE( 818)		this->label = null();
HXLINE( 819)		this->value = null();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(LabelValuePair_obj,destroy,(void))
 ...
 ::flixel::util::LabelValuePair LabelValuePair_obj::weak(::String label, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_53443e31a49e57d3_798_weak)
...
HXDLIN( 798)		_this->label = label;
HXDLIN( 798)		_this->value = value;
HXDLIN( 798)		return _this;
            	}
...
{
{
            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::flixel::util::LabelValuePair _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_794_boot)
HXDLIN( 794)			return  ::flixel::util::LabelValuePair_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_GC_STACKFRAME(&_hx_pos_53443e31a49e57d3_794_boot)
HXDLIN( 794)		_pool =  ::flixel::util::FlxPool_obj::__alloc( HX_CTX , ::Dynamic(new _hx_Closure_0()));
            	}
}
