...
::flixel::ui::FlxDPadMode FlxDPadMode_obj::ANALOG;
...
{
	if (inName==HX_("ANALOG",30,82,a4,11)) { outValue = FlxDPadMode_obj::ANALOG; return true; }
...
{
	if (inName==HX_("ANALOG",30,82,a4,11)) return 5;
...
{
ANALOG = ::hx::CreateConstEnum< FlxDPadMode_obj >(HX_("ANALOG",30,82,a4,11),5);
