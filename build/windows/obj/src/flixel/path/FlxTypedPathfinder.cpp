...
HXDLIN( 122)					 ::flixel::math::FlxBasePoint result1 = null();
...
HXDLIN( 122)						 ::flixel::math::FlxBasePoint result2 = result1;
HXDLIN( 122)						if (::hx::IsNull( result2 )) {
HXDLIN( 122)							 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 122)							point->_inPool = false;
HXDLIN( 122)							result2 = point;
            						}
HXDLIN( 122)						Float x = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->getColumnPos(column,true);
HXDLIN( 122)						inValue = result2->set(x,( ( ::flixel::tile::FlxBaseTilemap)(_this) )->getRowPos(row,true));
            					}
            					else {
...
HXDLIN( 408)			int tile1;
HXDLIN( 408)			bool tile2;
HXDLIN( 408)			if ((tile >= 0)) {
HXLINE( 408)				tile2 = (tile < ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->length);
            			}
            			else {
HXLINE( 408)				tile2 = false;
            			}
HXDLIN( 408)			if (tile2) {
HXLINE( 408)				tile1 = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->__get(tile);
            			}
            			else {
HXLINE( 408)				tile1 = -1;
            			}
HXDLIN( 408)			 ::flixel::FlxObject tile3 = Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_tileObjects->__get(tile1)).StaticCast<  ::flixel::FlxObject >();
HXLINE( 407)			_hx_tmp = (tile3->allowCollisions == 0);
            		}
            		else {
HXDLIN( 407)			_hx_tmp = false;
            		}
HXDLIN( 407)		if (_hx_tmp) {
HXLINE( 409)			int tile4 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->endIndex;
HXDLIN( 409)			 ::Dynamic _this1 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 409)			int tile5;
HXDLIN( 409)			bool tile6;
HXDLIN( 409)			if ((tile4 >= 0)) {
HXLINE( 409)				tile6 = (tile4 < ( ( ::flixel::tile::FlxBaseTilemap)(_this1) )->_data->length);
            			}
            			else {
HXLINE( 409)				tile6 = false;
            			}
HXDLIN( 409)			if (tile6) {
HXLINE( 409)				tile5 = ( ( ::flixel::tile::FlxBaseTilemap)(_this1) )->_data->__get(tile4);
            			}
            			else {
HXLINE( 409)				tile5 = -1;
            			}
HXDLIN( 409)			 ::flixel::FlxObject tile7 = Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this1) )->_tileObjects->__get(tile5)).StaticCast<  ::flixel::FlxObject >();
HXDLIN( 409)			return (tile7->allowCollisions == 0);
            		}
            		else {
