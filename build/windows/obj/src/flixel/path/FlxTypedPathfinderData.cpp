...
HXLINE( 606)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 606)			_this->advanced(HX_("getPathIndices ended up somewhere other than the start",7c,aa,6e,b9),_this->styles->error,true,::hx::SourceInfo(HX_("flixel/path/FlxPathfinder.hx",58,41,45,74),606,HX_("flixel.path.FlxTypedPathfinderData",84,89,78,56),HX_("getPathIndicesTo",a7,2f,0e,93)));
            		}
...
HXDLIN( 667)		int tile1;
HXDLIN( 667)		bool tile2;
HXDLIN( 667)		if ((tile >= 0)) {
HXDLIN( 667)			tile2 = (tile < ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->length);
            		}
            		else {
HXDLIN( 667)			tile2 = false;
            		}
HXDLIN( 667)		if (tile2) {
HXDLIN( 667)			tile1 = ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_data->__get(tile);
            		}
            		else {
HXDLIN( 667)			tile1 = -1;
            		}
HXDLIN( 667)		 ::flixel::FlxObject tile3 = Dynamic( ( ( ::flixel::tile::FlxBaseTilemap)(_this) )->_tileObjects->__get(tile1)).StaticCast<  ::flixel::FlxObject >();
HXDLIN( 667)		return tile3->allowCollisions;
            	}
