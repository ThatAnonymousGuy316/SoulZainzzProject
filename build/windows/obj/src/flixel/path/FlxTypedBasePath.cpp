...
HXLINE( 156)			{
HXLINE( 156)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 156)				_this->advanced(HX_("Cannot advance after path is finished",2c,20,30,7b),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/path/FlxBasePath.hx",ed,20,b2,ef),156,HX_("flixel.path.FlxTypedBasePath",85,f6,7c,19),HX_("advance",82,08,0c,ef)));
            			}
HXLINE( 157)			return;
            		}
