...
HXLINE( 600)		this->velocity->set(0,0);
...
HXDLIN(1089)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1089)			rect->_inPool = false;
HXDLIN(1089)			rect->_weak = false;
HXDLIN(1089)			 ::flixel::math::FlxRect _this = rect;
HXDLIN(1089)			_this->x = x;
HXDLIN(1089)			_this->y = y;
HXDLIN(1089)			_this->width = width;
HXDLIN(1089)			_this->height = height;
HXDLIN(1089)			Sprite->set_clipRect(_this);
            		}
            	}
