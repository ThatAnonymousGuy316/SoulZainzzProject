...
HXLINE( 200)			{
HXLINE( 200)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 200)				_this->advanced(HX_("Cannot add a `null` object to a FlxGroup.",f2,f4,c0,70),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/group/FlxGroup.hx",8e,d5,89,1e),200,HX_("flixel.group.FlxTypedGroup",e6,b8,51,d3),HX_("add",21,f2,49,00)));
            			}
...
HXLINE( 252)			{
HXLINE( 252)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 252)				_this->advanced(HX_("Cannot insert a `null` object into a FlxGroup.",a5,36,f4,8f),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/group/FlxGroup.hx",8e,d5,89,1e),252,HX_("flixel.group.FlxTypedGroup",e6,b8,51,d3),HX_("insert",39,43,dd,9d)));
            			}
...
HXLINE( 665)		return ::flixel::FlxG_obj::random->getObject(this->members,null(),startIndex,length);
            	}
