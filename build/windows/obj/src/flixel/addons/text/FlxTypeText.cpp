...
HX_LOCAL_STACK_FRAME(_hx_pos_09182b6b580f8cf2_554_loadDefaultSound,"flixel.addons.text.FlxTypeText","loadDefaultSound",0xf442cd21,"flixel.addons.text.FlxTypeText.loadDefaultSound","flixel/addons/text/FlxTypeText.hx",554,0x9451ed7e)
...
void FlxTypeText_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_width,::String __o_text,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_embeddedFont){
...
HX_DEFINE_DYNAMIC_FUNC5(FlxTypeText_obj,start,(void))
 ...
 ::flixel::text::FlxText FlxTypeText_obj::applyMarkup(::String _tmp_input,::Array< ::Dynamic> rules){
            	HX_STACKFRAME(&_hx_pos_09182b6b580f8cf2_240_applyMarkup)
HXLINE( 241)		::String input = _tmp_input;
HXDLIN( 241)		this->super::applyMarkup(input,rules);
...
HXLINE( 328)		this->set_text(this->prefix);
...
HXLINE( 479)					::flixel::FlxG_obj::random->getObject(this->sounds,null(),null(),null()).StaticCast<  ::flixel::sound::FlxSound >()->play(!(this->finishSounds),null(),null());
            				}
            				else {
...
void FlxTypeText_obj::loadDefaultSound(){
            	HX_GC_STACKFRAME(&_hx_pos_09182b6b580f8cf2_554_loadDefaultSound)
HXDLIN( 554)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 554)		this->_sound = _hx_tmp->create( ::flixel::addons::text::TypeSound_obj::__alloc( HX_CTX ,null(),null()),null(),null());
            	}
...
::hx::ObjectPtr< FlxTypeText_obj > FlxTypeText_obj::__new(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_width,::String __o_text,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_embeddedFont) {
	::hx::ObjectPtr< FlxTypeText_obj > __this = new FlxTypeText_obj();
	__this->__construct(__o_x,__o_y,__o_width,__o_text,__o_size,__o_embeddedFont);
	return __this;
}

::hx::ObjectPtr< FlxTypeText_obj > FlxTypeText_obj::__alloc(::hx::Ctx *_hx_ctx,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_width,::String __o_text,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_embeddedFont) {
