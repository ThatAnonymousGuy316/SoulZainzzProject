...
HX_DEFINE_STACK_FRAME(_hx_pos_542cd778bed1ec4a_326_new,"flixel.addons.text.TypeSound","new",0xea1a5b8f,"flixel.addons.text.TypeSound.new","openfl/utils/_internal/AssetsMacro.hx",326,0xfdd54705)
...
void TypeSound_obj::__construct( ::openfl::net::URLRequest stream, ::openfl::media::SoundLoaderContext context){
            	HX_STACKFRAME(&_hx_pos_542cd778bed1ec4a_326_new)
HXLINE( 327)		super::__construct(null(),null());
HXLINE( 329)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::text::TypeSound_obj::resourceName));
HXLINE( 330)		this->loadCompressedDataFromByteArray(byteArray,::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(byteArray));
            	}
