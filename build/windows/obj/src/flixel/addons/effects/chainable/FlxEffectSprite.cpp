...
HXDLIN(  91)		return this1->set((this1->x + this->_effectOffset->x),(this1->y + this->_effectOffset->y));
            	}
...
HXLINE( 115)		this->_effectOffset->set(0,0);
...
HXLINE( 127)							 ::flixel::math::FlxBasePoint this1 = this->_effectOffset;
HXDLIN( 127)							this1->set((this1->x + ( ( ::flixel::math::FlxBasePoint)(effect->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)) )->x),(this1->y + ( ( ::flixel::math::FlxBasePoint)(effect->__Field(HX_("offset",93,97,3f,60),::hx::paccDynamic)) )->y));
            						}
            					}
            				}
            			}
