...
HXDLIN( 168)			pixelOffset = (offsetP * ::Math_obj::sin((((( (Float)(p) ) / ( (Float)(this->wavelength) )) + this->_time) + waveOffset)));
...
HXLINE( 197)		return ::Math_obj::sin((((p / ( (Float)(this->wavelength) )) + this->_time) + waveOffset));
            	}
