...
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_165_recyclePoint,"flixel.addons.effects.FlxTrail","recyclePoint",0x692397c2,"flixel.addons.effects.FlxTrail.recyclePoint","flixel/addons/effects/FlxTrail.hx",165,0x79f2ead4)
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_175_addTrailFrame,"flixel.addons.effects.FlxTrail","addTrailFrame",0x925dfbe3,"flixel.addons.effects.FlxTrail.addTrailFrame","flixel/addons/effects/FlxTrail.hx",175,0x79f2ead4)
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_203_redrawTrailSprites,"flixel.addons.effects.FlxTrail","redrawTrailSprites",0x5e6ae3c4,"flixel.addons.effects.FlxTrail.redrawTrailSprites","flixel/addons/effects/FlxTrail.hx",203,0x79f2ead4)
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_239_cacheValue,"flixel.addons.effects.FlxTrail","cacheValue",0x1383f314,"flixel.addons.effects.FlxTrail.cacheValue","flixel/addons/effects/FlxTrail.hx",239,0x79f2ead4)
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_246_resetTrail,"flixel.addons.effects.FlxTrail","resetTrail",0x9dced8bc,"flixel.addons.effects.FlxTrail.resetTrail","flixel/addons/effects/FlxTrail.hx",246,0x79f2ead4)
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_270_increaseLength,"flixel.addons.effects.FlxTrail","increaseLength",0x6ebb160d,"flixel.addons.effects.FlxTrail.increaseLength","flixel/addons/effects/FlxTrail.hx",270,0x79f2ead4)
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_312_changeGraphic,"flixel.addons.effects.FlxTrail","changeGraphic",0x690acaf3,"flixel.addons.effects.FlxTrail.changeGraphic","flixel/addons/effects/FlxTrail.hx",312,0x79f2ead4)
HX_LOCAL_STACK_FRAME(_hx_pos_54e0b0e195bf849b_330_changeValuesEnabled,"flixel.addons.effects.FlxTrail","changeValuesEnabled",0x328b834a,"flixel.addons.effects.FlxTrail.changeValuesEnabled","flixel/addons/effects/FlxTrail.hx",330,0x79f2ead4)
namespace flixel{
namespace addons{
namespace effects{
...
HXLINE( 155)			this->addTrailFrame();
HXLINE( 158)			this->redrawTrailSprites();
            		}
HXLINE( 161)		this->super::update(elapsed);
            	}


void FlxTrail_obj::recyclePoint(::Array< ::Dynamic> list,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_54e0b0e195bf849b_165_recyclePoint)
HXLINE( 166)		 ::flixel::math::FlxBasePoint pos;
HXDLIN( 166)		if ((list->length >= this->_trailLength)) {
HXLINE( 166)			pos = list->pop().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
            		}
            		else {
HXLINE( 169)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN( 169)			point->_inPool = false;
HXLINE( 166)			pos = point;
            		}
HXLINE( 171)		list->unshift(pos);
            	}


HX_DEFINE_DYNAMIC_FUNC3(FlxTrail_obj,recyclePoint,(void))

void FlxTrail_obj::addTrailFrame(){
            	HX_STACKFRAME(&_hx_pos_54e0b0e195bf849b_175_addTrailFrame)
HXLINE( 177)		{
HXLINE( 177)			::Array< ::Dynamic> list = this->_recentPositions;
HXDLIN( 177)			Float x = (this->target->x - this->target->offset->x);
HXDLIN( 177)			Float y = (this->target->y - this->target->offset->y);
HXDLIN( 177)			 ::flixel::math::FlxBasePoint pos;
HXDLIN( 177)			if ((list->length >= this->_trailLength)) {
HXLINE( 177)				pos = list->pop().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
            			}
            			else {
HXLINE( 177)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x,y);
HXDLIN( 177)				point->_inPool = false;
HXDLIN( 177)				pos = point;
            			}
HXDLIN( 177)			list->unshift(pos);
            		}
HXLINE( 180)		if (this->rotationsEnabled) {
HXLINE( 182)			this->cacheValue(this->_recentAngles,this->target->angle);
            		}
HXLINE( 186)		if (this->scalesEnabled) {
HXLINE( 188)			::Array< ::Dynamic> list1 = this->_recentScales;
HXDLIN( 188)			Float x1 = this->target->scale->x;
HXDLIN( 188)			Float y1 = this->target->scale->y;
HXDLIN( 188)			 ::flixel::math::FlxBasePoint pos1;
HXDLIN( 188)			if ((list1->length >= this->_trailLength)) {
HXLINE( 188)				pos1 = list1->pop().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
            			}
            			else {
HXLINE( 188)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 188)				point1->_inPool = false;
HXDLIN( 188)				pos1 = point1;
            			}
HXDLIN( 188)			list1->unshift(pos1);
            		}
HXLINE( 192)		bool _hx_tmp;
HXDLIN( 192)		if (this->framesEnabled) {
HXLINE( 192)			_hx_tmp = ::hx::IsNull( this->_graphic );
            		}
            		else {
HXLINE( 192)			_hx_tmp = false;
            		}
HXDLIN( 192)		if (_hx_tmp) {
HXLINE( 194)			this->cacheValue(this->_recentFrames,this->target->animation->frameIndex);
...
HXLINE( 197)			this->cacheValue(this->_recentAnimations,this->target->animation->_curAnim);
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxTrail_obj,addTrailFrame,(void))

void FlxTrail_obj::redrawTrailSprites(){
            	HX_STACKFRAME(&_hx_pos_54e0b0e195bf849b_203_redrawTrailSprites)
HXDLIN( 203)		int _g = 0;
HXDLIN( 203)		int _g1 = this->_recentPositions->length;
HXDLIN( 203)		while((_g < _g1)){
HXDLIN( 203)			_g = (_g + 1);
HXDLIN( 203)			int i = (_g - 1);
HXLINE( 205)			 ::flixel::FlxSprite trailSprite = Dynamic( this->group->members->__get(i)).StaticCast<  ::flixel::FlxSprite >();
HXLINE( 206)			trailSprite->set_x(this->_recentPositions->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->x);
HXLINE( 207)			trailSprite->set_y(this->_recentPositions->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->y);
HXLINE( 210)			if (this->rotationsEnabled) {
HXLINE( 212)				trailSprite->set_angle(this->_recentAngles->__get(i));
HXLINE( 213)				trailSprite->origin->set_x(this->_spriteOrigin->x);
HXLINE( 214)				trailSprite->origin->set_y(this->_spriteOrigin->y);
            			}
HXLINE( 218)			if (this->scalesEnabled) {
HXLINE( 220)				 ::flixel::math::FlxBasePoint p = this->_recentScales->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 220)				trailSprite->scale->set(p->x,p->y);
HXDLIN( 220)				{
HXLINE( 220)					 ::flixel::math::FlxBasePoint _this = p;
...
HXDLIN( 224)			if (this->framesEnabled) {
HXLINE( 224)				_hx_tmp = ::hx::IsNull( this->_graphic );
            			}
            			else {
HXLINE( 224)				_hx_tmp = false;
            			}
HXDLIN( 224)			if (_hx_tmp) {
HXLINE( 226)				trailSprite->animation->set_frameIndex(this->_recentFrames->__get(i));
HXLINE( 227)				trailSprite->set_flipX(this->_recentFlipX->__get(i));
HXLINE( 228)				trailSprite->set_flipY(this->_recentFlipY->__get(i));
HXLINE( 230)				{
HXLINE( 230)					 ::flixel::animation::FlxAnimationController _this1 = trailSprite->animation;
HXDLIN( 230)					 ::flixel::animation::FlxAnimation anim = this->_recentAnimations->__get(i).StaticCast<  ::flixel::animation::FlxAnimation >();
HXDLIN( 230)					if (::hx::IsInstanceNotEq( anim,_this1->_curAnim )) {
HXLINE( 230)						if (::hx::IsNotNull( _this1->_curAnim )) {
HXLINE( 230)							_this1->_curAnim->stop();
            						}
HXDLIN( 230)						if (::hx::IsNotNull( anim )) {
HXLINE( 230)							anim->play(null(),null(),null());
            						}
            					}
HXDLIN( 230)					_this1->_curAnim = anim;
            				}
            			}
HXLINE( 234)			trailSprite->set_exists(true);
            		}
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxTrail_obj,redrawTrailSprites,(void))

void FlxTrail_obj::cacheValue(::cpp::VirtualArray array, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_54e0b0e195bf849b_239_cacheValue)
HXLINE( 240)		array->unshift(value);
HXLINE( 241)		if ((array->get_length() > this->_trailLength)) {
HXLINE( 242)			array->resize(this->_trailLength);
            		}
            	}
...
void FlxTrail_obj::resetTrail(){
            	HX_STACKFRAME(&_hx_pos_54e0b0e195bf849b_246_resetTrail)
HXLINE( 247)		::flixel::util::FlxDestroyUtil_obj::putArray(this->_recentPositions);
HXLINE( 248)		::flixel::util::FlxDestroyUtil_obj::putArray(this->_recentScales);
HXLINE( 249)		this->_recentAngles->resize(0);
HXLINE( 250)		this->_recentFrames->resize(0);
HXLINE( 251)		this->_recentFlipX->resize(0);
HXLINE( 252)		this->_recentFlipY->resize(0);
HXLINE( 253)		this->_recentAnimations->resize(0);
HXLINE( 255)		{
HXLINE( 255)			int _g = 0;
HXDLIN( 255)			int _g1 = this->group->members->get_length();
HXDLIN( 255)			while((_g < _g1)){
HXLINE( 255)				_g = (_g + 1);
HXDLIN( 255)				int i = (_g - 1);
HXLINE( 257)				if (::hx::IsNotNull( Dynamic( this->group->members->__get(i)).StaticCast<  ::flixel::FlxSprite >() )) {
HXLINE( 259)					Dynamic( this->group->members->__get(i)).StaticCast<  ::flixel::FlxSprite >()->set_exists(false);
            				}
            			}
            		}
            	}
...
void FlxTrail_obj::increaseLength(int amount){
            	HX_GC_STACKFRAME(&_hx_pos_54e0b0e195bf849b_270_increaseLength)
HXLINE( 272)		if ((amount <= 0)) {
HXLINE( 274)			return;
            		}
HXLINE( 277)		 ::flixel::addons::effects::FlxTrail _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 277)		_hx_tmp->_trailLength = (_hx_tmp->_trailLength + amount);
HXLINE( 280)		{
HXLINE( 280)			int _g = 0;
HXDLIN( 280)			int _g1 = amount;
HXDLIN( 280)			while((_g < _g1)){
HXLINE( 280)				_g = (_g + 1);
HXDLIN( 280)				int i = (_g - 1);
HXLINE( 282)				 ::flixel::FlxSprite trailSprite =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,null());
HXLINE( 284)				if (::hx::IsNull( this->_graphic )) {
HXLINE( 286)					trailSprite->loadGraphicFromSprite(this->target);
            				}
            				else {
HXLINE( 290)					trailSprite->loadGraphic(this->_graphic,null(),null(),null(),null(),null());
            				}
HXLINE( 292)				trailSprite->set_exists(false);
HXLINE( 293)				trailSprite->set_active(false);
HXLINE( 294)				this->add(trailSprite);
HXLINE( 295)				trailSprite->set_alpha(this->_transp);
HXLINE( 296)				 ::flixel::addons::effects::FlxTrail _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 296)				_hx_tmp1->_transp = (_hx_tmp1->_transp - this->_difference);
HXLINE( 297)				trailSprite->set_solid(((this->allowCollisions & 4369) > 0));
HXLINE( 299)				if ((trailSprite->alpha <= 0)) {
HXLINE( 301)					trailSprite->kill();
            				}
            			}
            		}
            	}
...
void FlxTrail_obj::changeGraphic( ::Dynamic image){
            	HX_STACKFRAME(&_hx_pos_54e0b0e195bf849b_312_changeGraphic)
HXLINE( 313)		this->_graphic = image;
HXLINE( 315)		{
HXLINE( 315)			int _g = 0;
HXDLIN( 315)			int _g1 = this->_trailLength;
HXDLIN( 315)			while((_g < _g1)){
HXLINE( 315)				_g = (_g + 1);
HXDLIN( 315)				int i = (_g - 1);
HXLINE( 317)				Dynamic( this->group->members->__get(i)).StaticCast<  ::flixel::FlxSprite >()->loadGraphic(image,null(),null(),null(),null(),null());
            			}
            		}
            	}
...
void FlxTrail_obj::changeValuesEnabled(bool angle,::hx::Null< bool >  __o_x,::hx::Null< bool >  __o_y,::hx::Null< bool >  __o_scale){
            	...
            	HX_STACKFRAME(&_hx_pos_54e0b0e195bf849b_330_changeValuesEnabled)
HXLINE( 331)		this->rotationsEnabled = angle;
HXLINE( 332)		this->xEnabled = x;
HXLINE( 333)		this->yEnabled = y;
HXLINE( 334)		this->scalesEnabled = scale;
            	}
...
::hx::Val FlxTrail_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"recyclePoint") ) { return ::hx::Val( recyclePoint_dyn() ); }
		break;
	case 13:
		...
		if (HX_FIELD_EQ(inName,"addTrailFrame") ) { return ::hx::Val( addTrailFrame_dyn() ); }
	...
	case 17:
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"redrawTrailSprites") ) { return ::hx::Val( redrawTrailSprites_dyn() ); }
		break;
	case 19:
...
static ::String FlxTrail_obj_sMemberFields[] = {
	...
	HX_("recyclePoint",3d,ef,3e,95),
	HX_("addTrailFrame",08,30,2f,fe),
	HX_("redrawTrailSprites",7f,89,f1,d6),
