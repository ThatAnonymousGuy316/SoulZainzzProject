...
HXLINE(  74)				( ( ::flixel::FlxObject)(sprite) )->scrollFactor->set(x,y);
            			}
            		}
            	}
...
HXLINE( 105)				rect->x = ((Float)0.0);
HXDLIN( 105)				rect->y = ((Float)0.0);
HXDLIN( 105)				rect->width = ((Float)0.0);
HXDLIN( 105)				rect->height = ((Float)0.0);
            			}
HXLINE( 106)			return;
            		}
