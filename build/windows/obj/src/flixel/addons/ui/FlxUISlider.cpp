...
HX_DEFINE_STACK_FRAME(_hx_pos_643b3c313fbe6513_9_new,"flixel.addons.ui.FlxUISlider","new",0x340a3448,"flixel.addons.ui.FlxUISlider.new","flixel/addons/ui/FlxUISlider.hx",9,0xcc2fb5c9)
HX_LOCAL_STACK_FRAME(_hx_pos_643b3c313fbe6513_15_boot,"flixel.addons.ui.FlxUISlider","boot",0x4cfc8b4a,"flixel.addons.ui.FlxUISlider.boot","flixel/addons/ui/FlxUISlider.hx",15,0xcc2fb5c9)
namespace flixel{
namespace addons{
namespace ui{
...
void FlxUISlider_obj::__construct( ::Dynamic Object,::String VarString, ::Dynamic X, ::Dynamic Y, ::Dynamic MinValue, ::Dynamic MaxValue, ::Dynamic Width, ::Dynamic Height, ::Dynamic Thickness, ::Dynamic Color, ::Dynamic HandleColor){
            	HX_STACKFRAME(&_hx_pos_643b3c313fbe6513_9_new)
HXLINE(  13)		this->broadcastToFlxUI = true;
HXLINE(   9)		super::__construct(Object,VarString,X,Y,MinValue,MaxValue,Width,Height,Thickness,Color,HandleColor);
            	}
...
bool FlxUISlider_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x5f6ac8a1) {
		if (inClassId<=(int)0x2c01639b) {
			...
			return inClassId==(int)0x520166d0 || inClassId==(int)0x5f6ac8a1;
		}
	} else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_643b3c313fbe6513_15_boot)
HXDLIN(  15)		CHANGE_EVENT = HX_("change_slider",50,54,ff,71);
            	}
}
