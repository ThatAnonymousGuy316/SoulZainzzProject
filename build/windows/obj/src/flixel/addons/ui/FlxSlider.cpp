...
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_357_updateValue,"flixel.addons.ui.FlxSlider","updateValue",0x61ff42fc,"flixel.addons.ui.FlxSlider.updateValue","flixel/addons/ui/FlxSlider.hx",357,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_381_setTexts,"flixel.addons.ui.FlxSlider","setTexts",0x49045d50,"flixel.addons.ui.FlxSlider.setTexts","flixel/addons/ui/FlxSlider.hx",381,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_431_destroy,"flixel.addons.ui.FlxSlider","destroy",0x763bcd4e,"flixel.addons.ui.FlxSlider.destroy","flixel/addons/ui/FlxSlider.hx",431,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_445_get_expectedPos,"flixel.addons.ui.FlxSlider","get_expectedPos",0x1d9d0de7,"flixel.addons.ui.FlxSlider.get_expectedPos","flixel/addons/ui/FlxSlider.hx",445,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_462_get_relativePos,"flixel.addons.ui.FlxSlider","get_relativePos",0x5a4b2c13,"flixel.addons.ui.FlxSlider.get_relativePos","flixel/addons/ui/FlxSlider.hx",462,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_475_set_varString,"flixel.addons.ui.FlxSlider","set_varString",0xced9704f,"flixel.addons.ui.FlxSlider.set_varString","flixel/addons/ui/FlxSlider.hx",475,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_491_set_x,"flixel.addons.ui.FlxSlider","set_x",0x5956beaf,"flixel.addons.ui.FlxSlider.set_x","flixel/addons/ui/FlxSlider.hx",491,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_498_set_y,"flixel.addons.ui.FlxSlider","set_y",0x5956beb0,"flixel.addons.ui.FlxSlider.set_y","flixel/addons/ui/FlxSlider.hx",498,0x927a0a9d)
HX_LOCAL_STACK_FRAME(_hx_pos_904b05de766b1fa3_506_updateBounds,"flixel.addons.ui.FlxSlider","updateBounds",0x73c1dc8a,"flixel.addons.ui.FlxSlider.updateBounds","flixel/addons/ui/FlxSlider.hx",506,0x927a0a9d)
namespace flixel{
namespace addons{
namespace ui{
...
HXLINE( 192)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 192)			_this->advanced(((HX_("FlxSlider: MinValue and MaxValue can't be the same (",b5,38,bb,84) + MinValue) + HX_(")",29,00,00,00)),_this->styles->error,true,::hx::SourceInfo(HX_("flixel/addons/ui/FlxSlider.hx",9d,0a,7a,92),192,HX_("flixel.addons.ui.FlxSlider",c2,8c,47,0b),HX_("new",60,d0,53,00)));
            		}
...
HXDLIN( 226)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 226)		rect->_inPool = false;
HXDLIN( 226)		rect->_weak = false;
HXDLIN( 226)		 ::flixel::math::FlxRect _this = rect;
...
HXDLIN( 230)		::String colorKey1 = ::StringTools_obj::hex(((this1 >> 24) & 255),2);
HXDLIN( 230)		::String colorKey2 = ((HX_("0x",48,2a,00,00) + colorKey1) + ::StringTools_obj::hex(((this1 >> 16) & 255),2));
HXDLIN( 230)		::String colorKey3 = (colorKey2 + ::StringTools_obj::hex(((this1 >> 8) & 255),2));
HXDLIN( 230)		::String colorKey4 = ((colorKey + (colorKey3 + ::StringTools_obj::hex((this1 & 255),2))) + HX_("T=",69,49,00,00));
HXDLIN( 230)		::String colorKey5 = (colorKey4 + this->_thickness);
HXLINE( 231)		this->body->makeGraphic(this->_width,this->_height,0,false,colorKey5);
HXLINE( 232)		this->body->scrollFactor->set(0,0);
...
HXLINE( 237)		this->handle->scrollFactor->set(0,0);
...
HXLINE( 243)		this->nameLabel->scrollFactor->set(0,0);
...
HXLINE( 250)		this->valueLabel->scrollFactor->set(0,0);
...
HXLINE( 255)		this->minLabel->scrollFactor->set(0,0);
...
HXLINE( 260)		this->maxLabel->scrollFactor->set(0,0);
...
HXLINE( 275)		 ::flixel::FlxCamera cam = this->getDefaultCamera();
HXLINE( 279)		 ::flixel::math::FlxBasePoint mousePosition = ::flixel::FlxG_obj::mouse->getViewPosition(cam,null());
HXLINE( 281)		if (::flixel::math::FlxMath_obj::pointInFlxRect(mousePosition->x,mousePosition->y,this->_bounds)) {
HXLINE( 283)			if ((this->hoverAlpha != 1)) {
HXLINE( 285)				this->set_alpha(this->hoverAlpha);
            			}
HXLINE( 289)			bool _hx_tmp;
HXDLIN( 289)			if (::hx::IsNotNull( this->hoverSound )) {
HXLINE( 289)				_hx_tmp = !(this->_justHovered);
            			}
            			else {
HXLINE( 289)				_hx_tmp = false;
            			}
HXDLIN( 289)			if (_hx_tmp) {
HXLINE( 291)				::flixel::FlxG_obj::sound->play(this->hoverSound,null(),null(),null(),null(),null());
            			}
HXLINE( 295)			this->_justHovered = true;
HXLINE( 297)			 ::flixel::input::mouse::FlxMouseButton _this = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 297)			bool _hx_tmp1;
HXDLIN( 297)			if ((_this->current != 1)) {
HXLINE( 297)				_hx_tmp1 = (_this->current == 2);
            			}
            			else {
HXLINE( 297)				_hx_tmp1 = true;
            			}
HXDLIN( 297)			if (_hx_tmp1) {
HXLINE( 299)				this->handle->set_x(mousePosition->x);
HXLINE( 300)				this->updateValue();
HXLINE( 303)				bool _hx_tmp2;
HXDLIN( 303)				if (::hx::IsNotNull( this->clickSound )) {
HXLINE( 303)					_hx_tmp2 = !(this->_justClicked);
            				}
            				else {
HXLINE( 303)					_hx_tmp2 = false;
            				}
HXDLIN( 303)				if (_hx_tmp2) {
HXLINE( 305)					::flixel::FlxG_obj::sound->play(this->clickSound,null(),null(),null(),null(),null());
HXLINE( 306)					this->_justClicked = true;
            				}
            			}
HXLINE( 310)			 ::flixel::input::mouse::FlxMouseButton _this1 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 310)			bool _hx_tmp3;
HXDLIN( 310)			if ((_this1->current != 1)) {
HXLINE( 310)				_hx_tmp3 = (_this1->current == 2);
            			}
            			else {
HXLINE( 310)				_hx_tmp3 = true;
            			}
HXDLIN( 310)			if (!(_hx_tmp3)) {
HXLINE( 312)				this->_justClicked = false;
            			}
            		}
            		else {
HXLINE( 317)			if ((this->hoverAlpha != 1)) {
HXLINE( 319)				this->set_alpha(( (Float)(1) ));
            			}
HXLINE( 322)			this->_justHovered = false;
            		}
HXLINE( 326)		bool _hx_tmp4;
HXDLIN( 326)		 ::flixel::input::mouse::FlxMouseButton _this2 = ::flixel::FlxG_obj::mouse->_leftButton;
HXDLIN( 326)		bool _hx_tmp5;
HXDLIN( 326)		if ((_this2->current != 1)) {
HXLINE( 326)			_hx_tmp5 = (_this2->current == 2);
            		}
            		else {
HXLINE( 326)			_hx_tmp5 = true;
            		}
HXDLIN( 326)		if (_hx_tmp5) {
HXLINE( 326)			_hx_tmp4 = ::flixel::math::FlxMath_obj::pointInFlxRect(mousePosition->x,mousePosition->y,this->_bounds);
            		}
            		else {
HXLINE( 326)			_hx_tmp4 = false;
            		}
HXDLIN( 326)		if (_hx_tmp4) {
HXLINE( 328)			this->updateValue();
            		}
HXLINE( 332)		bool _hx_tmp6;
HXDLIN( 332)		if (::hx::IsNotNull( this->varString )) {
HXLINE( 332)			_hx_tmp6 = ::hx::IsNotNull( ::Reflect_obj::getProperty(this->_object,this->varString) );
            		}
            		else {
HXLINE( 332)			_hx_tmp6 = false;
            		}
HXDLIN( 332)		if (_hx_tmp6) {
HXLINE( 334)			this->value = ( (Float)(::Reflect_obj::getProperty(this->_object,this->varString)) );
            		}
HXLINE( 338)		Float _hx_tmp7 = this->handle->x;
HXDLIN( 338)		if ((_hx_tmp7 != this->get_expectedPos())) {
HXLINE( 340)			 ::flixel::FlxSprite _hx_tmp8 = this->handle;
HXDLIN( 340)			_hx_tmp8->set_x(this->get_expectedPos());
            		}
HXLINE( 344)		 ::flixel::text::FlxText _hx_tmp9 = this->valueLabel;
HXDLIN( 344)		_hx_tmp9->set_text(::Std_obj::string(::flixel::math::FlxMath_obj::roundDecimal(this->value,this->decimals)));
HXLINE( 346)		mousePosition->put();
HXLINE( 349)		this->super::update(elapsed);
            	}


void FlxSlider_obj::updateValue(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_357_updateValue)
HXDLIN( 357)		Float _hx_tmp = this->_lastPos;
HXDLIN( 357)		if ((_hx_tmp != this->get_relativePos())) {
HXLINE( 359)			bool _hx_tmp1;
HXDLIN( 359)			if (this->setVariable) {
HXLINE( 359)				_hx_tmp1 = ::hx::IsNotNull( this->varString );
            			}
            			else {
HXLINE( 359)				_hx_tmp1 = false;
            			}
HXDLIN( 359)			if (_hx_tmp1) {
HXLINE( 361)				 ::Dynamic _hx_tmp2 = this->_object;
HXDLIN( 361)				::String _hx_tmp3 = this->varString;
HXDLIN( 361)				Float _hx_tmp4 = this->get_relativePos();
HXDLIN( 361)				::Reflect_obj::setProperty(_hx_tmp2,_hx_tmp3,((_hx_tmp4 * (this->maxValue - this->minValue)) + this->minValue));
            			}
HXLINE( 364)			this->_lastPos = this->get_relativePos();
HXLINE( 366)			if (::hx::IsNotNull( this->callback )) {
HXLINE( 367)				 ::Dynamic _hx_tmp5 = this->callback;
HXDLIN( 367)				_hx_tmp5(this->get_relativePos());
            			}
            		}
            	}
...
void FlxSlider_obj::setTexts(::String Name,::hx::Null< bool >  __o_Value,::String Min,::String Max,::hx::Null< int >  __o_Size){
            	...
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_381_setTexts)
HXLINE( 382)		if (::hx::IsNull( Name )) {
HXLINE( 384)			this->nameLabel->set_visible(false);
            		}
            		else {
HXLINE( 388)			this->nameLabel->set_text(Name);
HXLINE( 389)			this->nameLabel->set_visible(true);
            		}
HXLINE( 392)		if (::hx::IsNull( Min )) {
HXLINE( 394)			this->minLabel->set_visible(false);
            		}
            		else {
HXLINE( 398)			this->minLabel->set_text(Min);
HXLINE( 399)			this->minLabel->set_visible(true);
            		}
HXLINE( 402)		if (::hx::IsNull( Max )) {
HXLINE( 404)			this->maxLabel->set_visible(false);
            		}
            		else {
HXLINE( 408)			this->maxLabel->set_text(Max);
HXLINE( 409)			this->maxLabel->set_visible(true);
            		}
HXLINE( 412)		if (!(Value)) {
HXLINE( 414)			this->valueLabel->set_visible(false);
            		}
            		else {
HXLINE( 418)			this->valueLabel->set_visible(true);
            		}
HXLINE( 421)		this->nameLabel->set_size(Size);
HXLINE( 422)		this->valueLabel->set_size(Size);
HXLINE( 423)		this->minLabel->set_size(Size);
HXLINE( 424)		this->maxLabel->set_size(Size);
            	}
...
void FlxSlider_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_431_destroy)
HXLINE( 432)		this->body = ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->body)) );
HXLINE( 433)		this->handle = ( ( ::flixel::FlxSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->handle)) );
HXLINE( 434)		this->minLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->minLabel)) );
HXLINE( 435)		this->maxLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->maxLabel)) );
HXLINE( 436)		this->nameLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->nameLabel)) );
HXLINE( 437)		this->valueLabel = ( ( ::flixel::text::FlxText)(::flixel::util::FlxDestroyUtil_obj::destroy(this->valueLabel)) );
HXLINE( 439)		this->_bounds = ( ( ::flixel::math::FlxRect)(::flixel::util::FlxDestroyUtil_obj::put(this->_bounds)) );
HXLINE( 441)		this->super::destroy();
            	}


Float FlxSlider_obj::get_expectedPos(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_445_get_expectedPos)
HXLINE( 446)		Float pos = (this->x + this->offset->x);
HXDLIN( 446)		int pos1 = this->_width;
HXDLIN( 446)		Float pos2 = (( (Float)(pos1) ) - this->handle->get_width());
HXDLIN( 446)		Float pos3 = (pos + (pos2 * ((this->value - this->minValue) / (this->maxValue - this->minValue))));
HXLINE( 449)		if ((pos3 > ((this->x + this->_width) + this->offset->x))) {
HXLINE( 451)			pos3 = ((this->x + this->_width) + this->offset->x);
            		}
            		else {
HXLINE( 453)			if ((pos3 < (this->x + this->offset->x))) {
HXLINE( 455)				pos3 = (this->x + this->offset->x);
            			}
            		}
HXLINE( 458)		return pos3;
            	}
...
Float FlxSlider_obj::get_relativePos(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_462_get_relativePos)
HXLINE( 463)		Float pos = ((this->handle->x - this->x) - this->offset->x);
HXDLIN( 463)		int pos1 = this->_width;
HXDLIN( 463)		Float pos2 = (pos / (( (Float)(pos1) ) - this->handle->get_width()));
HXLINE( 466)		if ((pos2 > 1)) {
HXLINE( 468)			pos2 = ( (Float)(1) );
            		}
HXLINE( 471)		return pos2;
            	}
...
::String FlxSlider_obj::set_varString(::String Value){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_475_set_varString)
HXLINE( 476)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 478)			::Reflect_obj::getProperty(this->_object,Value);
HXLINE( 479)			this->varString = Value;
            		} catch( ::Dynamic _hx_e) {
...
HXLINE( 483)				{
HXLINE( 483)					 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 483)					 ::Dynamic data = ((((HX_("Could not create FlxSlider - '",0f,42,71,c5) + Value) + HX_("' is not a valid field of '",71,fa,35,d8)) + ::Std_obj::string(this->_object)) + HX_("'",27,00,00,00));
HXDLIN( 483)					_this->advanced(data,_this->styles->error,true,::hx::SourceInfo(HX_("flixel/addons/ui/FlxSlider.hx",9d,0a,7a,92),483,HX_("flixel.addons.ui.FlxSlider",c2,8c,47,0b),HX_("set_varString",fb,d8,20,b8)));
            				}
HXLINE( 484)				this->varString = null();
            			}
            			else {
...
Float FlxSlider_obj::set_x(Float value){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_491_set_x)
HXLINE( 492)		this->super::set_x(value);
HXLINE( 493)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 493)			 ::flixel::math::FlxRect _this = this->_bounds;
HXDLIN( 493)			_this->x = (this->x + this->offset->x);
HXDLIN( 493)			_this->y = (this->y + this->offset->y);
HXDLIN( 493)			_this->width = ( (Float)(this->_width) );
HXDLIN( 493)			_this->height = ( (Float)(this->_height) );
            		}
HXLINE( 494)		return (this->x = value);
            	}


Float FlxSlider_obj::set_y(Float value){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_498_set_y)
HXLINE( 499)		this->super::set_y(value);
HXLINE( 500)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 500)			 ::flixel::math::FlxRect _this = this->_bounds;
HXDLIN( 500)			_this->x = (this->x + this->offset->x);
HXDLIN( 500)			_this->y = (this->y + this->offset->y);
HXDLIN( 500)			_this->width = ( (Float)(this->_width) );
HXDLIN( 500)			_this->height = ( (Float)(this->_height) );
            		}
HXLINE( 501)		return (this->y = value);
            	}


void FlxSlider_obj::updateBounds(){
            	HX_STACKFRAME(&_hx_pos_904b05de766b1fa3_506_updateBounds)
HXDLIN( 506)		if (::hx::IsNotNull( this->_bounds )) {
HXLINE( 507)			 ::flixel::math::FlxRect _this = this->_bounds;
HXDLIN( 507)			_this->x = (this->x + this->offset->x);
HXDLIN( 507)			_this->y = (this->y + this->offset->y);
HXDLIN( 507)			_this->width = ( (Float)(this->_width) );
HXDLIN( 507)			_this->height = ( (Float)(this->_height) );
            		}
            	}
