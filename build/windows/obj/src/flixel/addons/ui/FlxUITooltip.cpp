...
HXDLIN( 421)		::String _hx_tmp = ::StringTools_obj::hex(((this1 >> 24) & 255),2);
HXDLIN( 421)		::String _hx_tmp1 = ((HX_("0x",48,2a,00,00) + _hx_tmp) + ::StringTools_obj::hex(((this1 >> 16) & 255),2));
HXDLIN( 421)		::String _hx_tmp2 = (_hx_tmp1 + ::StringTools_obj::hex(((this1 >> 8) & 255),2));
HXDLIN( 421)		::String _hx_tmp3 = (((((W + HX_(",",2c,00,00,00)) + H) + HX_(",",2c,00,00,00)) + (_hx_tmp2 + ::StringTools_obj::hex((this1 & 255),2))) + HX_(",",2c,00,00,00));
HXDLIN( 421)		::String _hx_tmp4 = ( (::String)(((_hx_tmp3 + Style->__Field(HX_("borderSize",cd,ff,ed,06),::hx::paccDynamic)) + HX_(",",2c,00,00,00))) );
HXDLIN( 421)		int this2 = ( (int)(Style->__Field(HX_("borderColor",d7,3c,d5,d6),::hx::paccDynamic)) );
HXDLIN( 421)		::String _hx_tmp5 = ::StringTools_obj::hex(((this2 >> 24) & 255),2);
HXDLIN( 421)		::String _hx_tmp6 = ((HX_("0x",48,2a,00,00) + _hx_tmp5) + ::StringTools_obj::hex(((this2 >> 16) & 255),2));
HXDLIN( 421)		::String _hx_tmp7 = (_hx_tmp6 + ::StringTools_obj::hex(((this2 >> 8) & 255),2));
HXDLIN( 421)		return (_hx_tmp4 + (_hx_tmp7 + ::StringTools_obj::hex((this2 & 255),2)));
            	}
...
HXDLIN( 776)		 ::flixel::math::FlxBasePoint obj = p->set(this1->x,this1->y);
...
HXDLIN( 777)		 ::flixel::math::FlxBasePoint obj1 = p1->set(this2->x,this2->y);
