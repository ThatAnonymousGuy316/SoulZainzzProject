...
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_55_set_color,"flixel.addons.ui.FlxUINumericStepper","set_color",0x15562a11,"flixel.addons.ui.FlxUINumericStepper.set_color","flixel/addons/ui/FlxUINumericStepper.hx",55,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_72_set_min,"flixel.addons.ui.FlxUINumericStepper","set_min",0x8923a2c0,"flixel.addons.ui.FlxUINumericStepper.set_min","flixel/addons/ui/FlxUINumericStepper.hx",72,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_82_set_max,"flixel.addons.ui.FlxUINumericStepper","set_max",0x89239bd2,"flixel.addons.ui.FlxUINumericStepper.set_max","flixel/addons/ui/FlxUINumericStepper.hx",82,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_92_set_value,"flixel.addons.ui.FlxUINumericStepper","set_value",0xfcb2381f,"flixel.addons.ui.FlxUINumericStepper.set_value","flixel/addons/ui/FlxUINumericStepper.hx",92,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_119_set_decimals,"flixel.addons.ui.FlxUINumericStepper","set_decimals",0xbb56b2d4,"flixel.addons.ui.FlxUINumericStepper.set_decimals","flixel/addons/ui/FlxUINumericStepper.hx",119,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_130_set_isPercent,"flixel.addons.ui.FlxUINumericStepper","set_isPercent",0xa2c7cfa9,"flixel.addons.ui.FlxUINumericStepper.set_isPercent","flixel/addons/ui/FlxUINumericStepper.hx",130,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_137_set_stack,"flixel.addons.ui.FlxUINumericStepper","set_stack",0x4f051ff6,"flixel.addons.ui.FlxUINumericStepper.set_stack","flixel/addons/ui/FlxUINumericStepper.hx",137,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_182_decimalize,"flixel.addons.ui.FlxUINumericStepper","decimalize",0x151fa4b8,"flixel.addons.ui.FlxUINumericStepper.decimalize","flixel/addons/ui/FlxUINumericStepper.hx",182,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_268__onInputTextEvent,"flixel.addons.ui.FlxUINumericStepper","_onInputTextEvent",0x97f1d1ec,"flixel.addons.ui.FlxUINumericStepper._onInputTextEvent","flixel/addons/ui/FlxUINumericStepper.hx",268,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_296__onPlus,"flixel.addons.ui.FlxUINumericStepper","_onPlus",0xcab59143,"flixel.addons.ui.FlxUINumericStepper._onPlus","flixel/addons/ui/FlxUINumericStepper.hx",296,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_303__onMinus,"flixel.addons.ui.FlxUINumericStepper","_onMinus",0xd7f4da67,"flixel.addons.ui.FlxUINumericStepper._onMinus","flixel/addons/ui/FlxUINumericStepper.hx",303,0xbef22206)
HX_LOCAL_STACK_FRAME(_hx_pos_b3434b006136ea9e_311__doCallback,"flixel.addons.ui.FlxUINumericStepper","_doCallback",0xf5f9d69a,"flixel.addons.ui.FlxUINumericStepper._doCallback","flixel/addons/ui/FlxUINumericStepper.hx",311,0xbef22206)
...
HXLINE( 208)		super::__construct(X,Y);
HXLINE( 210)		if (::hx::IsNull( TextField )) {
HXLINE( 212)			TextField =  ::flixel::addons::ui::FlxUIInputText_obj::__alloc( HX_CTX ,0,0,25,null(),null(),null(),null(),null());
            		}
HXLINE( 214)		TextField->set_x(( (Float)(0) ));
HXLINE( 215)		TextField->set_y(( (Float)(0) ));
HXLINE( 216)		this->text_field = TextField;
HXLINE( 217)		 ::flixel::text::FlxText _hx_tmp = this->text_field;
HXDLIN( 217)		_hx_tmp->set_text(::Std_obj::string(DefaultValue));
HXLINE( 219)		if (::Std_obj::isOfType(this->text_field,::hx::ClassOf< ::flixel::addons::ui::FlxUIInputText >())) {
HXLINE( 221)			 ::flixel::addons::ui::FlxUIInputText fuit = ( ( ::flixel::addons::ui::FlxUIInputText)(this->text_field) );
HXLINE( 222)			fuit->set_lines(1);
HXLINE( 223)			fuit->callback = this->_onInputTextEvent_dyn();
HXLINE( 224)			fuit->broadcastToFlxUI = false;
            		}
HXLINE( 227)		this->stepSize = StepSize;
HXLINE( 228)		this->set_decimals(Decimals);
HXLINE( 229)		this->set_min(Min);
HXLINE( 230)		this->set_max(Max);
HXLINE( 231)		this->set_value(DefaultValue);
HXLINE( 232)		this->set_isPercent(IsPercent);
HXLINE( 234)		int btnSize = (1 + ( (int)(TextField->get_height()) ));
HXLINE( 236)		if (::hx::IsNull( ButtonPlus )) {
HXLINE( 238)			ButtonPlus =  ::flixel::addons::ui::FlxUITypedButton_obj::__alloc( HX_CTX ,0,0,null());
HXLINE( 239)			ButtonPlus->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),btnSize,btnSize,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("2,2,15,15",38,7b,83,18))),0,-1,false,18,18,null());
HXLINE( 241)			ButtonPlus->set_label( ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,HX_("flixel/flixel-ui/img/plus_mark.png",e4,f7,7a,be))).StaticCast<  ::flixel::FlxSprite >();
            		}
HXLINE( 243)		if (::hx::IsNull( ButtonMinus )) {
HXLINE( 245)			ButtonMinus =  ::flixel::addons::ui::FlxUITypedButton_obj::__alloc( HX_CTX ,0,0,null());
HXLINE( 246)			ButtonMinus->loadGraphicSlice9(::cpp::VirtualArray_obj::__new(1)->init(0,HX_("flixel/flixel-ui/img/button_thin.png",58,62,55,9f)),btnSize,btnSize,::Array_obj< ::Dynamic>::__new(1)->init(0,::flixel::util::FlxStringUtil_obj::toIntArray(HX_("2,2,15,15",38,7b,83,18))),0,-1,false,18,18,null());
HXLINE( 248)			ButtonMinus->set_label( ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,0,HX_("flixel/flixel-ui/img/minus_mark.png",80,c9,b5,31))).StaticCast<  ::flixel::FlxSprite >();
            		}
HXLINE( 251)		this->button_plus = ButtonPlus;
HXLINE( 252)		this->button_minus = ButtonMinus;
HXLINE( 254)		this->add(this->text_field);
HXLINE( 255)		this->add(this->button_plus);
HXLINE( 256)		this->add(this->button_minus);
HXLINE( 258)		this->button_plus->onUp->callback = this->_onPlus_dyn();
HXLINE( 259)		this->button_plus->broadcastToFlxUI = false;
HXLINE( 261)		this->button_minus->onUp->callback = this->_onMinus_dyn();
HXLINE( 262)		this->button_minus->broadcastToFlxUI = false;
HXLINE( 264)		this->set_stack(Stack);
            	}
...
int FlxUINumericStepper_obj::set_color(int _tmp_Value){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_55_set_color)
HXLINE(  56)		int Value = _tmp_Value;
HXDLIN(  56)		this->color = Value;
HXLINE(  57)		this->button_plus->set_color(Value);
HXLINE(  58)		this->button_minus->set_color(Value);
HXLINE(  59)		if (::Std_obj::isOfType(this->text_field,::hx::ClassOf< ::flixel::addons::ui::FlxInputText >())) {
HXLINE(  61)			 ::flixel::addons::ui::FlxInputText fit = ( ( ::flixel::addons::ui::FlxInputText)(this->text_field) );
HXLINE(  62)			fit->set_backgroundColor(Value);
            		}
            		else {
HXLINE(  66)			this->text_field->set_color(Value);
            		}
...
Float FlxUINumericStepper_obj::set_min(Float f){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_72_set_min)
HXLINE(  73)		this->min = f;
HXLINE(  74)		if ((this->value < this->min)) {
HXLINE(  76)			this->set_value(this->min);
            		}
HXLINE(  78)		return this->min;
            	}
...
Float FlxUINumericStepper_obj::set_max(Float f){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_82_set_max)
HXLINE(  83)		this->max = f;
HXLINE(  84)		if ((this->value > this->max)) {
HXLINE(  86)			this->set_value(this->max);
            		}
HXLINE(  88)		return this->max;
            	}
...
Float FlxUINumericStepper_obj::set_value(Float f){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_92_set_value)
HXLINE(  93)		this->value = f;
HXLINE(  94)		if ((this->value < this->min)) {
HXLINE(  96)			this->value = this->min;
            		}
HXLINE(  98)		if ((this->value > this->max)) {
HXLINE( 100)			this->value = this->max;
            		}
HXLINE( 102)		if (::hx::IsNotNull( this->text_field )) {
HXLINE( 104)			Float displayValue = this->value;
HXLINE( 105)			if (this->isPercent) {
HXLINE( 107)				displayValue = (displayValue * ( (Float)(100) ));
HXLINE( 108)				 ::flixel::text::FlxText _hx_tmp = this->text_field;
HXDLIN( 108)				Float tens = ::Math_obj::pow(( (Float)(10) ),( (Float)(this->decimals) ));
HXDLIN( 108)				_hx_tmp->set_text((::Std_obj::string(::Std_obj::string((( (Float)(::Math_obj::round((displayValue * tens))) ) / tens))) + HX_("%",25,00,00,00)));
            			}
            			else {
HXLINE( 112)				 ::flixel::text::FlxText _hx_tmp1 = this->text_field;
HXDLIN( 112)				Float tens1 = ::Math_obj::pow(( (Float)(10) ),( (Float)(this->decimals) ));
HXDLIN( 112)				_hx_tmp1->set_text(::Std_obj::string((( (Float)(::Math_obj::round((displayValue * tens1))) ) / tens1)));
            			}
            		}
...
int FlxUINumericStepper_obj::set_decimals(int i){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_119_set_decimals)
HXLINE( 120)		this->decimals = i;
HXLINE( 121)		if ((i < 0)) {
HXLINE( 123)			this->decimals = 0;
            		}
HXLINE( 125)		this->set_value(this->value);
HXLINE( 126)		return this->decimals;
            	}
...
bool FlxUINumericStepper_obj::set_isPercent(bool b){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_130_set_isPercent)
HXLINE( 131)		this->isPercent = b;
HXLINE( 132)		this->set_value(this->value);
HXLINE( 133)		return this->isPercent;
            	}
...
int FlxUINumericStepper_obj::set_stack(int s){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_137_set_stack)
HXLINE( 138)		this->stack = s;
HXLINE( 139)		int btnSize = 10;
HXLINE( 140)		int offsetX = 0;
HXLINE( 141)		int offsetY = 0;
HXLINE( 142)		if (::Std_obj::isOfType(this->text_field,::hx::ClassOf< ::flixel::addons::ui::FlxUIInputText >())) {
HXLINE( 144)			offsetX = 1;
HXLINE( 145)			offsetY = 1;
            		}
HXLINE( 147)		switch((int)(this->stack)){
            			case (int)0: {
HXLINE( 164)				btnSize = (1 + ( (int)((this->text_field->get_height() / ( (Float)(2) ))) ));
HXLINE( 165)				if ((this->button_plus->get_height() != btnSize)) {
HXLINE( 167)					this->button_plus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
HXLINE( 169)				if ((this->button_minus->get_height() != btnSize)) {
HXLINE( 171)					this->button_minus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
HXLINE( 173)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp = this->button_plus;
HXDLIN( 173)				Float _hx_tmp1 = (offsetX + this->text_field->x);
HXDLIN( 173)				_hx_tmp->set_x((_hx_tmp1 + this->text_field->get_width()));
HXLINE( 174)				this->button_plus->set_y((-(offsetY) + this->text_field->y));
HXLINE( 175)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp2 = this->button_minus;
HXDLIN( 175)				Float _hx_tmp3 = (offsetX + this->text_field->x);
HXDLIN( 175)				_hx_tmp2->set_x((_hx_tmp3 + this->text_field->get_width()));
HXLINE( 176)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp4 = this->button_minus;
HXDLIN( 176)				Float _hx_tmp5 = (offsetY + this->text_field->y);
HXDLIN( 176)				Float _hx_tmp6 = this->text_field->get_height();
HXDLIN( 176)				_hx_tmp4->set_y((_hx_tmp5 + (_hx_tmp6 - this->button_minus->get_height())));
            			}
            			break;
            			case (int)1: {
HXLINE( 150)				btnSize = (2 + ( (int)(this->text_field->get_height()) ));
HXLINE( 151)				if ((this->button_plus->get_height() != btnSize)) {
HXLINE( 153)					this->button_plus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
HXLINE( 155)				if ((this->button_minus->get_height() != btnSize)) {
HXLINE( 157)					this->button_minus->resize(( (Float)(btnSize) ),( (Float)(btnSize) ));
            				}
HXLINE( 159)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp7 = this->button_plus;
HXDLIN( 159)				Float _hx_tmp8 = (offsetX + this->text_field->x);
HXDLIN( 159)				_hx_tmp7->set_x((_hx_tmp8 + this->text_field->get_width()));
HXLINE( 160)				this->button_plus->set_y((-(offsetY) + this->text_field->y));
HXLINE( 161)				 ::flixel::addons::ui::FlxUITypedButton _hx_tmp9 = this->button_minus;
HXDLIN( 161)				Float _hx_tmp10 = this->button_plus->x;
HXDLIN( 161)				_hx_tmp9->set_x((_hx_tmp10 + this->button_plus->get_width()));
HXLINE( 162)				this->button_minus->set_y(this->button_plus->y);
            			}
            			break;
            		}
HXLINE( 178)		return this->stack;
            	}
...
::String FlxUINumericStepper_obj::decimalize(Float f,int digits){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_182_decimalize)
HXLINE( 183)		Float tens = ::Math_obj::pow(( (Float)(10) ),( (Float)(digits) ));
HXLINE( 184)		return ::Std_obj::string((( (Float)(::Math_obj::round((f * tens))) ) / tens));
            	}
...
void FlxUINumericStepper_obj::_onInputTextEvent(::String text,::String action){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_268__onInputTextEvent)
HXLINE( 269)		if ((text == HX_("",00,00,00,00))) {
HXLINE( 271)			text = ::Std_obj::string(this->min);
            		}
HXLINE( 274)		int numDecimals = 0;
HXLINE( 275)		{
HXLINE( 275)			int _g = 0;
HXDLIN( 275)			int _g1 = text.length;
HXDLIN( 275)			while((_g < _g1)){
HXLINE( 275)				_g = (_g + 1);
HXDLIN( 275)				int i = (_g - 1);
HXLINE( 277)				::String _hx_char = text.charAt(i);
HXLINE( 278)				if ((_hx_char == HX_(".",2e,00,00,00))) {
HXLINE( 280)					numDecimals = (numDecimals + 1);
            				}
            			}
            		}
HXLINE( 284)		bool justAddedDecimal;
HXDLIN( 284)		if ((numDecimals == 1)) {
HXLINE( 284)			int justAddedDecimal1 = text.indexOf(HX_(".",2e,00,00,00),null());
HXDLIN( 284)			justAddedDecimal = (justAddedDecimal1 == (text.length - 1));
            		}
            		else {
HXLINE( 284)			justAddedDecimal = false;
            		}
HXLINE( 287)		if (!(justAddedDecimal)) {
HXLINE( 289)			this->set_value(::Std_obj::parseFloat(text));
HXLINE( 290)			this->_doCallback(HX_("edit_numeric_stepper",ea,96,04,5c));
HXLINE( 291)			this->_doCallback(HX_("change_numeric_stepper",50,0a,cc,bb));
            		}
            	}
...
void FlxUINumericStepper_obj::_onPlus(){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_296__onPlus)
HXLINE( 297)		this->set_value((this->value + this->stepSize));
HXLINE( 298)		this->_doCallback(HX_("click_numeric_stepper",28,25,65,6e));
HXLINE( 299)		this->_doCallback(HX_("change_numeric_stepper",50,0a,cc,bb));
            	}
...
void FlxUINumericStepper_obj::_onMinus(){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_303__onMinus)
HXLINE( 304)		this->set_value((this->value - this->stepSize));
HXLINE( 305)		this->_doCallback(HX_("click_numeric_stepper",28,25,65,6e));
HXLINE( 306)		this->_doCallback(HX_("change_numeric_stepper",50,0a,cc,bb));
            	}
...
void FlxUINumericStepper_obj::_doCallback(::String event_name){
            	HX_STACKFRAME(&_hx_pos_b3434b006136ea9e_311__doCallback)
HXDLIN( 311)		if (this->broadcastToFlxUI) {
HXLINE( 313)			::flixel::addons::ui::FlxUI_obj::event(event_name,::hx::ObjectPtr<OBJ_>(this),this->value,this->params);
            		}
            	}
