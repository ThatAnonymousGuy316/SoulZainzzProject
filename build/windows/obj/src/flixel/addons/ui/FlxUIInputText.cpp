...
HX_LOCAL_STACK_FRAME(_hx_pos_3220fe253d6a28c5_23_resize,"flixel.addons.ui.FlxUIInputText","resize",0x10b3be20,"flixel.addons.ui.FlxUIInputText.resize","flixel/addons/ui/FlxUIInputText.hx",23,0x43f86a3b)
HX_LOCAL_STACK_FRAME(_hx_pos_3220fe253d6a28c5_31_onChange,"flixel.addons.ui.FlxUIInputText","onChange",0x695a4f1b,"flixel.addons.ui.FlxUIInputText.onChange","flixel/addons/ui/FlxUIInputText.hx",31,0x43f86a3b)
...
void FlxUIInputText_obj::resize(Float w,Float h){
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_23_resize)
HXLINE(  24)		this->set_width(w);
HXLINE(  25)		this->set_height(h);
HXLINE(  26)		this->calcFrame(null());
            	}
...
void FlxUIInputText_obj::onChange(::String action){
            	HX_STACKFRAME(&_hx_pos_3220fe253d6a28c5_31_onChange)
HXLINE(  32)		this->super::onChange(action);
HXLINE(  33)		if (this->broadcastToFlxUI) {
HXLINE(  35)			::String _hx_switch_0 = action;
            			if (  (_hx_switch_0==HX_("backspace",3f,85,ea,ca)) ||  (_hx_switch_0==HX_("delete",2b,c0,d8,6a)) ){
HXLINE(  40)				::flixel::addons::ui::FlxUI_obj::event(HX_("delete_input_text",16,b7,28,af),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  41)				::flixel::addons::ui::FlxUI_obj::event(HX_("change_input_text",f1,11,47,68),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  39)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("enter",18,6d,86,70)) ){
HXLINE(  38)				::flixel::addons::ui::FlxUI_obj::event(HX_("enter_input_text",49,07,7b,5a),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXDLIN(  38)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("input",0a,c4,1d,be)) ){
HXLINE(  43)				::flixel::addons::ui::FlxUI_obj::event(HX_("input_input_text",97,11,0d,4c),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
HXLINE(  44)				::flixel::addons::ui::FlxUI_obj::event(HX_("change_input_text",f1,11,47,68),::hx::ObjectPtr<OBJ_>(this),this->text,this->params);
