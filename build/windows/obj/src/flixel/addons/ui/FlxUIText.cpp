...
HXLINE(  89)			{
HXLINE(  89)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(  89)				_this->advanced(((HX_("Loop failsafe tripped while resizing FlxUIText to height(",fa,63,b3,d6) + h) + HX_(")",29,00,00,00)),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/addons/ui/FlxUIText.hx",bd,53,7f,55),89,HX_("flixel.addons.ui.FlxUIText",a2,4f,17,a3),HX_("resize",f4,59,7b,08)));
            			}
