...
HXLINE(  55)		this->back->scrollFactor->set(0,0);
...
HXDLIN( 147)				this1->set(x,( (Float)(::Std_obj::_hx_int(region->height)) ));
            			}
...
HXLINE( 158)				sprite->scale->set(region->width,((Float)1.0));
...
HXLINE( 169)					sprite->scale->set(((Float)1.0),region->height);
