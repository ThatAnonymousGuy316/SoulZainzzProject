...
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1433_fromOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","fromOpenFL",0xc584ea03,"flixel.text._FlxText.FlxTextAlign_Impl_.fromOpenFL","flixel/text/FlxText.hx",1433,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1449_toOpenFL,"flixel.text._FlxText.FlxTextAlign_Impl_","toOpenFL",0xa34e3094,"flixel.text._FlxText.FlxTextAlign_Impl_.toOpenFL","flixel/text/FlxText.hx",1449,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1419_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1419,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1426_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1426,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1428_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1428,0xdf165a6e)
HX_LOCAL_STACK_FRAME(_hx_pos_b1c62838e0cb70a0_1429_boot,"flixel.text._FlxText.FlxTextAlign_Impl_","boot",0xece2bcdb,"flixel.text._FlxText.FlxTextAlign_Impl_.boot","flixel/text/FlxText.hx",1429,0xdf165a6e)
namespace flixel{
namespace text{
namespace _FlxText{
...
::String FlxTextAlign_Impl__obj::fromOpenFL( ::Dynamic align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1433_fromOpenFL)
HXDLIN(1433)		if (::hx::IsNull( align )) {
HXLINE(1438)			return HX_("left",07,08,b0,47);
            		}
            		else {
HXDLIN(1433)			 ::Dynamic _hx_switch_0 = align;
            			if (  (_hx_switch_0==0) ){
HXLINE(1440)				return HX_("center",d5,25,db,05);
HXDLIN(1440)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==2) ){
HXLINE(1442)				return HX_("justify",50,df,b5,83);
HXDLIN(1442)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==3) ){
HXLINE(1439)				return HX_("left",07,08,b0,47);
HXDLIN(1439)				goto _hx_goto_0;
            			}
            			if (  (_hx_switch_0==4) ){
HXLINE(1441)				return HX_("right",dc,0b,64,e9);
HXDLIN(1441)				goto _hx_goto_0;
            			}
            			/* default */{
HXLINE(1443)				return HX_("left",07,08,b0,47);
            			}
            			_hx_goto_0:;
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxTextAlign_Impl__obj,fromOpenFL,return )
 ...
 ::Dynamic FlxTextAlign_Impl__obj::toOpenFL(::String align){
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1449_toOpenFL)
HXDLIN(1449)		::String _hx_switch_0 = align;
            		if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE(1452)			return 0;
HXDLIN(1452)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("justify",50,df,b5,83)) ){
HXLINE(1454)			return 2;
HXDLIN(1454)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE(1451)			return 3;
HXDLIN(1451)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE(1453)			return 4;
HXDLIN(1453)			goto _hx_goto_2;
            		}
            		/* default */{
HXLINE(1455)			return 3;
            		}
            		_hx_goto_2:;
...
{
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1419_boot)
HXDLIN(1419)		LEFT = HX_("left",07,08,b0,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1426_boot)
HXDLIN(1426)		CENTER = HX_("center",d5,25,db,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1428_boot)
HXDLIN(1428)		RIGHT = HX_("right",dc,0b,64,e9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_b1c62838e0cb70a0_1429_boot)
HXDLIN(1429)		JUSTIFY = HX_("justify",50,df,b5,83);
            	}
}
