...
HX_DEFINE_STACK_FRAME(_hx_pos_6a104454ab9b2fac_1368_new,"flixel.text._FlxText.FlxTextFormatRange","new",0x02a8ae38,"flixel.text._FlxText.FlxTextFormatRange.new","flixel/text/FlxText.hx",1368,0xdf165a6e)
namespace flixel{
namespace text{
namespace _FlxText{

void FlxTextFormatRange_obj::__construct( ::flixel::text::FlxTextFormat format,int start,int end){
            	HX_GC_STACKFRAME(&_hx_pos_6a104454ab9b2fac_1368_new)
HXLINE(1369)		this->range =  ::flixel::util::helpers::FlxRange_obj::__alloc( HX_CTX ,start,end);
HXLINE(1370)		this->format = format;
            	}
