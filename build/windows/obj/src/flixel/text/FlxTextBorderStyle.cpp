...
::flixel::text::FlxTextBorderStyle FlxTextBorderStyle_obj::OUTLINE_CARDINAL;
...
bool FlxTextBorderStyle_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("OUTLINE_CARDINAL",9d,99,96,4c)) { outValue = FlxTextBorderStyle_obj::OUTLINE_CARDINAL; return true; }
...
int FlxTextBorderStyle_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("OUTLINE_CARDINAL",9d,99,96,4c)) return 4;
	if (inName==HX_("OUTLINE_FAST",d9,37,1b,3f)) return 5;
...
int FlxTextBorderStyle_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("OUTLINE_CARDINAL",9d,99,96,4c)) return 0;
...
::hx::Val FlxTextBorderStyle_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("OUTLINE_CARDINAL",9d,99,96,4c)) return OUTLINE_CARDINAL;
...
static ::String FlxTextBorderStyle_obj_sStaticFields[] = {
	...
	HX_("OUTLINE_CARDINAL",9d,99,96,4c),
...
OUTLINE_CARDINAL = ::hx::CreateConstEnum< FlxTextBorderStyle_obj >(HX_("OUTLINE_CARDINAL",9d,99,96,4c),4);
OUTLINE_FAST = ::hx::CreateConstEnum< FlxTextBorderStyle_obj >(HX_("OUTLINE_FAST",d9,37,1b,3f),5);
