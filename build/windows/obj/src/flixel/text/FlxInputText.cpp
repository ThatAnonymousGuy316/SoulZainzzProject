...
HXLINE( 375)			{
HXLINE( 375)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 375)				_this->advanced(HX_("Cannot set manager once destroyed",68,a1,f5,fc),_this->styles->error,true,::hx::SourceInfo(HX_("flixel/text/FlxInputText.hx",ea,81,56,80),375,HX_("flixel.text.FlxInputText",f4,60,ec,89),HX_("setManager",eb,b6,a0,66)));
            			}
HXLINE( 376)			return;
            		}
...
HXLINE( 625)			 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 625)			rect1->_inPool = false;
HXDLIN( 625)			rect1->_weak = false;
HXDLIN( 625)			 ::flixel::math::FlxRect _this = rect1;
HXDLIN( 625)			_this->x = ((Float)0.0);
HXDLIN( 625)			_this->y = ((Float)0.0);
HXDLIN( 625)			_this->width = ((Float)0.0);
HXDLIN( 625)			_this->height = ((Float)0.0);
HXDLIN( 625)			rect = _this;
            		}
HXLINE( 626)		{
...
HXDLIN( 628)			 ::flixel::math::FlxRect rect2 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 628)			rect2->_inPool = false;
HXDLIN( 628)			rect2->_weak = false;
HXDLIN( 628)			 ::flixel::math::FlxRect _this1 = rect2;
HXDLIN( 628)			_this1->x = x;
HXDLIN( 628)			_this1->y = y;
HXDLIN( 628)			_this1->width = width2;
HXDLIN( 628)			_this1->height = height2;
HXDLIN( 628)			bounds = _this1;
            		}
            		else {
HXLINE( 629)			Float width3 = this->get_width();
HXDLIN( 629)			Float height3 = this->get_height();
HXDLIN( 629)			 ::flixel::math::FlxRect rect3 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 629)			rect3->_inPool = false;
HXDLIN( 629)			rect3->_weak = false;
HXDLIN( 629)			 ::flixel::math::FlxRect _this2 = rect3;
HXDLIN( 629)			_this2->x = ( (Float)(0) );
HXDLIN( 629)			_this2->y = ( (Float)(0) );
HXDLIN( 629)			_this2->width = width3;
HXDLIN( 629)			_this2->height = height3;
HXLINE( 628)			bounds = _this2;
            		}
...
HXDLIN(1414)						 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1414)						rect->_inPool = false;
HXDLIN(1414)						rect->_weak = false;
HXDLIN(1414)						 ::flixel::math::FlxRect _this = rect;
HXDLIN(1414)						_this->x = x;
HXDLIN(1414)						_this->y = y;
HXDLIN(1414)						_this->width = width1;
HXDLIN(1414)						_this->height = height;
HXDLIN(1414)						 ::flixel::math::FlxRect boxRect = _this;
HXLINE(1417)						Float width2 = this->get_width();
HXDLIN(1417)						Float height1 = this->get_height();
HXDLIN(1417)						 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1417)						rect1->_inPool = false;
HXDLIN(1417)						rect1->_weak = true;
HXDLIN(1417)						 ::flixel::math::FlxRect _this1 = rect1;
HXDLIN(1417)						_this1->x = ( (Float)(0) );
HXDLIN(1417)						_this1->y = ( (Float)(0) );
HXDLIN(1417)						_this1->width = width2;
HXDLIN(1417)						_this1->height = height1;
HXDLIN(1417)						boxRect->clipTo(_this1);
