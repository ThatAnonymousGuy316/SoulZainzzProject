...
HXLINE(  90)			::flixel::FlxG_obj::sound->create(HX_("flixel/sounds/flixel",54,41,d6,5d),null(),null())->play(null(),null(),null());
            		}
            	}
...
HXDLIN( 108)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 108)				_this->advanced(HX_("`onOutroComplete` was called after the state was switched. This will be ignored",46,b2,58,c7),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/FlxG.hx",36,68,17,8e),387,HX_("flixel.FlxG",07,ab,3b,0e),HX_("switchState",7d,07,8b,77)));
            			}
            		}
