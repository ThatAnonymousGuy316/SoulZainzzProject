...
HX_LOCAL_STACK_FRAME(_hx_pos_eacd59df718e3049_75_parse,"flixel.system._FlxAssets.FlxAngelCodeAsset_Impl_","parse",0x14fd3e6e,"flixel.system._FlxAssets.FlxAngelCodeAsset_Impl_.parse","flixel/system/FlxAssets.hx",75,0xd3ac1356)
namespace flixel{
...
bool FlxAngelCodeAsset_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFont FlxAngelCodeAsset_Impl__obj::parse( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_eacd59df718e3049_75_parse)
HXDLIN(  75)		return ::flixel::graphics::frames::bmfont::BMFont_obj::parse(this1);
            	}
