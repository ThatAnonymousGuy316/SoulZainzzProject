...
HX_LOCAL_STACK_FRAME(_hx_pos_392c32109d0ee29a_85_getXml,"flixel.system._FlxAssets.FlxXmlAsset_Impl_","getXml",0x8489080f,"flixel.system._FlxAssets.FlxXmlAsset_Impl_.getXml","flixel/system/FlxAssets.hx",85,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_392c32109d0ee29a_100_fromPath,"flixel.system._FlxAssets.FlxXmlAsset_Impl_","fromPath",0x66b93cdd,"flixel.system._FlxAssets.FlxXmlAsset_Impl_.fromPath","flixel/system/FlxAssets.hx",100,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_392c32109d0ee29a_105_fromXmlString,"flixel.system._FlxAssets.FlxXmlAsset_Impl_","fromXmlString",0x0b1003d0,"flixel.system._FlxAssets.FlxXmlAsset_Impl_.fromXmlString","flixel/system/FlxAssets.hx",105,0xd3ac1356)
namespace flixel{
...
bool FlxXmlAsset_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml FlxXmlAsset_Impl__obj::getXml( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_392c32109d0ee29a_85_getXml)
HXLINE(  86)		if (::Std_obj::isOfType(this1,::hx::ClassOf< ::String >())) {
HXLINE(  88)			::String str = ( (::String)(this1) );
HXLINE(  89)			if (( (bool)(::flixel::FlxG_obj::assets->exists(str,null())) )) {
HXLINE(  90)				::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(str,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN(  90)				 ::Xml _hx_tmp;
HXDLIN(  90)				if (::hx::IsNotNull( text )) {
HXLINE(  90)					_hx_tmp = ::Xml_obj::parse(text);
            				}
            				else {
HXLINE(  90)					_hx_tmp = null();
            				}
HXDLIN(  90)				return _hx_tmp;
            			}
HXLINE(  92)			 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
HXDLIN(  92)			return ::Xml_obj::parse(str);
            		}
HXLINE(  95)		return ::hx::TCast<  ::Xml >::cast(this1);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxXmlAsset_Impl__obj,getXml,return )
 ...
 ::Xml FlxXmlAsset_Impl__obj::fromPath(::String path){
            	HX_STACKFRAME(&_hx_pos_392c32109d0ee29a_100_fromPath)
HXDLIN( 100)		::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(path,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN( 100)		if (::hx::IsNotNull( text )) {
HXDLIN( 100)			return ::Xml_obj::parse(text);
            		}
            		else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxXmlAsset_Impl__obj,fromPath,return )
 ...
 ::Xml FlxXmlAsset_Impl__obj::fromXmlString(::String data){
            	HX_STACKFRAME(&_hx_pos_392c32109d0ee29a_105_fromXmlString)
HXDLIN( 105)		 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
HXDLIN( 105)		return ::Xml_obj::parse(data);
            	}
