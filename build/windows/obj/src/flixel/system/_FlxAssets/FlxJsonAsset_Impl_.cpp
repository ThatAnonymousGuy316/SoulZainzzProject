...
HX_LOCAL_STACK_FRAME(_hx_pos_1a8263561f5674e9_112_getData,"flixel.system._FlxAssets.FlxJsonAsset_Impl_","getData",0x4df94853,"flixel.system._FlxAssets.FlxJsonAsset_Impl_.getData","flixel/system/FlxAssets.hx",112,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_1a8263561f5674e9_127_fromPath,"flixel.system._FlxAssets.FlxJsonAsset_Impl_","fromPath",0x5fe4965c,"flixel.system._FlxAssets.FlxJsonAsset_Impl_.fromPath","flixel/system/FlxAssets.hx",127,0xd3ac1356)
HX_LOCAL_STACK_FRAME(_hx_pos_1a8263561f5674e9_132_fromDataString,"flixel.system._FlxAssets.FlxJsonAsset_Impl_","fromDataString",0x07608292,"flixel.system._FlxAssets.FlxJsonAsset_Impl_.fromDataString","flixel/system/FlxAssets.hx",132,0xd3ac1356)
namespace flixel{
...
bool FlxJsonAsset_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic FlxJsonAsset_Impl__obj::getData( ::Dynamic this1){
            	HX_GC_STACKFRAME(&_hx_pos_1a8263561f5674e9_112_getData)
HXLINE( 113)		if (::Std_obj::isOfType(this1,::hx::ClassOf< ::String >())) {
HXLINE( 115)			::String str = ( (::String)(this1) );
HXLINE( 116)			if (( (bool)(::flixel::FlxG_obj::assets->exists(str,null())) )) {
HXLINE( 117)				::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(str,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN( 117)				 ::Dynamic _hx_tmp;
HXDLIN( 117)				if (::hx::IsNotNull( text )) {
HXLINE( 117)					_hx_tmp =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,text)->doParse();
            				}
            				else {
HXLINE( 117)					_hx_tmp = null();
            				}
HXDLIN( 117)				return _hx_tmp;
            			}
HXLINE( 119)			 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
HXDLIN( 119)			return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,str)->doParse();
            		}
HXLINE( 122)		return this1;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxJsonAsset_Impl__obj,getData,return )
 ...
 ::Dynamic FlxJsonAsset_Impl__obj::fromPath(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_1a8263561f5674e9_127_fromPath)
HXDLIN( 127)		::String text = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(path,HX_("text",ad,cc,f9,4c),true)) );
HXDLIN( 127)		 ::Dynamic _hx_tmp;
HXDLIN( 127)		if (::hx::IsNotNull( text )) {
HXDLIN( 127)			_hx_tmp =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,text)->doParse();
            		}
            		else {
HXDLIN( 127)			_hx_tmp = null();
            		}
HXDLIN( 127)		return _hx_tmp;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxJsonAsset_Impl__obj,fromPath,return )
 ...
 ::Dynamic FlxJsonAsset_Impl__obj::fromDataString(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_1a8263561f5674e9_132_fromDataString)
HXDLIN( 132)		 ::flixel::_hx_system::frontEnds::AssetFrontEnd _this = ::flixel::FlxG_obj::assets;
HXDLIN( 132)		return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,data)->doParse();
            	}
