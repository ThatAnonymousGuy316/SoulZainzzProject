...
HXDLIN( 157)			 ::flixel::_hx_system::debug::log::FlxLogStyle log = null();
HXDLIN( 157)			 ::Dynamic pos = null();
HXDLIN( 157)			_hx_tmp->play(::flixel::_hx_system::FlxAssets_obj::resolveSound(sound,true,true,log,pos),null(),null(),null(),null(),null());
            		}
