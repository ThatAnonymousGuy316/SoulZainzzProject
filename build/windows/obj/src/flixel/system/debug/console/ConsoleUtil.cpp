...
HXDLIN( 171)		::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,text),::flixel::FlxG_obj::log->styles->console,null(),::hx::SourceInfo(HX_("flixel/system/debug/console/ConsoleUtil.hx",e6,cd,8b,2e),171,HX_("flixel.system.debug.console.ConsoleUtil",ba,4f,d6,a9),HX_("log",84,54,52,00)));
            	}
