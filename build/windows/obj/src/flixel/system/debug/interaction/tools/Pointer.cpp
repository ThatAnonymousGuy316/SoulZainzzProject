...
HXLINE(  51)						 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  51)						rect->_inPool = false;
HXDLIN(  51)						rect->_weak = false;
HXDLIN(  51)						 ::flixel::math::FlxRect _this = rect;
HXDLIN(  51)						_this->x = startX;
HXDLIN(  51)						_this->y = startY;
HXDLIN(  51)						_this->width = ((Float)0.0);
HXDLIN(  51)						_this->height = ((Float)0.0);
HXDLIN(  51)						 ::flixel::math::FlxRect selection = _this;
...
HXLINE(  64)						 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  64)						rect1->_inPool = false;
HXDLIN(  64)						rect1->_weak = false;
HXDLIN(  64)						 ::flixel::math::FlxRect _this1 = rect1;
HXDLIN(  64)						_this1->x = startX1;
HXDLIN(  64)						_this1->y = startY1;
HXDLIN(  64)						_this1->width = ((Float)0.0);
HXDLIN(  64)						_this1->height = ((Float)0.0);
HXDLIN(  64)						 ::flixel::math::FlxRect selection1 = _this1;
...
HXDLIN( 143)					{
HXLINE( 144)						 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 144)						rect->_inPool = false;
HXDLIN( 144)						rect->_weak = false;
HXDLIN( 144)						 ::flixel::math::FlxRect _this = rect;
HXDLIN( 144)						_this->x = ((Float)0.0);
HXDLIN( 144)						_this->y = ((Float)0.0);
HXDLIN( 144)						_this->width = ((Float)0.0);
HXDLIN( 144)						_this->height = ((Float)0.0);
HXDLIN( 144)						 ::flixel::math::FlxRect rect1 = _this;
