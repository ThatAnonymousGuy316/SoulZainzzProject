...
HXLINE(  48)		 ::flixel::_hx_system::debug::log::FlxLogStyle log = null();
HXDLIN(  48)		 ::Dynamic pos = null();
HXDLIN(  48)		this->button =  ::flixel::_hx_system::ui::FlxSystemButton_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(icon,log,pos),this->onButtonClicked_dyn(),true);
