...
HX_LOCAL_STACK_FRAME(_hx_pos_ff18a02f3055fb45_30_add_flixel_input_actions_FlxActionManager,"flixel.system.frontEnds.InputFrontEnd","add_flixel_input_actions_FlxActionManager",0xc1a93055,"flixel.system.frontEnds.InputFrontEnd.add_flixel_input_actions_FlxActionManager","flixel/system/frontEnds/InputFrontEnd.hx",30,0x759f67bd)
...
bool InputFrontEnd_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::input::actions::FlxActionManager InputFrontEnd_obj::add_flixel_input_actions_FlxActionManager( ::flixel::input::actions::FlxActionManager input){
            	HX_STACKFRAME(&_hx_pos_ff18a02f3055fb45_30_add_flixel_input_actions_FlxActionManager)
HXDLIN(  30)		return ( ( ::flixel::input::actions::FlxActionManager)(this->addUniqueType_add_T(input)) );
            	}
