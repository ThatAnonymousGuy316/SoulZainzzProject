...
HXLINE(  98)			return this->add(newCamera,defaultDrawTarget);
            		}
...
HXDLIN( 131)				_this->advanced(HX_("FlxG.cameras.remove(): The camera you attempted to remove is not a part of the game.",63,6f,2b,31),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/system/frontEnds/CameraFrontEnd.hx",ec,d3,57,7a),131,HX_("flixel.system.frontEnds.CameraFrontEnd",31,94,3d,41),HX_("remove",44,9c,88,04)));
            			}
HXLINE( 132)			return;
            		}
...
HXDLIN( 162)				_this->advanced(HX_("FlxG.cameras.setDefaultDrawTarget(): The specified camera is not a part of the game.",17,fb,50,a6),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/system/frontEnds/CameraFrontEnd.hx",ec,d3,57,7a),162,HX_("flixel.system.frontEnds.CameraFrontEnd",31,94,3d,41),HX_("setDefaultDrawTarget",94,14,3f,93)));
            			}
HXLINE( 163)			return;
            		}
