...
HXDLIN( 145)		if ((maxSize->y > minSize->y)) {
...
HXLINE( 164)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 164)		rect->_inPool = false;
HXDLIN( 164)		rect->_weak = false;
HXDLIN( 164)		 ::flixel::math::FlxRect _this = rect;
...
HXLINE( 191)		 ::openfl::display::BitmapData data = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(Graphic,null(),null());
...
HXDLIN( 221)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 221)		rect->_inPool = false;
HXDLIN( 221)		rect->_weak = false;
HXDLIN( 221)		 ::flixel::math::FlxRect _this = rect;
...
HXDLIN( 282)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 282)				rect->_inPool = false;
HXDLIN( 282)				rect->_weak = false;
HXDLIN( 282)				 ::flixel::math::FlxRect _this = rect;
...
HXDLIN( 286)					 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 286)					rect1->_inPool = false;
HXDLIN( 286)					rect1->_weak = false;
HXDLIN( 286)					 ::flixel::math::FlxRect _this1 = rect1;
...
HXDLIN( 290)				 ::flixel::math::FlxRect rect2 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 290)				rect2->_inPool = false;
HXDLIN( 290)				rect2->_weak = false;
HXDLIN( 290)				 ::flixel::math::FlxRect _this2 = rect2;
...
HXDLIN( 295)					 ::flixel::math::FlxRect rect3 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 295)					rect3->_inPool = false;
HXDLIN( 295)					rect3->_weak = false;
HXDLIN( 295)					 ::flixel::math::FlxRect _this3 = rect3;
...
HXDLIN( 301)				 ::flixel::math::FlxRect rect4 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 301)				rect4->_inPool = false;
HXDLIN( 301)				rect4->_weak = false;
HXDLIN( 301)				 ::flixel::math::FlxRect _this4 = rect4;
HXDLIN( 301)				_this4->x = x4;
HXDLIN( 301)				_this4->y = y4;
HXDLIN( 301)				_this4->width = width1;
HXDLIN( 301)				_this4->height = ( (Float)(insertHeight) );
HXDLIN( 301)				firstChild =  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,_this4,::hx::ObjectPtr<OBJ_>(this),null(),null(),null());
...
HXDLIN( 305)					 ::flixel::math::FlxRect rect5 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 305)					rect5->_inPool = false;
HXDLIN( 305)					rect5->_weak = false;
HXDLIN( 305)					 ::flixel::math::FlxRect _this5 = rect5;
HXDLIN( 305)					_this5->x = x5;
HXDLIN( 305)					_this5->y = y5;
HXDLIN( 305)					_this5->width = width2;
HXDLIN( 305)					_this5->height = height3;
HXDLIN( 305)					secondChild =  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,_this5,::hx::ObjectPtr<OBJ_>(this),null(),null(),null());
            				}
HXLINE( 309)				Float x6 = ( (Float)(::Std_obj::_hx_int(firstChild->rect->x)) );
HXDLIN( 309)				Float y6 = ( (Float)(::Std_obj::_hx_int(firstChild->rect->y)) );
HXDLIN( 309)				 ::flixel::math::FlxRect rect6 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 309)				rect6->_inPool = false;
HXDLIN( 309)				rect6->_weak = false;
HXDLIN( 309)				 ::flixel::math::FlxRect _this6 = rect6;
...
HXDLIN( 309)				firstGrandChild =  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,_this6,::hx::ObjectPtr<OBJ_>(this),firstGrandChildFilled,firstGrandChildKey,firstGrandChildRotated);
...
HXDLIN( 314)					 ::flixel::math::FlxRect rect7 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 314)					rect7->_inPool = false;
HXDLIN( 314)					rect7->_weak = false;
HXDLIN( 314)					 ::flixel::math::FlxRect _this7 = rect7;
HXDLIN( 314)					_this7->x = x7;
HXDLIN( 314)					_this7->y = y7;
HXDLIN( 314)					_this7->width = width3;
HXDLIN( 314)					_this7->height = ( (Float)(insertHeight) );
HXDLIN( 314)					secondGrandChild =  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,_this7,::hx::ObjectPtr<OBJ_>(this),null(),null(),null());
            				}
            			}
...
HXLINE( 553)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 553)			rect->_inPool = false;
HXDLIN( 553)			rect->_weak = false;
HXDLIN( 553)			 ::flixel::math::FlxRect _this = rect;
HXDLIN( 553)			_this->x = ( (Float)(0) );
HXDLIN( 553)			_this->y = ( (Float)(0) );
HXDLIN( 553)			_this->width = newWidth;
HXDLIN( 553)			_this->height = newHeight;
HXDLIN( 553)			this->root =  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,_this,::hx::ObjectPtr<OBJ_>(this),null(),null(),null());
...
HXLINE( 623)		 ::openfl::display::BitmapData data = ::flixel::_hx_system::FlxAssets_obj::resolveBitmapData(Graphic,null(),null());
...
HXDLIN( 681)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 681)			rect->_inPool = false;
HXDLIN( 681)			rect->_weak = false;
HXDLIN( 681)			 ::flixel::math::FlxRect _this = rect;
HXDLIN( 681)			_this->x = x;
HXDLIN( 681)			_this->y = y;
HXDLIN( 681)			_this->width = width1;
HXDLIN( 681)			_this->height = height1;
HXDLIN( 681)			 ::flixel::math::FlxRect frame = _this;
...
HXDLIN( 682)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x2,y2);
...
HXDLIN( 683)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x4,y4);
...
HXLINE(1102)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(1102)				rect->_inPool = false;
HXDLIN(1102)				rect->_weak = false;
HXDLIN(1102)				 ::flixel::math::FlxRect _this = rect;
...
HXDLIN(1102)				this->root =  ::flixel::graphics::atlas::FlxNode_obj::__alloc( HX_CTX ,_this,::hx::ObjectPtr<OBJ_>(this),null(),null(),null());
