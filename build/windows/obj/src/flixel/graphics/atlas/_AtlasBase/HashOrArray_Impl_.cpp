...
HX_LOCAL_STACK_FRAME(_hx_pos_e7a0ae140684c0ba_88_isArray,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_","isArray",0x02ce8f4c,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_.isArray","flixel/graphics/atlas/AtlasBase.hx",88,0x520eac77)
HX_LOCAL_STACK_FRAME(_hx_pos_e7a0ae140684c0ba_93_isHash,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_","isHash",0x2024057b,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_.isHash","flixel/graphics/atlas/AtlasBase.hx",93,0x520eac77)
HX_LOCAL_STACK_FRAME(_hx_pos_e7a0ae140684c0ba_99_toArray,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_","toArray",0x32cd381b,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_.toArray","flixel/graphics/atlas/AtlasBase.hx",99,0x520eac77)
HX_LOCAL_STACK_FRAME(_hx_pos_e7a0ae140684c0ba_105_toHash,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_","toHash",0x3876ab8c,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_.toHash","flixel/graphics/atlas/AtlasBase.hx",105,0x520eac77)
HX_LOCAL_STACK_FRAME(_hx_pos_e7a0ae140684c0ba_110_iterator,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_","iterator",0xf52f0951,"flixel.graphics.atlas._AtlasBase.HashOrArray_Impl_.iterator","flixel/graphics/atlas/AtlasBase.hx",110,0x520eac77)
namespace flixel{
namespace graphics{
namespace atlas{
...
bool HashOrArray_Impl__obj::isArray( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_e7a0ae140684c0ba_88_isArray)
HXDLIN(  88)		return ::Std_obj::isOfType(this1,::hx::ArrayBase::__mClass);
            	}
...
bool HashOrArray_Impl__obj::isHash( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_e7a0ae140684c0ba_93_isHash)
HXDLIN(  93)		return !(::Std_obj::isOfType(this1,::hx::ArrayBase::__mClass));
            	}
...
::cpp::VirtualArray HashOrArray_Impl__obj::toArray( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_e7a0ae140684c0ba_99_toArray)
HXDLIN(  99)		return ( (::cpp::VirtualArray)(this1) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(HashOrArray_Impl__obj,toArray,return )
 ...
 ::Dynamic HashOrArray_Impl__obj::toHash( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_e7a0ae140684c0ba_105_toHash)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(HashOrArray_Impl__obj,toHash,return )
 ...
 ::Dynamic HashOrArray_Impl__obj::iterator( ::Dynamic this1){
            	HX_GC_STACKFRAME(&_hx_pos_e7a0ae140684c0ba_110_iterator)
HXDLIN( 110)		if (::Std_obj::isOfType(this1,::hx::ArrayBase::__mClass)) {
HXLINE( 111)			return  ::haxe::iterators::ArrayIterator_obj::__alloc( HX_CTX ,( (::cpp::VirtualArray)(this1) ));
            		}
            		else {
HXLINE( 113)			return  ::haxe::iterators::DynamicAccessIterator_obj::__alloc( HX_CTX ,this1);
            		}
