...
HXDLIN( 461)			_this->advanced(((data + this->fontName) + HX_("\"",22,00,00,00)),_this->styles->error,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxBitmapFont.hx",06,82,34,de),461,HX_("flixel.graphics.frames.FlxBitmapFont",79,e8,86,f0),HX_("setCharFrame",75,c1,2b,e4)));
            		}
...
HXLINE( 277)					 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 277)					rect->_inPool = false;
HXDLIN( 277)					rect->_weak = false;
HXDLIN( 277)					 ::flixel::math::FlxRect _this = rect;
HXDLIN( 277)					_this->x = ( (Float)(cx) );
HXDLIN( 277)					_this->y = ( (Float)(cy) );
HXDLIN( 277)					_this->width = ( (Float)(gw) );
HXDLIN( 277)					_this->height = ( (Float)(gh) );
HXDLIN( 277)					 ::flixel::math::FlxRect rect1 = _this;
...
HXDLIN( 381)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 381)			rect->_inPool = false;
HXDLIN( 381)			rect->_weak = true;
HXDLIN( 381)			 ::flixel::math::FlxRect _this = rect;
HXDLIN( 381)			_this->x = ( (Float)(0) );
HXDLIN( 381)			_this->y = ( (Float)(0) );
HXDLIN( 381)			_this->width = width;
HXDLIN( 381)			_this->height = height;
HXDLIN( 381)			region = _this;
            		}
...
HXLINE( 417)						 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 417)						rect1->_inPool = false;
HXDLIN( 417)						rect1->_weak = false;
HXDLIN( 417)						 ::flixel::math::FlxRect _this1 = rect1;
...
HXDLIN( 417)						 ::flixel::math::FlxRect charRect = _this1;
...
HXLINE( 526)			{
HXLINE( 526)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
HXDLIN( 526)				_this1->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),_this1->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),494,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
            			}
...
HXLINE( 529)					 ::flixel::math::FlxBasePoint _this2 = font->border;
HXDLIN( 529)					bool result;
HXDLIN( 529)					if ((::Math_obj::abs((_this2->x - border->x)) <= ((Float)0.0000001))) {
HXLINE( 529)						result = (::Math_obj::abs((_this2->y - border->y)) <= ((Float)0.0000001));
            					}
            					else {
