...
HX_LOCAL_STACK_FRAME(_hx_pos_d294561f5bda5770_427_addBorder,"flixel.graphics.frames.FlxAtlasFrames","addBorder",0x1a31fb55,"flixel.graphics.frames.FlxAtlasFrames.addBorder","flixel/graphics/frames/FlxAtlasFrames.hx",427,0x501ecb67)
HX_LOCAL_STACK_FRAME(_hx_pos_d294561f5bda5770_451_addAtlas,"flixel.graphics.frames.FlxAtlasFrames","addAtlas",0xf89d1f02,"flixel.graphics.frames.FlxAtlasFrames.addAtlas","flixel/graphics/frames/FlxAtlasFrames.hx",451,0x501ecb67)
HX_LOCAL_STACK_FRAME(_hx_pos_d294561f5bda5770_474_concat,"flixel.graphics.frames.FlxAtlasFrames","concat",0x0fd01eac,"flixel.graphics.frames.FlxAtlasFrames.concat","flixel/graphics/frames/FlxAtlasFrames.hx",474,0x501ecb67)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d294561f5bda5770_318_fromTexturePackerXml,"flixel.graphics.frames.FlxAtlasFrames","fromTexturePackerXml",0x5ca98eb8,"flixel.graphics.frames.FlxAtlasFrames.fromTexturePackerXml","flixel/graphics/frames/FlxAtlasFrames.hx",318,0x501ecb67)
HX_LOCAL_STACK_FRAME(_hx_pos_d294561f5bda5770_367_fromSpriteSheetPacker,"flixel.graphics.frames.FlxAtlasFrames","fromSpriteSheetPacker",0x4fb8a81e,"flixel.graphics.frames.FlxAtlasFrames.fromSpriteSheetPacker","flixel/graphics/frames/FlxAtlasFrames.hx",367,0x501ecb67)
HX_LOCAL_STACK_FRAME(_hx_pos_d294561f5bda5770_413_findFrame,"flixel.graphics.frames.FlxAtlasFrames","findFrame",0xf36e229c,"flixel.graphics.frames.FlxAtlasFrames.findFrame","flixel/graphics/frames/FlxAtlasFrames.hx",413,0x501ecb67)
namespace flixel{
namespace graphics{
namespace frames{
...
HXLINE(  32)		this->super::destroy();
 ...
 ::flixel::graphics::frames::FlxFramesCollection FlxAtlasFrames_obj::addBorder( ::flixel::math::FlxBasePoint border){
            	HX_GC_STACKFRAME(&_hx_pos_d294561f5bda5770_427_addBorder)
HXLINE( 428)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 428)		point->_inPool = false;
HXDLIN( 428)		 ::flixel::math::FlxBasePoint point1 = point;
HXDLIN( 428)		point1->_weak = true;
HXDLIN( 428)		 ::flixel::math::FlxBasePoint this1 = point1;
HXDLIN( 428)		 ::flixel::math::FlxBasePoint point2 = this->border;
HXDLIN( 428)		this1->set((this1->x + point2->x),(this1->y + point2->y));
HXDLIN( 428)		{
HXLINE( 428)			 ::flixel::math::FlxBasePoint _this = point2;
HXDLIN( 428)			if (_this->_weak) {
HXLINE( 428)				_this->put();
            			}
            		}
HXDLIN( 428)		 ::flixel::math::FlxBasePoint this2 = this1;
HXDLIN( 428)		this2->set((this2->x + border->x),(this2->y + border->y));
HXDLIN( 428)		{
HXLINE( 428)			 ::flixel::math::FlxBasePoint _this1 = border;
HXDLIN( 428)			if (_this1->_weak) {
HXLINE( 428)				_this1->put();
            			}
            		}
HXDLIN( 428)		 ::flixel::math::FlxBasePoint resultBorder = this2;
HXLINE( 429)		 ::flixel::graphics::frames::FlxAtlasFrames atlasFrames = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(this->parent,resultBorder);
HXLINE( 430)		if (::hx::IsNotNull( atlasFrames )) {
HXLINE( 431)			return atlasFrames;
            		}
HXLINE( 433)		atlasFrames =  ::flixel::graphics::frames::FlxAtlasFrames_obj::__alloc( HX_CTX ,this->parent,resultBorder);
HXLINE( 435)		{
HXLINE( 435)			int _g = 0;
HXDLIN( 435)			::Array< ::Dynamic> _g1 = this->frames;
HXDLIN( 435)			while((_g < _g1->length)){
HXLINE( 435)				 ::flixel::graphics::frames::FlxFrame frame = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 435)				_g = (_g + 1);
HXLINE( 436)				atlasFrames->pushFrame(frame->setBorderTo(border,null()),null());
            			}
            		}
HXLINE( 438)		return atlasFrames;
            	}
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::addAtlas( ::flixel::graphics::frames::FlxAtlasFrames collection,::hx::Null< bool >  __o_overwriteHash){
            	...
            	HX_STACKFRAME(&_hx_pos_d294561f5bda5770_451_addAtlas)
HXLINE( 452)		{
HXLINE( 452)			int _g = 0;
HXDLIN( 452)			::Array< ::Dynamic> _g1 = collection->frames;
HXDLIN( 452)			while((_g < _g1->length)){
HXLINE( 452)				 ::flixel::graphics::frames::FlxFrame frame = _g1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 452)				_g = (_g + 1);
HXLINE( 453)				this->pushFrame(frame,overwriteHash);
            			}
            		}
HXLINE( 455)		if (!(this->usedGraphics->contains(collection->parent))) {
HXLINE( 457)			this->usedGraphics->push(collection->parent);
HXLINE( 458)			collection->parent->incrementUseCount();
            		}
...
HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,addAtlas,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::concat( ::flixel::graphics::frames::FlxAtlasFrames collection,::hx::Null< bool >  __o_overwriteHash){
            		bool overwriteHash = __o_overwriteHash.Default(false);
            	HX_GC_STACKFRAME(&_hx_pos_d294561f5bda5770_474_concat)
HXLINE( 475)		 ::flixel::graphics::frames::FlxAtlasFrames newCollection =  ::flixel::graphics::frames::FlxAtlasFrames_obj::__alloc( HX_CTX ,this->parent,null());
HXLINE( 476)		newCollection->addAtlas(::hx::ObjectPtr<OBJ_>(this),null());
HXLINE( 477)		newCollection->addAtlas(::hx::ObjectPtr<OBJ_>(this),overwriteHash);
...
HXDLIN( 115)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 115)			rect->_inPool = false;
HXDLIN( 115)			rect->_weak = false;
HXDLIN( 115)			 ::flixel::math::FlxRect _this = rect;
HXDLIN( 115)			_this->x = x;
HXDLIN( 115)			_this->y = y;
HXDLIN( 115)			_this->width = width;
HXDLIN( 115)			_this->height = height;
HXDLIN( 115)			frameRect = _this;
HXLINE( 116)			angle = -90;
            		}
            		else {
...
HXDLIN( 120)			 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 120)			rect1->_inPool = false;
HXDLIN( 120)			rect1->_weak = false;
HXDLIN( 120)			 ::flixel::math::FlxRect _this1 = rect1;
HXDLIN( 120)			_this1->x = x1;
HXDLIN( 120)			_this1->y = y1;
HXDLIN( 120)			_this1->width = width1;
HXDLIN( 120)			_this1->height = height1;
HXDLIN( 120)			frameRect = _this1;
            		}
HXLINE( 123)		Float x2 = ( (Float)( ::Dynamic(frameData->__Field(HX_("sourceSize",3c,87,b7,74),::hx::paccDynamic))->__Field(HX_("w",77,00,00,00),::hx::paccDynamic)) );
HXDLIN( 123)		Float y2 = ( (Float)( ::Dynamic(frameData->__Field(HX_("sourceSize",3c,87,b7,74),::hx::paccDynamic))->__Field(HX_("h",68,00,00,00),::hx::paccDynamic)) );
HXDLIN( 123)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x2,y2);
HXDLIN( 123)		point->_inPool = false;
HXDLIN( 123)		 ::flixel::math::FlxBasePoint sourceSize = point;
HXLINE( 124)		Float x3 = ( (Float)( ::Dynamic(frameData->__Field(HX_("spriteSourceSize",a1,7f,c1,03),::hx::paccDynamic))->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) );
HXDLIN( 124)		Float y3 = ( (Float)( ::Dynamic(frameData->__Field(HX_("spriteSourceSize",a1,7f,c1,03),::hx::paccDynamic))->__Field(HX_("y",79,00,00,00),::hx::paccDynamic)) );
HXDLIN( 124)		 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x3,y3);
...
HXLINE( 187)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 187)				rect->_inPool = false;
HXDLIN( 187)				rect->_weak = false;
HXDLIN( 187)				 ::flixel::math::FlxRect _this = rect;
...
HXDLIN( 187)				 ::flixel::math::FlxRect rect1 = _this;
...
HXLINE( 254)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 254)		rect->_inPool = false;
HXDLIN( 254)		rect->_weak = false;
HXDLIN( 254)		 ::flixel::math::FlxRect _this = rect;
HXDLIN( 254)		_this->x = ((Float)0.0);
HXDLIN( 254)		_this->y = ((Float)0.0);
HXDLIN( 254)		_this->width = ((Float)0.0);
HXDLIN( 254)		_this->height = ((Float)0.0);
HXDLIN( 254)		 ::flixel::math::FlxRect size = _this;
HXLINE( 255)		{
HXLINE( 255)			int _g = 0;
...
HXLINE( 266)				Float x1 = ::Std_obj::parseFloat(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("x",78,00,00,00)));
...
HXDLIN( 266)				 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 266)				rect1->_inPool = false;
HXDLIN( 266)				rect1->_weak = false;
HXDLIN( 266)				 ::flixel::math::FlxRect _this1 = rect1;
HXDLIN( 266)				_this1->x = x1;
HXDLIN( 266)				_this1->y = y;
HXDLIN( 266)				_this1->width = width;
HXDLIN( 266)				_this1->height = height;
HXDLIN( 266)				 ::flixel::math::FlxRect rect2 = _this1;
HXLINE( 269)				if (trimmed) {
HXLINE( 271)					Float x2 = ( (Float)(::Std_obj::parseInt(::haxe::xml::_Access::AttribAccess_Impl__obj::resolve(texture,HX_("frameX",8b,af,85,ac)))) );
...
HXDLIN( 271)					size->x = x2;
HXDLIN( 271)					size->y = y1;
HXDLIN( 271)					size->width = width1;
HXDLIN( 271)					size->height = height1;
            				}
            				else {
HXLINE( 276)					size->x = ( (Float)(0) );
HXDLIN( 276)					size->y = ( (Float)(0) );
HXDLIN( 276)					size->width = rect2->width;
HXDLIN( 276)					size->height = rect2->height;
            				}
...
HXLINE( 282)				Float x3 = -(size->x);
HXDLIN( 282)				Float y2 = -(size->y);
HXDLIN( 282)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x3,y2);
HXDLIN( 282)				point->_inPool = false;
HXDLIN( 282)				 ::flixel::math::FlxBasePoint offset = point;
HXLINE( 283)				Float x4 = size->width;
HXDLIN( 283)				Float y3 = size->height;
HXDLIN( 283)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x4,y3);
...
HXLINE( 286)					sourceSize->set(size->height,size->width);
            				}
HXLINE( 289)				bool _hx_tmp4;
HXDLIN( 289)				if ((rect2->width != 0)) {
HXLINE( 289)					_hx_tmp4 = (rect2->height == 0);
            				}
            				else {
...
HXLINE( 297)					{
HXLINE( 297)						frame->offset->set(offset->x,offset->y);
HXDLIN( 297)						{
HXLINE( 297)							 ::flixel::math::FlxBasePoint _this2 = offset;
HXDLIN( 297)							if (_this2->_weak) {
HXLINE( 297)								_this2->put();
            							}
            						}
            					}
HXLINE( 299)					continue;
            				}
HXLINE( 302)				frames->addAtlasFrame(rect2,sourceSize,offset,name,angle,flipX,flipY,null());
            			}
            		}
HXLINE( 304)		if (!(size->_inPool)) {
HXLINE( 304)			size->_inPool = true;
HXDLIN( 304)			::flixel::math::FlxRect_obj::_pool->putUnsafe(size);
            		}
HXLINE( 306)		return frames;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,fromSparrow,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromTexturePackerXml( ::Dynamic source, ::Dynamic xml){
            	HX_GC_STACKFRAME(&_hx_pos_d294561f5bda5770_318_fromTexturePackerXml)
HXLINE( 319)		 ::flixel::graphics::FlxGraphic graphic = ::flixel::FlxG_obj::bitmap->add(source,false,null());
HXLINE( 320)		if (::hx::IsNull( graphic )) {
HXLINE( 321)			return null();
            		}
HXLINE( 324)		 ::flixel::graphics::frames::FlxAtlasFrames frames = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
HXLINE( 325)		if (::hx::IsNotNull( frames )) {
HXLINE( 326)			return frames;
            		}
HXLINE( 328)		bool _hx_tmp;
HXDLIN( 328)		if (::hx::IsNotNull( graphic )) {
HXLINE( 328)			_hx_tmp = ::hx::IsNull( xml );
            		}
            		else {
...
HXLINE( 331)		frames =  ::flixel::graphics::frames::FlxAtlasFrames_obj::__alloc( HX_CTX ,graphic,null());
HXLINE( 333)		 ::Xml data = ::flixel::_hx_system::_FlxAssets::FlxXmlAsset_Impl__obj::getXml(xml);
HXLINE( 335)		{
HXLINE( 335)			 ::Dynamic sprite = data->firstElement()->elements();
HXDLIN( 335)			while(( (bool)(sprite->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 335)				 ::Xml sprite1 = ( ( ::Xml)(sprite->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 337)				bool trimmed;
HXDLIN( 337)				if (!(sprite1->exists(HX_("oX",09,61,00,00)))) {
HXLINE( 337)					trimmed = sprite1->exists(HX_("oY",0a,61,00,00));
            				}
            				else {
HXLINE( 337)					trimmed = true;
            				}
HXLINE( 338)				bool rotated;
HXDLIN( 338)				if (sprite1->exists(HX_("r",72,00,00,00))) {
HXLINE( 338)					rotated = (sprite1->get(HX_("r",72,00,00,00)) == HX_("y",79,00,00,00));
            				}
            				else {
HXLINE( 338)					rotated = false;
            				}
HXLINE( 339)				int angle;
HXDLIN( 339)				if (rotated) {
HXLINE( 339)					angle = -90;
            				}
            				else {
HXLINE( 339)					angle = 0;
            				}
HXLINE( 340)				::String name = sprite1->get(HX_("n",6e,00,00,00));
HXLINE( 341)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(0,0);
HXDLIN( 341)				point->_inPool = false;
HXDLIN( 341)				 ::flixel::math::FlxBasePoint offset = point;
HXLINE( 342)				Float x = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("x",78,00,00,00)))) );
HXDLIN( 342)				Float y = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("y",79,00,00,00)))) );
HXDLIN( 342)				Float width = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("w",77,00,00,00)))) );
HXDLIN( 342)				Float height = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("h",68,00,00,00)))) );
HXDLIN( 342)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 342)				rect->_inPool = false;
HXDLIN( 342)				rect->_weak = false;
HXDLIN( 342)				 ::flixel::math::FlxRect _this = rect;
HXDLIN( 342)				_this->x = x;
HXDLIN( 342)				_this->y = y;
HXDLIN( 342)				_this->width = width;
HXDLIN( 342)				_this->height = height;
HXDLIN( 342)				 ::flixel::math::FlxRect rect1 = _this;
HXLINE( 343)				Float x1 = rect1->width;
HXDLIN( 343)				Float y1 = rect1->height;
HXDLIN( 343)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 343)				point1->_inPool = false;
HXDLIN( 343)				 ::flixel::math::FlxBasePoint sourceSize = point1;
HXLINE( 345)				if (trimmed) {
HXLINE( 347)					{
HXLINE( 347)						Float x2 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oX",09,61,00,00)))) );
HXDLIN( 347)						offset->set(x2,( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oY",0a,61,00,00)))) ));
            					}
HXLINE( 348)					{
HXLINE( 348)						Float x3 = ( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oW",08,61,00,00)))) );
HXDLIN( 348)						sourceSize->set(x3,( (Float)(::Std_obj::parseInt(sprite1->get(HX_("oH",f9,60,00,00)))) ));
            					}
            				}
HXLINE( 351)				frames->addAtlasFrame(rect1,sourceSize,offset,name,angle,null(),null(),null());
            			}
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,fromTexturePackerXml,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::fromSpriteSheetPacker( ::Dynamic Source,::String Description){
            	HX_GC_STACKFRAME(&_hx_pos_d294561f5bda5770_367_fromSpriteSheetPacker)
HXLINE( 368)		 ::flixel::graphics::FlxGraphic graphic = ::flixel::FlxG_obj::bitmap->add(Source,null(),null());
HXLINE( 369)		if (::hx::IsNull( graphic )) {
HXLINE( 370)			return null();
            		}
HXLINE( 373)		 ::flixel::graphics::frames::FlxAtlasFrames frames = ::flixel::graphics::frames::FlxAtlasFrames_obj::findFrame(graphic,null());
HXLINE( 374)		if (::hx::IsNotNull( frames )) {
HXLINE( 375)			return frames;
            		}
HXLINE( 377)		bool _hx_tmp;
HXDLIN( 377)		if (::hx::IsNotNull( graphic )) {
HXLINE( 377)			_hx_tmp = ::hx::IsNull( Description );
            		}
            		else {
...
HXLINE( 380)		frames =  ::flixel::graphics::frames::FlxAtlasFrames_obj::__alloc( HX_CTX ,graphic,null());
HXLINE( 382)		if (( (bool)(::flixel::FlxG_obj::assets->exists(Description,null())) )) {
HXLINE( 383)			Description = ( (::String)(::flixel::FlxG_obj::assets->getAssetUnsafe(Description,HX_("text",ad,cc,f9,4c),true)) );
            		}
HXLINE( 385)		::String pack = ::StringTools_obj::trim(Description);
HXLINE( 386)		::Array< ::String > lines = pack.split(HX_("\n",0a,00,00,00));
HXLINE( 388)		{
HXLINE( 388)			int _g = 0;
HXDLIN( 388)			int _g1 = lines->length;
HXDLIN( 388)			while((_g < _g1)){
HXLINE( 388)				_g = (_g + 1);
HXDLIN( 388)				int i = (_g - 1);
HXLINE( 390)				::Array< ::String > currImageData = lines->__get(i).split(HX_("=",3d,00,00,00));
HXLINE( 391)				::String name = ::StringTools_obj::trim(currImageData->__get(0));
HXLINE( 392)				::Array< ::String > currImageRegion = ::StringTools_obj::trim(currImageData->__get(1)).split(HX_(" ",20,00,00,00));
HXLINE( 394)				Float x = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(0))) );
HXDLIN( 394)				Float y = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(1))) );
HXDLIN( 394)				Float width = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(2))) );
HXDLIN( 394)				Float height = ( (Float)(::Std_obj::parseInt(currImageRegion->__get(3))) );
HXDLIN( 394)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 394)				rect->_inPool = false;
HXDLIN( 394)				rect->_weak = false;
HXDLIN( 394)				 ::flixel::math::FlxRect _this = rect;
HXDLIN( 394)				_this->x = x;
HXDLIN( 394)				_this->y = y;
HXDLIN( 394)				_this->width = width;
HXDLIN( 394)				_this->height = height;
HXDLIN( 394)				 ::flixel::math::FlxRect rect1 = _this;
HXLINE( 396)				Float x1 = rect1->width;
HXDLIN( 396)				Float y1 = rect1->height;
HXDLIN( 396)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(x1,y1);
HXDLIN( 396)				point->_inPool = false;
HXDLIN( 396)				 ::flixel::math::FlxBasePoint sourceSize = point;
HXLINE( 397)				 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 397)				point1->_inPool = false;
HXDLIN( 397)				 ::flixel::math::FlxBasePoint offset = point1;
HXLINE( 399)				frames->addAtlasFrame(rect1,sourceSize,offset,name,0,null(),null(),null());
            			}
            		}
HXLINE( 402)		return frames;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(FlxAtlasFrames_obj,fromSpriteSheetPacker,return )
 ...
 ::flixel::graphics::frames::FlxAtlasFrames FlxAtlasFrames_obj::findFrame( ::flixel::graphics::FlxGraphic graphic, ::flixel::math::FlxBasePoint border){
            	HX_STACKFRAME(&_hx_pos_d294561f5bda5770_413_findFrame)
HXLINE( 414)		if (::hx::IsNull( border )) {
HXLINE( 415)			 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 415)			point->_inPool = false;
HXDLIN( 415)			 ::flixel::math::FlxBasePoint point1 = point;
HXDLIN( 415)			point1->_weak = true;
HXDLIN( 415)			border = point1;
            		}
HXLINE( 417)		 ::flixel::graphics::frames::FlxFrameCollectionType type = ::flixel::graphics::frames::FlxFrameCollectionType_obj::ATLAS_dyn();
HXDLIN( 417)		::cpp::VirtualArray atlasFrames;
HXDLIN( 417)		if (::hx::IsNull( graphic->shader )) {
HXLINE( 417)			{
HXLINE( 417)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 417)				_this->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),494,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
            			}
HXDLIN( 417)			atlasFrames = ::cpp::VirtualArray_obj::__new(0);
            		}
            		else {
HXLINE( 417)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(graphic->frameCollections->get(type)) );
HXDLIN( 417)			if (::hx::IsNull( collections )) {
HXLINE( 417)				collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 417)				graphic->frameCollections->set(type,collections);
            			}
HXDLIN( 417)			atlasFrames = collections;
            		}
HXDLIN( 417)		::Array< ::Dynamic> atlasFrames1 = atlasFrames;
HXLINE( 419)		{
HXLINE( 419)			int _g = 0;
HXDLIN( 419)			while((_g < atlasFrames1->length)){
HXLINE( 419)				 ::flixel::graphics::frames::FlxAtlasFrames atlas = atlasFrames1->__get(_g).StaticCast<  ::flixel::graphics::frames::FlxAtlasFrames >();
HXDLIN( 419)				_g = (_g + 1);
HXLINE( 420)				 ::flixel::math::FlxBasePoint _this1 = atlas->border;
HXDLIN( 420)				bool result;
HXDLIN( 420)				if ((::Math_obj::abs((_this1->x - border->x)) <= ((Float)0.0000001))) {
HXLINE( 420)					result = (::Math_obj::abs((_this1->y - border->y)) <= ((Float)0.0000001));
            				}
            				else {
HXLINE( 420)					result = false;
            				}
HXDLIN( 420)				if (border->_weak) {
HXLINE( 420)					border->put();
            				}
HXDLIN( 420)				if (result) {
HXLINE( 421)					return atlas;
            				}
            			}
            		}
