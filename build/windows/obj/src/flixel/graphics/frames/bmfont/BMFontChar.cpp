...
HXDLIN(  79)				goto _hx_goto_4;
            			...
            			/* default */{
HXLINE(  84)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(  84)				_this->advanced((((HX_("Unexpected font char attribute: ",7a,69,14,e4) + key) + HX_("=",3d,00,00,00)) + value),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/bmfont/BMFontChar.hx",31,9a,ed,4a),84,HX_("flixel.graphics.frames.bmfont.BMFontChar",ad,60,d1,d8),HX_("fromText",37,9b,c5,aa)));
            			}
            			_hx_goto_4:;
            		}
