...
HXDLIN(  50)				goto _hx_goto_4;
            			...
            			/* default */{
HXLINE(  52)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(  52)				_this->advanced((((HX_("Unexpected font char attribute: ",7a,69,14,e4) + key) + HX_("=",3d,00,00,00)) + value),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/bmfont/BMFontPage.hx",58,d0,d4,06),52,HX_("flixel.graphics.frames.bmfont.BMFontPage",26,dc,63,e1),HX_("fromText",37,9b,c5,aa)));
            			}
            			_hx_goto_4:;
            		}
