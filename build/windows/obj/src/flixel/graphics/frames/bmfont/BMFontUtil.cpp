...
HXLINE(  19)			::String value = ::flixel::graphics::frames::bmfont::BMFontUtil_obj::attFinder->matched(4);
...
HXDLIN(  11)		attFinder =  ::EReg_obj::__alloc( HX_CTX ,HX_("(\\w+?)=(\\s*)(\"?)(.*?)\\3(?=\\s|$)",72,d8,a2,de),HX_("",00,00,00,00));
            	}
}
