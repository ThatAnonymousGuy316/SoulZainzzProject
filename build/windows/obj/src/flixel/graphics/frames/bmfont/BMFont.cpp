...
HXDLIN( 135)				_g = (_g + 1);
HXLINE( 137)				 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 137)				rect->_inPool = false;
HXDLIN( 137)				rect->_weak = false;
HXDLIN( 137)				 ::flixel::math::FlxRect _this = rect;
HXDLIN( 137)				_this->x = ((Float)0.0);
HXDLIN( 137)				_this->y = ((Float)0.0);
HXDLIN( 137)				_this->width = ((Float)0.0);
HXDLIN( 137)				_this->height = ((Float)0.0);
HXDLIN( 137)				 ::flixel::math::FlxRect frame = _this;
...
HXDLIN( 100)			_this->advanced(HX_("The BMFont parser is made to work on files with version 3. Using earlier versions can cause issues!",db,84,bd,6a),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/bmfont/BMFont.hx",e7,9e,ad,28),100,HX_("flixel.graphics.frames.bmfont.BMFont",37,ee,9f,e7),HX_("fromBytes",a1,f2,20,72)));
            		}
