...
HXDLIN( 500)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 500)			rect->_inPool = false;
HXDLIN( 500)			rect->_weak = true;
HXDLIN( 500)			 ::flixel::math::FlxRect _this = rect;
...
HXLINE( 527)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 527)		rect->_inPool = false;
HXDLIN( 527)		rect->_weak = false;
HXDLIN( 527)		 ::flixel::math::FlxRect _this3 = rect;
HXDLIN( 527)		_this3->x = ((Float)0.0);
HXDLIN( 527)		_this3->y = ((Float)0.0);
HXDLIN( 527)		_this3->width = ((Float)0.0);
HXDLIN( 527)		_this3->height = ((Float)0.0);
HXDLIN( 527)		 ::flixel::math::FlxRect _this4 = _this3;
HXDLIN( 527)		 ::flixel::math::FlxRect rect1 = this->region;
HXDLIN( 527)		_this4->x = rect1->x;
HXDLIN( 527)		_this4->y = rect1->y;
HXDLIN( 527)		_this4->width = rect1->width;
HXDLIN( 527)		_this4->height = rect1->height;
HXDLIN( 527)		if (rect1->_weak) {
HXLINE( 527)			if (!(rect1->_inPool)) {
HXLINE( 527)				rect1->_inPool = true;
HXDLIN( 527)				::flixel::math::FlxRect_obj::_pool->putUnsafe(rect1);
            			}
            		}
...
HXDLIN( 156)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 156)		rect->_inPool = false;
HXDLIN( 156)		rect->_weak = false;
HXDLIN( 156)		 ::flixel::math::FlxRect _this = rect;
HXDLIN( 156)		_this->x = ( (Float)(0) );
HXDLIN( 156)		_this->y = ( (Float)(0) );
HXDLIN( 156)		_this->width = width;
HXDLIN( 156)		_this->height = height;
HXDLIN( 156)		 ::flixel::math::FlxRect helperRect = _this;
HXLINE( 158)		{
HXLINE( 158)			int _g = 0;
...
HXDLIN( 270)			 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 270)			rect->_inPool = false;
HXDLIN( 270)			rect->_weak = false;
HXDLIN( 270)			 ::flixel::math::FlxRect _this = rect;
...
HXDLIN( 305)						 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 305)						rect1->_inPool = false;
HXDLIN( 305)						rect1->_weak = false;
HXDLIN( 305)						 ::flixel::math::FlxRect _this1 = rect1;
HXDLIN( 305)						_this1->x = x;
HXDLIN( 305)						_this1->y = y;
HXDLIN( 305)						_this1->width = width1;
HXDLIN( 305)						_this1->height = height1;
HXDLIN( 305)						tileRect = _this1;
...
HXLINE( 430)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 430)		rect->_inPool = false;
HXDLIN( 430)		rect->_weak = false;
HXDLIN( 430)		 ::flixel::math::FlxRect _this = rect;
...
HXDLIN( 443)						 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 443)						rect1->_inPool = false;
HXDLIN( 443)						rect1->_weak = false;
HXDLIN( 443)						 ::flixel::math::FlxRect _this1 = rect1;
...
HXDLIN( 473)				_this->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),494,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
            			}
