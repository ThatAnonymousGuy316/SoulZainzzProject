...
HXLINE(  70)		 ::flixel::math::FlxRect rect1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  70)		rect1->_inPool = false;
HXDLIN(  70)		rect1->_weak = false;
HXDLIN(  70)		 ::flixel::math::FlxRect _this = rect1;
HXDLIN(  70)		_this->x = ((Float)0.0);
HXDLIN(  70)		_this->y = ((Float)0.0);
HXDLIN(  70)		_this->width = ((Float)0.0);
HXDLIN(  70)		_this->height = ((Float)0.0);
HXDLIN(  70)		 ::flixel::math::FlxRect rect2 = _this;
HXDLIN(  70)		rect2->x = rect->x;
HXDLIN(  70)		rect2->y = rect->y;
HXDLIN(  70)		rect2->width = rect->width;
HXDLIN(  70)		rect2->height = rect->height;
...
HXDLIN(  70)		imageFrame->addSpriteSheetFrame(rect2);
...
HXDLIN(  99)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN(  99)		rect->_inPool = false;
HXDLIN(  99)		rect->_weak = false;
HXDLIN(  99)		 ::flixel::math::FlxRect _this = rect;
HXDLIN(  99)		_this->x = ( (Float)(0) );
HXDLIN(  99)		_this->y = ( (Float)(0) );
HXDLIN(  99)		_this->width = width;
HXDLIN(  99)		_this->height = height;
HXDLIN(  99)		 ::flixel::math::FlxRect checkRegion = _this;
...
HXDLIN( 101)			if (region->_weak) {
HXLINE( 101)				if (!(region->_inPool)) {
HXLINE( 101)					region->_inPool = true;
HXDLIN( 101)					::flixel::math::FlxRect_obj::_pool->putUnsafe(region);
            				}
            			}
            		}
...
HXLINE( 202)			{
HXLINE( 202)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 202)				_this->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),494,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
            			}
...
HXLINE( 205)					 ::flixel::math::FlxBasePoint _this1 = frameBorder;
HXDLIN( 205)					 ::flixel::math::FlxBasePoint point2 = imageFrame->border;
HXDLIN( 205)					bool result3;
HXDLIN( 205)					if ((::Math_obj::abs((_this1->x - point2->x)) <= ((Float)0.0000001))) {
HXLINE( 205)						result3 = (::Math_obj::abs((_this1->y - point2->y)) <= ((Float)0.0000001));
            					}
            					else {
...
HXLINE( 209)		{
HXLINE( 209)			 ::flixel::math::FlxBasePoint _this2 = frameBorder;
HXDLIN( 209)			if (_this2->_weak) {
HXLINE( 209)				_this2->put();
            			}
            		}
...
HXLINE( 231)			{
HXLINE( 231)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 231)				_this->advanced(HX_("Invalid call to getFramesCollections on a destroyed graphic",1c,9c,0d,21),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/FlxGraphic.hx",17,35,63,b3),494,HX_("flixel.graphics.FlxGraphic",27,fc,ac,ae),HX_("getFramesCollections",d9,58,45,b4)));
            			}
