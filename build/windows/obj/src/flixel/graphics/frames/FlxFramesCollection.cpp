...
HXLINE( 152)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 152)		rect->_inPool = false;
HXDLIN( 152)		rect->_weak = false;
HXDLIN( 152)		 ::flixel::math::FlxRect _this = rect;
HXDLIN( 152)		_this->x = ((Float)0.0);
HXDLIN( 152)		_this->y = ((Float)0.0);
HXDLIN( 152)		_this->width = ((Float)0.0);
HXDLIN( 152)		_this->height = ((Float)0.0);
HXDLIN( 152)		frame->set_frame(_this);
...
HXLINE( 167)		 ::flixel::math::FlxRect rect = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 167)		rect->_inPool = false;
HXDLIN( 167)		rect->_weak = false;
HXDLIN( 167)		 ::flixel::math::FlxRect _this = rect;
HXDLIN( 167)		_this->x = ((Float)0.0);
HXDLIN( 167)		_this->y = ((Float)0.0);
HXDLIN( 167)		_this->width = ((Float)0.0);
HXDLIN( 167)		_this->height = ((Float)0.0);
HXDLIN( 167)		 ::flixel::math::FlxRect _this1 = _this;
...
HXDLIN( 218)			if (warn) {
HXLINE( 218)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 218)				 ::Dynamic _hx_tmp;
...
HXDLIN( 218)				_this->advanced(_hx_tmp,_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            			}
            		}
...
HXDLIN( 245)			_this->advanced(_hx_tmp,_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            		}
            	}
...
HXLINE( 264)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 264)			_this->advanced((HX_("No frame called ",11,02,4c,19) + name),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),264,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("setFrameOffset",1e,9f,45,e6)));
            		}
            	}
...
HXLINE( 283)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 283)			_this->advanced((HX_("No frame called ",11,02,4c,19) + name),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),283,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("addFrameOffset",ff,6a,5e,d4)));
            		}
            	}
...
HXDLIN( 299)		if (warn) {
HXDLIN( 299)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
...
HXDLIN( 299)			_this->advanced(_hx_tmp,_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            		}
            	}
...
HXDLIN( 315)		if (warn) {
HXDLIN( 315)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
...
HXDLIN( 315)			_this->advanced(_hx_tmp,_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),245,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("forEachByPrefix",93,be,d0,ba)));
            		}
            	}
...
HXLINE( 333)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 333)			_this->advanced((HX_("No frame called ",11,02,4c,19) + name),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),333,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("setFrameDuration",9f,4f,cd,ad)));
            		}
            	}
...
HXDLIN( 354)			_this->advanced(((HX_("The frame ",42,8b,9d,3a) + name) + HX_(" has incorrect data and results in an image with the size of (0, 0)",63,cf,34,3e)),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/graphics/frames/FlxFramesCollection.hx",00,d2,9d,e0),354,HX_("flixel.graphics.frames.FlxFramesCollection",ff,be,62,54),HX_("checkFrame",45,7a,73,16)));
            		}
