...
HXLINE( 639)				if (camera->containsPoint(this->_point,null(),null())) {
...
HXLINE( 654)						if (camera->containsPoint(this->_point,null(),null())) {
...
HXLINE( 658)								_hx_tmp2 = event->sprite->pixelsOverlapPoint(point1,1,camera);
            							}
            							else {
HXLINE( 658)								_hx_tmp2 = event->object->overlapsPoint(point1,true,camera);
            							}
