...
HXLINE( 275)		{
HXLINE( 275)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 275)			_this->advanced(HX_("steamwrap library not installed; steam inputs will be ignored.",eb,58,1d,c7),_this->styles->warning,true,::hx::SourceInfo(HX_("flixel/input/actions/FlxActionInputDigital.hx",d2,ec,a4,47),275,HX_("flixel.input.actions.FlxActionInputDigitalSteam",01,05,c0,45),HX_("new",60,d0,53,00)));
            		}
            	}
