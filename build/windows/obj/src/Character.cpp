...
HXLINE( 109)					::String file1 = ((HX_("characters/",45,3c,bf,be) + ::Character_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN( 109)					if (::hx::IsNull( file1 )) {
HXLINE( 109)						file1 = HX_("",00,00,00,00);
            					}
HXDLIN( 109)					path = (HX_("assets/",4c,2a,dc,36) + file1);
            				}
...
HXDLIN( 120)					::String library1 = null();
...
HXLINE( 120)							_hx_tmp = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            						}
            					}
...
HXLINE( 120)						_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".txt",02,3f,c0,1e)),HX_("TEXT",ad,94,ba,37),library1);
            					}
HXDLIN( 120)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSpriteSheetPacker(_hx_tmp,_hx_tmp1));
            				}
            				else {
HXLINE( 122)					::String key1 = ( (::String)(json->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic)) );
HXDLIN( 122)					::String library2 = null();
HXDLIN( 122)					 ::flixel::graphics::FlxGraphic imageLoaded1 = ::Paths_obj::addCustomGraphic(key1);
HXDLIN( 122)					bool xmlExists = false;
HXDLIN( 122)					if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 122)						xmlExists = true;
            					}
HXDLIN( 122)					 ::Dynamic _hx_tmp2;
HXDLIN( 122)					if (::hx::IsNotNull( imageLoaded1 )) {
HXLINE( 122)						_hx_tmp2 = imageLoaded1;
            					}
            					else {
HXLINE( 122)						 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(key1);
HXDLIN( 122)						if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE( 122)							_hx_tmp2 = imageToReturn1;
            						}
            						else {
HXLINE( 122)							_hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
            						}
            					}
HXDLIN( 122)					 ::Dynamic _hx_tmp3;
HXDLIN( 122)					if (xmlExists) {
HXLINE( 122)						_hx_tmp3 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e))));
            					}
            					else {
HXLINE( 122)						_hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2);
            					}
HXDLIN( 122)					this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp2,_hx_tmp3));
            				}
...
HXLINE( 128)					Float _hx_tmp4 = this->get_width();
HXDLIN( 128)					this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp4 * this->jsonScale)),null());
...
HXLINE( 143)					_hx_tmp5 = (( (::Array< int >)(json->__Field(HX_("healthbar_colors",78,d9,40,40),::hx::paccDynamic)) )->length > 2);
            				}
            				else {
...
HXLINE( 150)					_hx_tmp6 = (this->animationsArray->length > 0);
            				}
            				else {
...
HXDLIN( 151)					::Array< ::Dynamic> _g2 = this->animationsArray;
HXDLIN( 151)					while((_g1 < _g2->length)){
HXLINE( 151)						 ::Dynamic anim = _g2->__get(_g1);
HXDLIN( 151)						_g1 = (_g1 + 1);
...
HXLINE( 157)							_hx_tmp7 = (animIndices->length > 0);
            						}
            						else {
...
HXLINE( 163)							_hx_tmp8 = (( (::Array< int >)(anim->__Field(HX_("offsets",80,09,65,d7),::hx::paccDynamic)) )->length > 1);
            						}
            						else {
...
HXLINE( 209)				 ::Character _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 209)				_hx_tmp1->heyTimer = (_hx_tmp1->heyTimer - elapsed);
HXLINE( 210)				if ((this->heyTimer <= 0)) {
HXLINE( 212)					bool _hx_tmp2;
HXDLIN( 212)					bool _hx_tmp3;
HXDLIN( 212)					if (this->specialAnim) {
HXLINE( 212)						_hx_tmp3 = (this->animation->_curAnim->name == HX_("hey",dc,42,4f,00));
            					}
            					else {
HXLINE( 212)						_hx_tmp3 = false;
            					}
HXDLIN( 212)					if (!(_hx_tmp3)) {
HXLINE( 212)						_hx_tmp2 = (this->animation->_curAnim->name == HX_("cheer",8d,9a,b6,45));
            					}
            					else {
HXLINE( 212)						_hx_tmp2 = true;
            					}
...
HXLINE( 219)					_hx_tmp4 = this->animation->_curAnim->finished;
            				}
            				else {
...
HXLINE( 229)					 ::Character _hx_tmp5 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 229)					_hx_tmp5->holdTimer = (_hx_tmp5->holdTimer + elapsed);
            				}
...
HXLINE( 239)			bool _hx_tmp6;
HXDLIN( 239)			if (this->animation->_curAnim->finished) {
HXLINE( 239)				_hx_tmp6 = ::hx::IsNotNull( this->animation->_animations->get((this->animation->_curAnim->name + HX_("-loop",11,c1,bf,30))) );
            			}
            			else {
HXLINE( 239)				_hx_tmp6 = false;
            			}
...
HXLINE( 279)			this->offset->set(( (Float)(daOffset->__get(0)) ),( (Float)(daOffset->__get(1)) ));
            		}
            		else {
