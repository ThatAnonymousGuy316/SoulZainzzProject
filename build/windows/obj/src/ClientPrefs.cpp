...
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_67_saveSettings,"ClientPrefs","saveSettings",0xab8c0989,"ClientPrefs.saveSettings","ClientPrefs.hx",67,0x329d1619)
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_106_loadPrefs,"ClientPrefs","loadPrefs",0x58c63c41,"ClientPrefs.loadPrefs","ClientPrefs.hx",106,0x329d1619)
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_184_reloadControls,"ClientPrefs","reloadControls",0xe353bb78,"ClientPrefs.reloadControls","ClientPrefs.hx",184,0x329d1619)
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_191_removeControls,"ClientPrefs","removeControls",0xbe206763,"ClientPrefs.removeControls","ClientPrefs.hx",191,0x329d1619)
HX_LOCAL_STACK_FRAME(_hx_pos_1453641688f31b8d_205_loadControls,"ClientPrefs","loadControls",0xfeebb305,"ClientPrefs.loadControls","ClientPrefs.hx",205,0x329d1619)
...
Float ClientPrefs_obj::scrollSpeedSetting;

bool ClientPrefs_obj::RoundLeDecimal;
...
void ClientPrefs_obj::saveSettings(){
            	HX_GC_STACKFRAME(&_hx_pos_1453641688f31b8d_67_saveSettings)
HXLINE(  68)		::flixel::FlxG_obj::save->data->__SetField(HX_("scrollSpeedSetting",76,04,bc,d7),::ClientPrefs_obj::scrollSpeedSetting,::hx::paccDynamic);
HXLINE(  69)		::flixel::FlxG_obj::save->data->__SetField(HX_("RoundLeDecimal",0a,31,d8,07),::ClientPrefs_obj::RoundLeDecimal,::hx::paccDynamic);
HXLINE(  71)		::flixel::FlxG_obj::save->data->__SetField(HX_("downScroll",0f,ba,68,84),::ClientPrefs_obj::downScroll,::hx::paccDynamic);
HXLINE(  72)		::flixel::FlxG_obj::save->data->__SetField(HX_("middleScroll",42,cd,58,62),::ClientPrefs_obj::middleScroll,::hx::paccDynamic);
HXLINE(  73)		::flixel::FlxG_obj::save->data->__SetField(HX_("showFPS",ec,0a,9a,7b),::ClientPrefs_obj::showFPS,::hx::paccDynamic);
HXLINE(  74)		::flixel::FlxG_obj::save->data->__SetField(HX_("flashing",32,85,e8,99),::ClientPrefs_obj::flashing,::hx::paccDynamic);
HXLINE(  75)		::flixel::FlxG_obj::save->data->__SetField(HX_("globalAntialiasing",f7,9c,ed,4c),::ClientPrefs_obj::globalAntialiasing,::hx::paccDynamic);
HXLINE(  76)		::flixel::FlxG_obj::save->data->__SetField(HX_("noteSplashes",a7,57,29,8d),::ClientPrefs_obj::noteSplashes,::hx::paccDynamic);
HXLINE(  77)		::flixel::FlxG_obj::save->data->__SetField(HX_("lowQuality",8b,52,27,3e),::ClientPrefs_obj::lowQuality,::hx::paccDynamic);
HXLINE(  78)		::flixel::FlxG_obj::save->data->__SetField(HX_("framerate",8d,e5,4b,4e),::ClientPrefs_obj::framerate,::hx::paccDynamic);
HXLINE(  79)		::flixel::FlxG_obj::save->data->__SetField(HX_("cursing",cf,db,8f,cc),::ClientPrefs_obj::cursing,::hx::paccDynamic);
HXLINE(  80)		::flixel::FlxG_obj::save->data->__SetField(HX_("violence",5b,5e,88,3f),::ClientPrefs_obj::violence,::hx::paccDynamic);
HXLINE(  81)		::flixel::FlxG_obj::save->data->__SetField(HX_("camZooms",71,f3,cd,90),::ClientPrefs_obj::camZooms,::hx::paccDynamic);
HXLINE(  82)		::flixel::FlxG_obj::save->data->__SetField(HX_("noteOffset",25,a5,53,fe),::ClientPrefs_obj::noteOffset,::hx::paccDynamic);
HXLINE(  83)		::flixel::FlxG_obj::save->data->__SetField(HX_("hideHud",15,b9,3c,b7),::ClientPrefs_obj::hideHud,::hx::paccDynamic);
HXLINE(  84)		::flixel::FlxG_obj::save->data->__SetField(HX_("arrowHSV",c2,f4,b4,fd),::ClientPrefs_obj::arrowHSV,::hx::paccDynamic);
HXLINE(  85)		::flixel::FlxG_obj::save->data->__SetField(HX_("imagesPersist",3c,00,5c,08),::ClientPrefs_obj::imagesPersist,::hx::paccDynamic);
HXLINE(  86)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghostTapping",c6,6a,da,10),::ClientPrefs_obj::ghostTapping,::hx::paccDynamic);
HXLINE(  87)		::flixel::FlxG_obj::save->data->__SetField(HX_("hideTime",ef,b5,ca,a5),::ClientPrefs_obj::hideTime,::hx::paccDynamic);
HXLINE(  89)		::Array< ::String > achieves = ::Array_obj< ::String >::__new(0);
HXLINE(  90)		{
HXLINE(  90)			int _g = 0;
HXDLIN(  90)			int _g1 = ::Achievements_obj::achievementsUnlocked->get_length();
HXDLIN(  90)			while((_g < _g1)){
HXLINE(  90)				_g = (_g + 1);
HXDLIN(  90)				int i = (_g - 1);
HXLINE(  91)				if (( (bool)(::Achievements_obj::achievementsUnlocked->__get(i)->__GetItem(1)) )) {
HXLINE(  92)					achieves->push(::Achievements_obj::achievementsUnlocked->__get(i)->__GetItem(0));
            				}
            			}
            		}
HXLINE(  95)		::flixel::FlxG_obj::save->data->__SetField(HX_("achievementsUnlocked",67,55,27,1c),achieves,::hx::paccDynamic);
HXLINE(  96)		::flixel::FlxG_obj::save->data->__SetField(HX_("henchmenDeath",f4,76,2a,dd),::Achievements_obj::henchmenDeath,::hx::paccDynamic);
HXLINE(  97)		::flixel::FlxG_obj::save->flush(null());
HXLINE(  99)		 ::flixel::util::FlxSave save =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
HXLINE( 100)		save->bind(HX_("controls",76,86,bc,37),HX_("ninjamuffin99",f7,4c,e5,00),null());
HXLINE( 101)		save->data->__SetField(HX_("customControls",47,63,49,5a),::ClientPrefs_obj::lastControls,::hx::paccDynamic);
HXLINE( 102)		save->flush(null());
HXLINE( 103)		{
HXLINE( 103)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 103)			_this->advanced(HX_("Settings saved!",37,01,d5,e3),_this->styles->normal,false,::hx::SourceInfo(HX_("source/ClientPrefs.hx",0d,e8,36,fc),103,HX_("ClientPrefs",c5,55,e0,8a),HX_("saveSettings",40,c9,c5,9d)));
            		}
            	}
...
void ClientPrefs_obj::loadPrefs(){
            	HX_GC_STACKFRAME(&_hx_pos_1453641688f31b8d_106_loadPrefs)
HXLINE( 107)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeedSetting",76,04,bc,d7),::hx::paccDynamic) )) {
HXLINE( 108)			::ClientPrefs_obj::scrollSpeedSetting = ( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("scrollSpeedSetting",76,04,bc,d7),::hx::paccDynamic)) );
            		}
HXLINE( 110)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("RoundLeDecimal",0a,31,d8,07),::hx::paccDynamic) )) {
HXLINE( 111)			::ClientPrefs_obj::RoundLeDecimal = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("RoundLeDecimal",0a,31,d8,07),::hx::paccDynamic)) );
            		}
HXLINE( 114)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("downScroll",0f,ba,68,84),::hx::paccDynamic) )) {
HXLINE( 115)			::ClientPrefs_obj::downScroll = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("downScroll",0f,ba,68,84),::hx::paccDynamic)) );
            		}
HXLINE( 117)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("middleScroll",42,cd,58,62),::hx::paccDynamic) )) {
HXLINE( 118)			::ClientPrefs_obj::middleScroll = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("middleScroll",42,cd,58,62),::hx::paccDynamic)) );
            		}
HXLINE( 120)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("showFPS",ec,0a,9a,7b),::hx::paccDynamic) )) {
HXLINE( 121)			::ClientPrefs_obj::showFPS = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("showFPS",ec,0a,9a,7b),::hx::paccDynamic)) );
HXLINE( 122)			if (::hx::IsNotNull( ::Main_obj::fpsVar )) {
HXLINE( 123)				::Main_obj::fpsVar->set_visible(::ClientPrefs_obj::showFPS);
            			}
            		}
HXLINE( 126)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic) )) {
HXLINE( 127)			::ClientPrefs_obj::flashing = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) );
            		}
HXLINE( 129)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("globalAntialiasing",f7,9c,ed,4c),::hx::paccDynamic) )) {
HXLINE( 130)			::ClientPrefs_obj::globalAntialiasing = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("globalAntialiasing",f7,9c,ed,4c),::hx::paccDynamic)) );
            		}
HXLINE( 132)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("noteSplashes",a7,57,29,8d),::hx::paccDynamic) )) {
HXLINE( 133)			::ClientPrefs_obj::noteSplashes = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("noteSplashes",a7,57,29,8d),::hx::paccDynamic)) );
            		}
HXLINE( 135)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("lowQuality",8b,52,27,3e),::hx::paccDynamic) )) {
HXLINE( 136)			::ClientPrefs_obj::lowQuality = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("lowQuality",8b,52,27,3e),::hx::paccDynamic)) );
            		}
HXLINE( 138)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic) )) {
HXLINE( 139)			::ClientPrefs_obj::framerate = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("framerate",8d,e5,4b,4e),::hx::paccDynamic)) );
HXLINE( 140)			if ((::ClientPrefs_obj::framerate > ::flixel::FlxG_obj::drawFramerate)) {
HXLINE( 141)				::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
HXLINE( 142)				::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
            			}
            			else {
HXLINE( 144)				::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
HXLINE( 145)				::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
            			}
            		}
HXLINE( 154)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("camZooms",71,f3,cd,90),::hx::paccDynamic) )) {
HXLINE( 155)			::ClientPrefs_obj::camZooms = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camZooms",71,f3,cd,90),::hx::paccDynamic)) );
            		}
HXLINE( 157)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("hideHud",15,b9,3c,b7),::hx::paccDynamic) )) {
HXLINE( 158)			::ClientPrefs_obj::hideHud = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("hideHud",15,b9,3c,b7),::hx::paccDynamic)) );
            		}
HXLINE( 160)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("noteOffset",25,a5,53,fe),::hx::paccDynamic) )) {
HXLINE( 161)			::ClientPrefs_obj::noteOffset = ( (int)(::flixel::FlxG_obj::save->data->__Field(HX_("noteOffset",25,a5,53,fe),::hx::paccDynamic)) );
            		}
HXLINE( 163)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("arrowHSV",c2,f4,b4,fd),::hx::paccDynamic) )) {
HXLINE( 164)			::ClientPrefs_obj::arrowHSV = ( (::Array< ::Dynamic>)(::flixel::FlxG_obj::save->data->__Field(HX_("arrowHSV",c2,f4,b4,fd),::hx::paccDynamic)) );
            		}
HXLINE( 166)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("imagesPersist",3c,00,5c,08),::hx::paccDynamic) )) {
HXLINE( 167)			::ClientPrefs_obj::imagesPersist = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("imagesPersist",3c,00,5c,08),::hx::paccDynamic)) );
HXLINE( 168)			::flixel::graphics::FlxGraphic_obj::defaultPersist = ::ClientPrefs_obj::imagesPersist;
            		}
HXLINE( 170)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("ghostTapping",c6,6a,da,10),::hx::paccDynamic) )) {
HXLINE( 171)			::ClientPrefs_obj::ghostTapping = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghostTapping",c6,6a,da,10),::hx::paccDynamic)) );
            		}
HXLINE( 173)		if (::hx::IsNotNull( ::flixel::FlxG_obj::save->data->__Field(HX_("hideTime",ef,b5,ca,a5),::hx::paccDynamic) )) {
HXLINE( 174)			::ClientPrefs_obj::hideTime = ( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("hideTime",ef,b5,ca,a5),::hx::paccDynamic)) );
            		}
HXLINE( 177)		 ::flixel::util::FlxSave save =  ::flixel::util::FlxSave_obj::__alloc( HX_CTX );
HXLINE( 178)		save->bind(HX_("controls",76,86,bc,37),HX_("ninjamuffin99",f7,4c,e5,00),null());
...
HXLINE( 180)			::ClientPrefs_obj::reloadControls(( (::Array< int >)(save->data->__Field(HX_("customControls",47,63,49,5a),::hx::paccDynamic)) ));
            		}
            	}
...
void ClientPrefs_obj::reloadControls(::Array< int > newKeys){
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_184_reloadControls)
HXLINE( 185)		::ClientPrefs_obj::removeControls(::ClientPrefs_obj::lastControls);
HXLINE( 186)		::ClientPrefs_obj::lastControls = newKeys->copy();
HXLINE( 187)		::ClientPrefs_obj::loadControls(::ClientPrefs_obj::lastControls);
            	}
...
void ClientPrefs_obj::removeControls(::Array< int > controlArray){
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_191_removeControls)
HXDLIN( 191)		int _g = 0;
HXDLIN( 191)		int _g1 = ::ClientPrefs_obj::keyBinds->get_length();
HXDLIN( 191)		while((_g < _g1)){
HXDLIN( 191)			_g = (_g + 1);
HXDLIN( 191)			int i = (_g - 1);
HXLINE( 192)			int controlValue = (i * 2);
HXLINE( 193)			::Array< int > controlsToRemove = ::Array_obj< int >::__new(0);
HXLINE( 194)			{
HXLINE( 195)				if ((controlArray->__get(controlValue) != -1)) {
HXLINE( 196)					controlsToRemove->push(controlArray->__get(controlValue));
            				}
HXLINE( 195)				if ((controlArray->__get((controlValue + 1)) != -1)) {
HXLINE( 196)					controlsToRemove->push(controlArray->__get((controlValue + 1)));
            				}
            			}
HXLINE( 199)			if ((controlsToRemove->length > 0)) {
HXLINE( 200)				::PlayerSettings_obj::player1->controls->unbindKeys(Dynamic( ::ClientPrefs_obj::keyBinds->__get(i)->__GetItem(0)).StaticCast<  ::Control >(),controlsToRemove);
            			}
            		}
            	}
...
void ClientPrefs_obj::loadControls(::Array< int > controlArray){
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_205_loadControls)
HXDLIN( 205)		int _g = 0;
HXDLIN( 205)		int _g1 = ::ClientPrefs_obj::keyBinds->get_length();
HXDLIN( 205)		while((_g < _g1)){
HXDLIN( 205)			_g = (_g + 1);
HXDLIN( 205)			int i = (_g - 1);
HXLINE( 206)			int controlValue = (i * 2);
HXLINE( 207)			::Array< int > controlsToAdd = ::Array_obj< int >::__new(0);
HXLINE( 208)			{
HXLINE( 209)				if ((controlArray->__get(controlValue) != -1)) {
HXLINE( 210)					controlsToAdd->push(controlArray->__get(controlValue));
            				}
HXLINE( 209)				if ((controlArray->__get((controlValue + 1)) != -1)) {
HXLINE( 210)					controlsToAdd->push(controlArray->__get((controlValue + 1)));
            				}
            			}
HXLINE( 213)			if ((controlsToAdd->length > 0)) {
HXLINE( 214)				::PlayerSettings_obj::player1->controls->bindKeys(Dynamic( ::ClientPrefs_obj::keyBinds->__get(i)->__GetItem(0)).StaticCast<  ::Control >(),controlsToAdd);
            			}
            		}
            	}
...
bool ClientPrefs_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"RoundLeDecimal") ) { outValue = ( RoundLeDecimal ); return true; }
		...
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"scrollSpeedSetting") ) { outValue = ( scrollSpeedSetting ); return true; }
...
bool ClientPrefs_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"RoundLeDecimal") ) { RoundLeDecimal=ioValue.Cast< bool >(); return true; }
		break;
	case 18:
		if (HX_FIELD_EQ(inName,"scrollSpeedSetting") ) { scrollSpeedSetting=ioValue.Cast< Float >(); return true; }
...
static ::hx::StaticInfo ClientPrefs_obj_sStaticStorageInfo[] = {
	{::hx::fsFloat,(void *) &ClientPrefs_obj::scrollSpeedSetting,HX_("scrollSpeedSetting",76,04,bc,d7)},
	{::hx::fsBool,(void *) &ClientPrefs_obj::RoundLeDecimal,HX_("RoundLeDecimal",0a,31,d8,07)},
...
static void ClientPrefs_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ClientPrefs_obj::scrollSpeedSetting,"scrollSpeedSetting");
	HX_MARK_MEMBER_NAME(ClientPrefs_obj::RoundLeDecimal,"RoundLeDecimal");
...
static void ClientPrefs_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(ClientPrefs_obj::scrollSpeedSetting,"scrollSpeedSetting");
	HX_VISIT_MEMBER_NAME(ClientPrefs_obj::RoundLeDecimal,"RoundLeDecimal");
...
static ::String ClientPrefs_obj_sStaticFields[] = {
	HX_("scrollSpeedSetting",76,04,bc,d7),
	HX_("RoundLeDecimal",0a,31,d8,07),
...
HXDLIN(  10)		scrollSpeedSetting = ((Float)0);
            	}
{
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_11_boot)
HXDLIN(  11)		RoundLeDecimal = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_1453641688f31b8d_13_boot)
HXDLIN(  13)		downScroll = false;
            	}
{
