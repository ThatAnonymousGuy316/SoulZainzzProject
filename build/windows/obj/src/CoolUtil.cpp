...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_38_dominantColor,"CoolUtil","dominantColor",0xd61f0ec0,"CoolUtil.dominantColor","CoolUtil.hx",38,0x9f143813)
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_65_coolTextFile,"CoolUtil","coolTextFile",0xa6086875,"CoolUtil.coolTextFile","CoolUtil.hx",65,0x9f143813)
...
HX_LOCAL_STACK_FRAME(_hx_pos_d6b1695b4ccb37a6_102_browserLoad,"CoolUtil","browserLoad",0xdac4a08b,"CoolUtil.browserLoad","CoolUtil.hx",102,0x9f143813)
...
int CoolUtil_obj::dominantColor( ::flixel::FlxSprite sprite){
            	HX_GC_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_38_dominantColor)
HXLINE(  39)		 ::haxe::ds::IntMap countByColor =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  40)		{
HXLINE(  40)			int _g = 0;
HXDLIN(  40)			int _g1 = sprite->frameWidth;
HXDLIN(  40)			while((_g < _g1)){
HXLINE(  40)				_g = (_g + 1);
HXDLIN(  40)				int col = (_g - 1);
HXLINE(  41)				{
HXLINE(  41)					int _g2 = 0;
HXDLIN(  41)					int _g3 = sprite->frameHeight;
HXDLIN(  41)					while((_g2 < _g3)){
HXLINE(  41)						_g2 = (_g2 + 1);
HXDLIN(  41)						int row = (_g2 - 1);
HXLINE(  42)						int colorOfThisPixel = sprite->get_pixels()->getPixel32(col,row);
HXLINE(  43)						if ((colorOfThisPixel != 0)) {
HXLINE(  44)							if (countByColor->exists(colorOfThisPixel)) {
HXLINE(  45)								int v = (countByColor->get(colorOfThisPixel) + 1);
HXDLIN(  45)								countByColor->set(colorOfThisPixel,v);
            							}
            							else {
HXLINE(  46)								if (::hx::IsNotEq( countByColor->get(colorOfThisPixel),-13520687 )) {
HXLINE(  47)									countByColor->set(colorOfThisPixel,1);
            								}
            							}
            						}
            					}
...
HXLINE(  52)		int maxCount = 0;
HXLINE(  53)		int maxKey = 0;
HXLINE(  54)		countByColor->set(-16777216,0);
HXLINE(  55)		{
HXLINE(  55)			 ::Dynamic key = countByColor->keys();
HXDLIN(  55)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(  55)				int key1 = ( (int)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(  56)				if (::hx::IsGreaterEq( countByColor->get(key1),maxCount )) {
HXLINE(  57)					maxCount = ( (int)(countByColor->get(key1)) );
HXLINE(  58)					maxKey = key1;
            				}
            			}
            		}
HXLINE(  61)		return maxKey;
            	}
...
::Array< ::String > CoolUtil_obj::coolTextFile(::String path){
            	HX_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_65_coolTextFile)
HXLINE(  66)		::Array< ::String > daList = ::Array_obj< ::String >::__new(0);
HXLINE(  68)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE(  68)			daList = ::StringTools_obj::trim(::sys::io::File_obj::getContent(path)).split(HX_("\n",0a,00,00,00));
            		}
HXLINE(  73)		{
HXLINE(  73)			int _g = 0;
...
HXDLIN(  94)			::String assetId = ( (::String)(::Paths_obj::sound(sound,library)) );
HXDLIN(  94)			::flixel::FlxG_obj::assets->getAsset(assetId,HX_("sound",cf,8c,cc,80),true,::flixel::FlxG_obj::log->styles->error);
            		}
            	}
...
void CoolUtil_obj::browserLoad(::String site){
            	HX_GC_STACKFRAME(&_hx_pos_d6b1695b4ccb37a6_102_browserLoad)
HXDLIN( 102)		::String url = site;
HXDLIN( 102)		if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^.\\w+?:/*",16,3c,ef,2d),HX_("",00,00,00,00))->match(url))) {
HXDLIN( 102)			url = (HX_("https://",cf,b4,ae,3e) + url);
            		}
HXDLIN( 102)		::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,url),HX_("_blank",95,26,d9,b0));
            	}
