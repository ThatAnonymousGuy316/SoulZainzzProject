...
HXLINE(  22)			 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
...
HXLINE(  28)			 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(HX_("pauseAlt/bfLol",a9,d6,8a,6b));
HXDLIN(  28)			if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE(  28)				_hx_tmp = imageToReturn1;
            			}
            			else {
...
HXDLIN(  32)				bf->set_x(((( (Float)(_hx_tmp3) ) - bf->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  32)				bf->set_y(((( (Float)(_hx_tmp5) ) - bf->get_height()) / ( (Float)(2) )));
            			}
            		}
...
HXLINE(  35)		 ::flixel::FlxSprite _hx_tmp6 = this->replayButton;
...
HXDLIN(  35)		 ::Dynamic _hx_tmp7;
HXDLIN(  35)		if (::hx::IsNotNull( imageLoaded1 )) {
HXLINE(  35)			_hx_tmp7 = imageLoaded1;
            		}
            		else {
HXLINE(  35)			 ::flixel::graphics::FlxGraphic imageToReturn2 = ::Paths_obj::addCustomGraphic(HX_("pauseAlt/pauseUI",4e,e1,5d,69));
HXDLIN(  35)			if (::hx::IsNotNull( imageToReturn2 )) {
HXLINE(  35)				_hx_tmp7 = imageToReturn2;
            			}
            			else {
HXLINE(  35)				_hx_tmp7 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
            			}
            		}
HXDLIN(  35)		 ::Dynamic _hx_tmp8;
HXDLIN(  35)		if (xmlExists1) {
HXLINE(  35)			_hx_tmp8 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  35)			_hx_tmp8 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2);
            		}
HXDLIN(  35)		_hx_tmp6->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp7,_hx_tmp8));
...
HXLINE(  42)		 ::flixel::FlxSprite _hx_tmp9 = this->cancelButton;
...
HXDLIN(  42)		 ::Dynamic _hx_tmp10;
HXDLIN(  42)		if (::hx::IsNotNull( imageLoaded2 )) {
HXLINE(  42)			_hx_tmp10 = imageLoaded2;
            		}
            		else {
HXLINE(  42)			 ::flixel::graphics::FlxGraphic imageToReturn3 = ::Paths_obj::addCustomGraphic(HX_("pauseAlt/pauseUI",4e,e1,5d,69));
HXDLIN(  42)			if (::hx::IsNotNull( imageToReturn3 )) {
HXLINE(  42)				_hx_tmp10 = imageToReturn3;
            			}
            			else {
HXLINE(  42)				_hx_tmp10 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library3);
            			}
            		}
HXDLIN(  42)		 ::Dynamic _hx_tmp11;
HXDLIN(  42)		if (xmlExists2) {
HXLINE(  42)			_hx_tmp11 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  42)			_hx_tmp11 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + HX_("pauseAlt/pauseUI",4e,e1,5d,69)) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library3);
            		}
HXDLIN(  42)		_hx_tmp9->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp10,_hx_tmp11));
...
HXLINE(  72)				{
HXLINE(  72)					 ::flixel::_hx_system::frontEnds::SoundFrontEnd _this = ::flixel::FlxG_obj::sound;
...
HXDLIN(  72)						asset = ::Paths_obj::customSoundsLoaded->get(file);
            					}
            					else {
HXLINE(  72)						asset = ::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + HX_("freakyMenu",15,c9,93,86)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library);
            					}
HXDLIN(  72)					 ::flixel::sound::FlxSoundGroup group = null();
HXDLIN(  72)					 ::Dynamic onComplete = null();
HXDLIN(  72)					 ::flixel::sound::FlxSound _this1 = _this->recycleMusic(group)->loadHelper(asset,null(),null(),null());
HXDLIN(  72)					_this1->set_volume(((Float)1.0));
HXDLIN(  72)					_this1->loopUntil = -1;
HXDLIN(  72)					_this1->init(true,false,onComplete)->play(null(),null(),null());
            				}
            			}
            		}
