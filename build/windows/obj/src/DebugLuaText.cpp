...
HX_DEFINE_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1341_new,"DebugLuaText","new",0xad824284,"DebugLuaText.new","FunkinLua.hx",1341,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_6f866b21df2f4ee6_1353_update,"DebugLuaText","update",0x3cb60265,"DebugLuaText.update","FunkinLua.hx",1353,0x00117937)

void DebugLuaText_obj::__construct(::String text, ::flixel::group::FlxTypedGroup parentGroup){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1341_new)
HXLINE(1343)		this->disableTime = ((Float)6);
HXLINE(1346)		this->parentGroup = parentGroup;
HXLINE(1347)		super::__construct(10,10,0,text,16,null());
HXLINE(1348)		this->setFormat((HX_("assets/fonts/",37,ff,a5,9c) + HX_("vcr.ttf",9d,d2,a7,82)),20,-1,HX_("left",07,08,b0,47),::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn(),-16777216,null());
HXLINE(1349)		this->scrollFactor->set(0,0);
HXLINE(1350)		this->set_borderSize(( (Float)(1) ));
            	}
...
void DebugLuaText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_6f866b21df2f4ee6_1353_update)
HXLINE(1354)		this->super::update(elapsed);
HXLINE(1355)		 ::DebugLuaText _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(1355)		_hx_tmp->disableTime = (_hx_tmp->disableTime - elapsed);
HXLINE(1356)		if ((this->disableTime <= 0)) {
HXLINE(1357)			this->kill();
HXLINE(1358)			this->parentGroup->remove(::hx::ObjectPtr<OBJ_>(this),null()).StaticCast<  ::DebugLuaText >();
HXLINE(1359)			this->destroy();
            		}
            		else {
HXLINE(1361)			if ((this->disableTime < 1)) {
HXLINE(1361)				this->set_alpha(this->disableTime);
            			}
            		}
            	}
