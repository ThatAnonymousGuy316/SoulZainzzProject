...
HX_LOCAL_STACK_FRAME(_hx_pos_362e1cea85625f87_318_get,"crowplexus.iris.Iris","get",0x15b2170c,"crowplexus.iris.Iris.get","crowplexus/iris/Iris.hx",318,0x27ccb4fa)
...
HX_LOCAL_STACK_FRAME(_hx_pos_362e1cea85625f87_390_exists,"crowplexus.iris.Iris","exists",0x5e5d7526,"crowplexus.iris.Iris.exists","crowplexus/iris/Iris.hx",390,0x27ccb4fa)
...
HX_DEFINE_DYNAMIC_FUNC0(Iris_obj,preset,(void))
 ...
 ::Dynamic Iris_obj::get(::String field){
            	HX_STACKFRAME(&_hx_pos_362e1cea85625f87_318_get)
HXDLIN( 318)		if (::hx::IsNotNull( this->interp )) {
HXDLIN( 318)			return this->interp->variables->get(field);
            		}
            		else {
...
bool Iris_obj::exists(::String field){
            	HX_STACKFRAME(&_hx_pos_362e1cea85625f87_390_exists)
HXDLIN( 390)		if (::hx::IsNotNull( this->interp )) {
HXDLIN( 390)			return this->interp->variables->exists(field);
            		}
            		else {
