...
::hscript::ExprDef ExprDef_obj::ECast( ::Dynamic e, ::hscript::CType t)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("ECast",a4,51,39,e7),28,2)->_hx_init(0,e)->_hx_init(1,t);
}
...
::hscript::ExprDef ExprDef_obj::EForGen( ::Dynamic it, ::Dynamic e)
{
	return ::hx::CreateEnum< ExprDef_obj >(HX_("EForGen",2c,33,4f,67),27,2)->_hx_init(0,it)->_hx_init(1,e);
}
...
bool ExprDef_obj::__GetStatic(const ::String &inName, ::Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("EForGen",2c,33,4f,67)) { outValue = ExprDef_obj::EForGen_dyn(); return true; }
...
int ExprDef_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("ECast",a4,51,39,e7)) return 28;
	...
	if (inName==HX_("EForGen",2c,33,4f,67)) return 27;
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(ExprDef_obj,EForGen,return)
...
int ExprDef_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("EForGen",2c,33,4f,67)) return 2;
...
::hx::Val ExprDef_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	if (inName==HX_("EForGen",2c,33,4f,67)) return EForGen_dyn();
