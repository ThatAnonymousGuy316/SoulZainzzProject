...
HXDLIN(  30)			 ::Dynamic _hx_tmp1;
HXDLIN(  30)			if (::hx::IsNotNull( imageToReturn )) {
HXLINE(  30)				_hx_tmp1 = imageToReturn;
            			}
            			else {
HXLINE(  30)				_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library);
            			}
HXDLIN(  30)			this->loadGraphic(_hx_tmp1,null(),null(),null(),null(),null());
...
HXDLIN(  33)			 ::Dynamic _hx_tmp2;
HXDLIN(  33)			if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE(  33)				_hx_tmp2 = imageToReturn1;
            			}
            			else {
HXLINE(  33)				_hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            			}
HXDLIN(  33)			int _hx_tmp3 = ::Math_obj::floor(this->get_width());
HXDLIN(  33)			this->loadGraphic(_hx_tmp2,true,_hx_tmp3,::Math_obj::floor(this->get_height()),null(),null());
...
HXLINE(  40)			Float _hx_tmp4 = this->get_width();
HXDLIN(  40)			this->setGraphicSize(::Std_obj::_hx_int((_hx_tmp4 * ::PlayState_obj::daPixelZoom)),null());
...
HXDLIN(  64)			 ::Dynamic _hx_tmp5;
HXDLIN(  64)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE(  64)				_hx_tmp5 = imageLoaded;
            			}
            			else {
HXLINE(  64)				 ::flixel::graphics::FlxGraphic imageToReturn2 = ::Paths_obj::addCustomGraphic(skin);
HXDLIN(  64)				if (::hx::IsNotNull( imageToReturn2 )) {
HXLINE(  64)					_hx_tmp5 = imageToReturn2;
            				}
            				else {
HXLINE(  64)					_hx_tmp5 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library2);
            				}
            			}
HXDLIN(  64)			 ::Dynamic _hx_tmp6;
HXDLIN(  64)			if (xmlExists) {
HXLINE(  64)				_hx_tmp6 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE(  64)				_hx_tmp6 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library2);
            			}
HXDLIN(  64)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp5,_hx_tmp6));
...
HXLINE(  95)		this->scrollFactor->set(0,0);
            	}
...
HXLINE( 134)				_hx_tmp1 = !(::PlayState_obj::isPixelStage);
            			}
            			else {
...
HXLINE( 142)		this->offset->set_x((this->offset->x - ( (Float)(13) )));
HXLINE( 143)		this->offset->set_y((this->offset->y - ( (Float)(13) )));
            	}
