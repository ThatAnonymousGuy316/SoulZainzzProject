...
HXLINE(  53)		{
HXLINE(  53)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(  53)			_this->advanced(((HX_("Completed achievement \"",bc,88,62,0c) + ::Achievements_obj::achievementsStuff->__get(id)->__GetItem(0)) + HX_("\"",22,00,00,00)),_this->styles->normal,false,::hx::SourceInfo(HX_("source/Achievements.hx",86,db,47,8f),53,HX_("Achievements",44,ed,7d,4e),HX_("unlockAchievement",0b,e4,d1,6a)));
            		}
...
HXLINE(  61)				{
HXLINE(  61)					 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN(  61)					_this->advanced(HX_("Trying to load stuff",c6,1c,d3,26),_this->styles->normal,false,::hx::SourceInfo(HX_("source/Achievements.hx",86,db,47,8f),61,HX_("Achievements",44,ed,7d,4e),HX_("loadAchievements",6a,28,c7,f2)));
            				}
...
HXLINE(  64)						{
HXLINE(  64)							int _g2 = 0;
HXDLIN(  64)							int _g3 = savedStuff->length;
HXDLIN(  64)							while((_g2 < _g3)){
HXLINE(  64)								_g2 = (_g2 + 1);
HXDLIN(  64)								int j = (_g2 - 1);
