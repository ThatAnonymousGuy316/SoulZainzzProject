...
HXLINE(  60)				::String file1 = ((HX_("images/menucharacters/",6f,fa,bf,a6) + ::MenuCharacter_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN(  60)				if (::hx::IsNull( file1 )) {
HXLINE(  60)					file1 = HX_("",00,00,00,00);
            				}
HXDLIN(  60)				path = (HX_("assets/",4c,2a,dc,36) + file1);
            			}
...
HXLINE(  81)			this->offset->set(( (Float)( ::Dynamic(charFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(0)) ),( (Float)( ::Dynamic(charFile->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(1)) ));
...
HXLINE(  50)				::String characterPath1 = ((HX_("images/menucharacters/",6f,fa,bf,a6) + character) + HX_(".json",56,f1,d6,c2));
HXLINE(  51)				::String rawJson1 = null();
HXLINE(  54)				::String path1 = ::Paths_obj::modFolders(characterPath1);
HXLINE(  55)				if (!(::sys::FileSystem_obj::exists(path1))) {
HXLINE(  56)					::String file2 = characterPath1;
HXDLIN(  56)					if (::hx::IsNull( file2 )) {
HXLINE(  56)						file2 = HX_("",00,00,00,00);
            					}
HXDLIN(  56)					path1 = (HX_("assets/",4c,2a,dc,36) + file2);
            				}
HXLINE(  59)				if (!(::sys::FileSystem_obj::exists(path1))) {
HXLINE(  60)					::String file3 = ((HX_("images/menucharacters/",6f,fa,bf,a6) + ::MenuCharacter_obj::DEFAULT_CHARACTER) + HX_(".json",56,f1,d6,c2));
HXDLIN(  60)					if (::hx::IsNull( file3 )) {
HXLINE(  60)						file3 = HX_("",00,00,00,00);
            					}
HXDLIN(  60)					path1 = (HX_("assets/",4c,2a,dc,36) + file3);
            				}
HXLINE(  62)				rawJson1 = ::sys::io::File_obj::getContent(path1);
HXLINE(  72)				 ::Dynamic charFile1 =  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson1)->doParse();
HXLINE(  73)				::String key1 = ( (::String)((HX_("menucharacters/",06,2d,77,01) + charFile1->__Field(HX_("image",5b,1f,69,bd),::hx::paccDynamic))) );
HXDLIN(  73)				::String library1 = null();
HXDLIN(  73)				 ::flixel::graphics::FlxGraphic imageLoaded1 = ::Paths_obj::addCustomGraphic(key1);
HXDLIN(  73)				bool xmlExists1 = false;
HXDLIN(  73)				if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE(  73)					xmlExists1 = true;
            				}
HXDLIN(  73)				 ::Dynamic _hx_tmp2;
HXDLIN(  73)				if (::hx::IsNotNull( imageLoaded1 )) {
HXLINE(  73)					_hx_tmp2 = imageLoaded1;
            				}
            				else {
HXLINE(  73)					 ::flixel::graphics::FlxGraphic imageToReturn1 = ::Paths_obj::addCustomGraphic(key1);
HXDLIN(  73)					if (::hx::IsNotNull( imageToReturn1 )) {
HXLINE(  73)						_hx_tmp2 = imageToReturn1;
            					}
            					else {
HXLINE(  73)						_hx_tmp2 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".png",3b,2d,bd,1e)),HX_("IMAGE",3b,57,57,3b),library1);
            					}
            				}
HXDLIN(  73)				 ::Dynamic _hx_tmp3;
HXDLIN(  73)				if (xmlExists1) {
HXLINE(  73)					_hx_tmp3 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e))));
            				}
            				else {
HXLINE(  73)					_hx_tmp3 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + key1) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library1);
            				}
HXDLIN(  73)				this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp2,_hx_tmp3));
HXLINE(  74)				this->animation->addByPrefix(HX_("idle",14,a7,b3,45),( (::String)(charFile1->__Field(HX_("idle_anim",5c,d2,54,bd),::hx::paccDynamic)) ),24,null(),null(),null());
HXLINE(  75)				this->animation->addByPrefix(HX_("confirm",00,9d,39,10),( (::String)(charFile1->__Field(HX_("confirm_anim",f0,e4,4f,7c),::hx::paccDynamic)) ),24,false,null(),null());
HXLINE(  77)				if (::hx::IsNotEq( charFile1->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic),1 )) {
HXLINE(  78)					this->scale->set(charFile1->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic),charFile1->__Field(HX_("scale",8a,ce,ce,78),::hx::paccDynamic));
HXLINE(  79)					this->updateHitbox();
            				}
HXLINE(  81)				this->offset->set(( (Float)( ::Dynamic(charFile1->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(0)) ),( (Float)( ::Dynamic(charFile1->__Field(HX_("position",a9,a0,fa,ca),::hx::paccDynamic))->__GetItem(1)) ));
HXLINE(  82)				this->animation->play(HX_("idle",14,a7,b3,45),null(),null(),null());
            			}
            		}
            	}
