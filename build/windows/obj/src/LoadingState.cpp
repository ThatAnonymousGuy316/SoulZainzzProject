...
HXDLIN(  69)				_gthis1->checkLoadSong(::LoadingState_obj::getSongPath());
HXLINE(  70)				if (( (bool)(::PlayState_obj::SONG->__Field(HX_("needsVoices",be,05,e9,0d),::hx::paccDynamic)) )) {
HXLINE(  71)					 ::LoadingState _gthis2 = _gthis;
HXDLIN(  71)					_gthis2->checkLoadSong(::LoadingState_obj::getVocalPath());
            				}
            			}
...
HXLINE(  54)		this->funkay->scrollFactor->set(0,0);
HXLINE(  55)		{
...
HXLINE( 133)			 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
...
HXDLIN( 140)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00))) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
HXDLIN( 145)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic)) ).toLowerCase(),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00))) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
            	}
...
HXLINE( 174)			 ::flixel::sound::FlxSound _this = ::flixel::FlxG_obj::sound->music;
