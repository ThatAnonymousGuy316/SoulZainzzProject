...
class HXCPP_CLASS_ATTRIBUTES FlxVideoSprite_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		...
		void __construct( ::hxvlc::impl::Instance instance, ::Dynamic __o_x, ::Dynamic __o_y);
		...
		static ::hx::ObjectPtr< FlxVideoSprite_obj > __new( ::hxvlc::impl::Instance instance, ::Dynamic __o_x, ::Dynamic __o_y);
		static ::hx::ObjectPtr< FlxVideoSprite_obj > __alloc(::hx::Ctx *_hx_ctx, ::hxvlc::impl::Instance instance, ::Dynamic __o_x, ::Dynamic __o_y);
		...
		::String __ToString() const { return HX_("FlxVideoSprite",ae,2b,c5,9a); }
		 ...
		 ::hxvlc::flixel::FlxInternalVideo bitmap;
