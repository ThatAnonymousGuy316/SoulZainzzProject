...
#define INCLUDED_CustomFlxColor

#ifndef HXCPP_H
#include <hxcpp.h>
#endif

HX_DECLARE_CLASS0(CustomFlxColor)
...
class HXCPP_CLASS_ATTRIBUTES CustomFlxColor_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x0390bba6 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=false,const char *inName="CustomFlxColor")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,false,"CustomFlxColor"); }
		...
		inline static ::hx::ObjectPtr< CustomFlxColor_obj > __alloc(::hx::Ctx *_hx_ctx) {
			CustomFlxColor_obj *__this = (CustomFlxColor_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(CustomFlxColor_obj), false, "CustomFlxColor"));
