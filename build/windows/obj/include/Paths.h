...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::media::Sound voices(::String song);
		static ::Dynamic voices_dyn();

		static  ::openfl::media::Sound inst(::String song);
		static ::Dynamic inst_dyn();

		static ::String voicesPath(::String song);
		static ::Dynamic voicesPath_dyn();

		static ::String instPath(::String song);
		static ::Dynamic instPath_dyn();
