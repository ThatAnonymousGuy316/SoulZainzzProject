...
class HXCPP_CLASS_ATTRIBUTES Interp_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic expr_dyn();
		 ...
		 ::Dynamic exprMeta(::String meta,::Array< ::Dynamic> args, ::Dynamic e);
		::Dynamic exprMeta_dyn();
		...
		::Dynamic makeIterator_dyn();
		 ...
		 ::Dynamic makeKeyValueIterator( ::Dynamic v);
		::Dynamic makeKeyValueIterator_dyn();

		void forLoop(::String n, ::Dynamic it, ::Dynamic e);
		::Dynamic forLoop_dyn();

		void forKeyValueLoop(::String vk,::String vv, ::Dynamic it, ::Dynamic e);
