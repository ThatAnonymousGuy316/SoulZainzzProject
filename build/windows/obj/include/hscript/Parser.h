...
class HXCPP_CLASS_ATTRIBUTES Parser_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic pmax_dyn();
		 ...
		 ::Dynamic mk( ::hscript::ExprDef e,::hx::Null< int >  pmin,::hx::Null< int >  pmax);
		::Dynamic mk_dyn();
		...
		::Dynamic parseFullExpr_dyn();
		 ...
		 ::Dynamic parseObject(int p1);
		::Dynamic parseObject_dyn();

		 ::Dynamic parseExpr();
		::Dynamic parseExpr_dyn();

		 ::Dynamic parseLambda(::Array< ::Dynamic> args,int pmin);
		::Dynamic parseLambda_dyn();

		 ::Dynamic mkLambda(::Array< ::Dynamic> args, ::Dynamic eret,int p);
		::Dynamic mkLambda_dyn();
