...
class HXCPP_CLASS_ATTRIBUTES FlxCamera_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		static Float safeGetX( ::flixel::math::FlxBasePoint p,Float backup);
		static ::Dynamic safeGetX_dyn();

		static Float safeGetY( ::flixel::math::FlxBasePoint p,Float backup);
		static ::Dynamic safeGetY_dyn();
		...
		::Dynamic setPosition_dyn();
		 ...
		 ::flixel::math::FlxBasePoint worldToViewHelper(Float worldX,Float worldY,::hx::Null< Float >  scrollFactorX,::hx::Null< Float >  scrollFactorY, ::flixel::math::FlxBasePoint result);
		::Dynamic worldToViewHelper_dyn();

		Float worldToViewX(Float worldX,::hx::Null< Float >  scrollFactor);
		::Dynamic worldToViewX_dyn();

		Float worldToViewY(Float worldY,::hx::Null< Float >  scrollFactor);
		::Dynamic worldToViewY_dyn();

		 ::flixel::math::FlxBasePoint viewToWorldHelper(Float viewX,Float viewY,::hx::Null< Float >  scrollFactorX,::hx::Null< Float >  scrollFactorY, ::flixel::math::FlxBasePoint result);
		::Dynamic viewToWorldHelper_dyn();

		Float viewToWorldX(Float viewX,::hx::Null< Float >  scrollFactor);
		::Dynamic viewToWorldX_dyn();

		Float viewToWorldY(Float viewY,::hx::Null< Float >  scrollFactor);
		::Dynamic viewToWorldY_dyn();

		 ::flixel::math::FlxBasePoint gameToViewHelper(Float gameX,Float gameY, ::flixel::math::FlxBasePoint result);
		::Dynamic gameToViewHelper_dyn();

		Float gameToViewX(Float gameX);
		::Dynamic gameToViewX_dyn();

		Float gameToViewY(Float gameY);
		::Dynamic gameToViewY_dyn();

		 ::flixel::math::FlxBasePoint viewToGameHelper(Float viewX,Float viewY, ::flixel::math::FlxBasePoint result);
		::Dynamic viewToGameHelper_dyn();

		Float viewToGameX(Float viewX);
		::Dynamic viewToGameX_dyn();

		Float viewToGameY(Float viewY);
		::Dynamic viewToGameY_dyn();
