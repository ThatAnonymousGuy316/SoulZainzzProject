...
class HXCPP_CLASS_ATTRIBUTES FlxSprite_obj : public  ::flixel::FlxObject_obj
{
	...
	public:
		...
		static  ::flixel::math::FlxMatrix drawComplexMatrix;
		...
		void clipToWorldBounds(Float left,Float top,Float right,Float bottom);
		::Dynamic clipToWorldBounds_dyn();

		void clipToWorldBoundsSimple(Float left,Float top,Float right,Float bottom);
		::Dynamic clipToWorldBoundsSimple_dyn();

		void clipToViewBounds(Float left,Float top,Float right,Float bottom, ::flixel::FlxCamera camera);
		::Dynamic clipToViewBounds_dyn();
		...
		void prepareComplexMatrix( ::flixel::math::FlxMatrix matrix, ::flixel::graphics::frames::FlxFrame frame, ::flixel::FlxCamera camera);
		::Dynamic prepareComplexMatrix_dyn();
		...
		int transformColor(int colorIn);
		::Dynamic transformColor_dyn();
		...
		::Dynamic transformWorldToPixelsSimple_dyn();
		 ...
		 ::flixel::math::FlxBasePoint transformScreenToPixels( ::flixel::math::FlxBasePoint screenPos, ::flixel::FlxCamera camera, ::flixel::math::FlxBasePoint result);
		::Dynamic transformScreenToPixels_dyn();

		 ::flixel::math::FlxBasePoint worldToFrameHelper(Float worldX,Float worldY, ::flixel::FlxCamera camera, ::flixel::math::FlxBasePoint result);
		::Dynamic worldToFrameHelper_dyn();

		 ::flixel::math::FlxBasePoint worldToFrameSimpleHelper(Float worldX,Float worldY, ::flixel::math::FlxBasePoint result);
		::Dynamic worldToFrameSimpleHelper_dyn();

		 ::flixel::math::FlxBasePoint viewToFrameHelper(Float viewX,Float viewY, ::flixel::FlxCamera camera, ::flixel::math::FlxBasePoint result);
		::Dynamic viewToFrameHelper_dyn();
