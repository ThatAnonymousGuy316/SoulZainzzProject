...
class HXCPP_CLASS_ATTRIBUTES FlxBaseTilemap_obj : public  ::flixel::FlxObject_obj
{
	...
	public:
		...
		Float getColumnPos(int column,::hx::Null< bool >  midpoint);
		::Dynamic getColumnPos_dyn();

		Float getRowPos(int row,::hx::Null< bool >  midpoint);
		::Dynamic getRowPos_dyn();

		Float getColumnPosAt(Float worldX,::hx::Null< bool >  midpoint);
		::Dynamic getColumnPosAt_dyn();

		Float getRowPosAt(Float worldY,::hx::Null< bool >  midpoint);
		::Dynamic getRowPosAt_dyn();

		virtual Float getTileWidth() { return 0; }
		::Dynamic getTileWidth_dyn();
		virtual Float getTileHeight() { return 0; }
		...
		::Dynamic ray_dyn();
		 ...
		 ::flixel::tile::FlxRayResult rayAdvanced( ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint end,::hx::Null< bool >  checkDir);
		::Dynamic rayAdvanced_dyn();

		 ::Dynamic checkRayDirHelper( ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint end,bool checkDir);
		::Dynamic checkRayDirHelper_dyn();

		void forEachInRay( ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint end, ::Dynamic func);
		::Dynamic forEachInRay_dyn();

		int findIndexInRay( ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint end, ::Dynamic func);
		::Dynamic findIndexInRay_dyn();

		 ::flixel::tile::FlxRayResult findInRay( ::flixel::math::FlxBasePoint start, ::flixel::math::FlxBasePoint end, ::Dynamic func);
		::Dynamic findInRay_dyn();

		Float ambiClamp(Float value,Float a,Float b);
		::Dynamic ambiClamp_dyn();

		int findIndexInColumnWithEntry(int column,int startRow,int endRow, ::Dynamic func, ::flixel::tile::FlxRayEntry entry);
		::Dynamic findIndexInColumnWithEntry_dyn();

		 ::flixel::tile::FlxRayResult calcRayResult(int index, ::flixel::tile::FlxRayEntry entry,Float m,Float b, ::flixel::math::FlxBasePoint start);
		::Dynamic calcRayResult_dyn();

		void forEachInColumn(int column,int startRow,int endRow, ::Dynamic func);
		::Dynamic forEachInColumn_dyn();

		 ::Dynamic findInColumn(int column,int startRow,int endRow, ::Dynamic func);
		::Dynamic findInColumn_dyn();

		int findIndexInColumn(int column,int startRow,int endRow, ::Dynamic func);
		::Dynamic findIndexInColumn_dyn();

		 ::Dynamic findInRow(int row,int startColumn,int endColumn, ::Dynamic func);
		::Dynamic findInRow_dyn();

		int findIndexInRow(int row,int startColumn,int endColumn, ::Dynamic func);
		::Dynamic findIndexInRow_dyn();
		...
		::Dynamic loadMapFrom2DArray_dyn();
		 ...
		 ::flixel::tile::FlxBaseTilemap loadMap32FromGraphic( ::Dynamic mapGraphic,::hx::Null< int >  scale,::Array< int > colorMap, ::Dynamic tileGraphic,::hx::Null< int >  tileWidth,::hx::Null< int >  tileHeight, ::flixel::tile::FlxTilemapAutoTiling autoTile,::hx::Null< int >  startingIndex,::hx::Null< int >  drawIndex,::hx::Null< int >  collideIndex);
		::Dynamic loadMap32FromGraphic_dyn();
		...
		virtual  ::Dynamic orientTile( ::Dynamic tile,int mapIndex) { return 0; }
		::Dynamic orientTile_dyn();
		int getTileIndexAt(Float worldX,Float worldY);
		::Dynamic getTileIndexAt_dyn();

		 ::flixel::math::FlxBasePoint getTilePosAt(Float worldX,Float worldY,::hx::Null< bool >  midpoint, ::flixel::math::FlxBasePoint result);
