...
class HXCPP_CLASS_ATTRIBUTES FlxMatrix_obj : public  ::openfl::geom::Matrix_obj
{
	...
	public:
		...
		::Dynamic isIdentity_dyn();
		 ...
		 ::flixel::math::FlxMatrix skewRadians(Float skewX,Float skewY);
		::Dynamic skewRadians_dyn();

		 ::flixel::math::FlxMatrix skewDegrees(Float skewX,Float skewY);
		::Dynamic skewDegrees_dyn();
