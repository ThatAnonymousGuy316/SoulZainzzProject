...
class HXCPP_CLASS_ATTRIBUTES FlxObject_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		Float getViewX( ::flixel::FlxCamera camera);
		::Dynamic getViewX_dyn();

		Float getViewXHelper( ::flixel::FlxCamera camera);
		::Dynamic getViewXHelper_dyn();

		Float getViewY( ::flixel::FlxCamera camera);
		::Dynamic getViewY_dyn();

		Float getViewYHelper( ::flixel::FlxCamera camera);
		::Dynamic getViewYHelper_dyn();
