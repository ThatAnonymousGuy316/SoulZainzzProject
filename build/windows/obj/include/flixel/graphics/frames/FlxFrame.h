...
class HXCPP_CLASS_ATTRIBUTES FlxFrame_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic prepareMatrix_dyn();
		 ...
		 ::flixel::math::FlxBasePoint toSourcePosition( ::flixel::math::FlxBasePoint framePos, ::flixel::math::FlxBasePoint result);
		::Dynamic toSourcePosition_dyn();

		Float toSourceXHelper(Float frameX,Float frameY);
		::Dynamic toSourceXHelper_dyn();

		Float toSourceYHelper(Float frameX,Float frameY);
		::Dynamic toSourceYHelper_dyn();
