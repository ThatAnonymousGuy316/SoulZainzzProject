...
class HXCPP_CLASS_ATTRIBUTES FlxSound_obj : public  ::flixel::FlxBasic_obj
{
	...
	public:
		...
		::Dynamic updateProximity_dyn();

		void kill();

		 ::flixel::sound::FlxSound load( ::Dynamic asset,::hx::Null< bool >  allowCache);
		::Dynamic load_dyn();

		 ::flixel::sound::FlxSound loadHelper( ::Dynamic asset,::hx::Null< bool >  destroy,::hx::Null< bool >  allowCache,::hx::Null< bool >  addExt);
		::Dynamic loadHelper_dyn();

		 ::flixel::sound::FlxSound loadStreamed(::String assetId);
		::Dynamic loadStreamed_dyn();

		 ::flixel::sound::FlxSound loadStreamedHelper(::String assetId,bool destroy);
		::Dynamic loadStreamedHelper_dyn();

		 ::flixel::sound::FlxSound loadFromURL(::String soundURL, ::Dynamic onLoad);
		::Dynamic loadFromURL_dyn();

		 ::flixel::sound::FlxSound loadFromUrlHelper(::String soundURL, ::Dynamic onLoad);
		::Dynamic loadFromUrlHelper_dyn();
		...
		::Dynamic loadByteArray_dyn();
		 ...
		 ::flixel::sound::FlxSound init(bool looped,bool autoDestroy, ::Dynamic onComplete);
		::Dynamic init_dyn();
		...
		void onSoundSet();
		::Dynamic onSoundSet_dyn();

		void gotID3( ::openfl::events::Event e);
		::Dynamic gotID3_dyn();
