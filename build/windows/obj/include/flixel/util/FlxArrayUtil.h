...
class HXCPP_CLASS_ATTRIBUTES FlxArrayUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static ::cpp::VirtualArray fastSplice(::cpp::VirtualArray array, ::Dynamic element);
		static ::Dynamic fastSplice_dyn();
		...
		static ::Array< ::Dynamic> scale2dHelper(::Array< ::Dynamic> data,int subAmount,int amount);
		static ::Dynamic scale2dHelper_dyn();
