...
class HXCPP_CLASS_ATTRIBUTES IFlxPooled_obj {
	public:
		...
		void (::hx::Object :: *_hx_putWeak)(); 
		static inline void putWeak( ::Dynamic _hx_) {
			#ifdef HXCPP_CHECK_POINTER
			if (::hx::IsNull(_hx_)) ::hx::NullReference("Object", false);
			#ifdef HXCPP_GC_CHECK_POINTER
				GCCheckPointer(_hx_.mPtr);
			#endif
			#endif
			(_hx_.mPtr->*( ::hx::interface_cast< ::flixel::util::IFlxPooled_obj *>(_hx_.mPtr->_hx_getInterface(0x9aa322a2)))->_hx_putWeak)();
		}
};
