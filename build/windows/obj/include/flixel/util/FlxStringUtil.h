...
class HXCPP_CLASS_ATTRIBUTES FlxStringUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String arrayToCSVHelper(::cpp::VirtualArray data,int width);
		static ::Dynamic arrayToCSVHelper_dyn();

		static ::Array< int > defaultColorMap;
		static ::Array< int > invertColorMap;
		static ::String bitmap32ToCSV( ::openfl::display::BitmapData bitmap,::hx::Null< int >  scale,::Array< int > colorMap);
		static ::Dynamic bitmap32ToCSV_dyn();

		static ::String bitmapToCSVHelper( ::openfl::display::BitmapData bitmap,int scale,::Array< int > colors,bool ignoreAlpha);
		static ::Dynamic bitmapToCSVHelper_dyn();

		static ::Array< ::Dynamic> bitmapToArray2d( ::openfl::display::BitmapData bitmap, ::haxe::ds::IntMap colorMap,bool ignoreAlpha, ::Dynamic backupValue);
		static ::Dynamic bitmapToArray2d_dyn();

		static bool isBrowserManipulatingImages;
		static  ::haxe::ds::IntMap generateColorMapFromArray(::Array< int > colors,bool ignoreAlpha);
		static ::Dynamic generateColorMapFromArray_dyn();
