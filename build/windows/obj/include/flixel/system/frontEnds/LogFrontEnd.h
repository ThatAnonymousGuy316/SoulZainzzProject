...
class HXCPP_CLASS_ATTRIBUTES LogFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		bool redirectTraces;
		 ::flixel::_hx_system::frontEnds::FlxLogStylesList styles;
		...
		void advanced( ::Dynamic data, ::flixel::_hx_system::debug::log::FlxLogStyle style,::hx::Null< bool >  fireOnce, ::Dynamic pos);
