...
class HXCPP_CLASS_ATTRIBUTES AssetFrontEnd_obj : public ::hx::Object
{
	...
	public:
		...
		::Dynamic getOpenflAssetUnsafe_dyn();
		 ...
		 ::Dynamic getAsset(::String id,::String type,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		...
		::Dynamic getBitmapDataUnsafe_dyn();
		 ...
		 ::openfl::display::BitmapData getBitmapData(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic getBitmapData_dyn();

		 ::openfl::media::Sound getSoundUnsafe(::String id,::hx::Null< bool >  useCache);
		::Dynamic getSoundUnsafe_dyn();

		 ::openfl::media::Sound getSound(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic getSound_dyn();

		 ::openfl::media::Sound getSoundAddExt(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		...
		::Dynamic streamSoundUnsafe;
		inline ::Dynamic &streamSoundUnsafe_dyn() {return streamSoundUnsafe; }

		 ::openfl::media::Sound streamSound(::String id, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic streamSound_dyn();

		 ::openfl::media::Sound streamSoundAddExt(::String id, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic streamSoundAddExt_dyn();

		::Dynamic canStreamSound;
		inline ::Dynamic &canStreamSound_dyn() {return canStreamSound; }

		::String getTextUnsafe(::String id,::hx::Null< bool >  useCache);
		::Dynamic getTextUnsafe_dyn();

		::String getText(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic getText_dyn();

		 ::Xml getXmlUnsafe(::String id,::hx::Null< bool >  useCache);
		::Dynamic getXmlUnsafe_dyn();

		 ::Xml getXml(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic getXml_dyn();

		 ::Dynamic getJsonUnsafe(::String id,::hx::Null< bool >  useCache);
		::Dynamic getJsonUnsafe_dyn();

		 ::Dynamic getJson(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic getJson_dyn();

		 ::haxe::io::Bytes getBytesUnsafe(::String id,::hx::Null< bool >  useCache);
		::Dynamic getBytesUnsafe_dyn();

		 ::haxe::io::Bytes getBytes(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic getBytes_dyn();

		 ::openfl::text::Font getFontUnsafe(::String id,::hx::Null< bool >  useCache);
		::Dynamic getFontUnsafe_dyn();

		 ::openfl::text::Font getFont(::String id,::hx::Null< bool >  useCache, ::flixel::_hx_system::debug::log::FlxLogStyle logStyle);
		::Dynamic getFont_dyn();
