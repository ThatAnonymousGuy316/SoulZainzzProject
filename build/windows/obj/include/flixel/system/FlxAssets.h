...
class HXCPP_CLASS_ATTRIBUTES FlxAssets_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::display::BitmapData assertBitmapData( ::Dynamic graphic);
		static ::Dynamic assertBitmapData_dyn();

		static  ::openfl::display::BitmapData resolveBitmapData( ::Dynamic graphic, ::flixel::_hx_system::debug::log::FlxLogStyle log, ::Dynamic pos);
		static ::Dynamic resolveBitmapData_dyn();

		static  ::openfl::media::Sound resolveSound( ::Dynamic sound,::hx::Null< bool >  allowCache,::hx::Null< bool >  addExt, ::flixel::_hx_system::debug::log::FlxLogStyle log, ::Dynamic pos);
		static ::Dynamic resolveSound_dyn();

		static  ::openfl::media::Sound assertSound( ::Dynamic sound,::hx::Null< bool >  allowCache,::hx::Null< bool >  addExt);
