...
class HXCPP_CLASS_ATTRIBUTES FlxTypeText_obj : public  ::flixel::text::FlxText_obj
{
	...
	public:
		...
		void __construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_width,::String __o_text,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_embeddedFont);
		...
		static ::hx::ObjectPtr< FlxTypeText_obj > __new(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_width,::String __o_text,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_embeddedFont);
		static ::hx::ObjectPtr< FlxTypeText_obj > __alloc(::hx::Ctx *_hx_ctx,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y,::hx::Null< int >  __o_width,::String __o_text,::hx::Null< int >  __o_size,::hx::Null< bool >  __o_embeddedFont);
		...
		::Dynamic start_dyn();
		 ...
		 ::flixel::text::FlxText applyMarkup(::String _tmp_input,::Array< ::Dynamic> rules);
